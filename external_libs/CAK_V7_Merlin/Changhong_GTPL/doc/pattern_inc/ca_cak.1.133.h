...
#ifndef CA_CAK_H_DEFINES
#define CA_CAK_H_DEFINES
...
#ifndef CA_CAK_H_TYPES
#define CA_CAK_H_TYPES
...
typedef enum
{
  ...
  CA_ACCESS_NO_VALID_SMARTCARD,
    /**<  The smartcard is not inserted, or the CAK is temporarily unable to 
     *    communicate with it. It may also be incompatible with the program to 
     *    be descrambled (e.g. program operated by an operator not managed by 
     *    the card). Therefore, access is not granted. It is advised to make a 
     *    smart card information request to get further information about the 
...
typedef enum
{
  ...
  CA_PROCESSING_NO_VALID_SMARTCARD,
    /**< no valid smartcard has been found to process the request */
...
/**
 *  @brief
 *    This enumeration define the connection result.
*/
typedef enum
{
...
#ifndef CA_CAK_H_PROTOTYPES
#define CA_CAK_H_PROTOTYPES
...
/**
 * @brief
 *   This function gets the smartcard serial number as string.
 *
 *  @pre
 *    None.
 *
 ...
 *             The pointer does not correspond to a valid request
 *  @retval  CA_REQUEST_PARAMETER_INVALID
 *             The parameter is invalid (probably pxRequest or xCallback
 *             set to NULL)
 *  @retval  CA_REQUEST_INVALID_SYNCHRONISM
 ...
 *    of type CA_REQUEST_TYPE_OPERATOR_RESTRICTION or CA_REQUEST_TYPE_EVENT.
 *
 *  @pre
 *    The request must be created by a call to caRequestCreate().
 *    It may have been sent to the CAK already.
 ...
 *  @param   pxRequest
 *            Request to use.
 *            It must be of type CA_REQUEST_TYPE_OPERATOR_RESTRICTION or 
 *            CA_REQUEST_TYPE_EVENT.
 *  @param   xNumberOfPpids
 *            Number of operator IDs. Can be set to 0.
 *  @param   pxPpidArray
 *            Array containing the operator IDs. Can be set to NULL.
 *
 *  @retval CA_REQUEST_NO_ERROR
 *            The parameter could be set successfully
 *  @retval CA_REQUEST_PROCESSING
 ...
 *            An unspecified error occurred
 *  @remark
 *    -#  The request CA_REQUEST_TYPE_OPERATOR_RESTRICTION cannot be 
 *        successfully sent if the operator IDs have not been set through 
 *        this function. 
 *    -#  The request CA_REQUEST_TYPE_EVENT only use caRequestSetOperatorIds 
 *        as an option to overwrite the current operator restriction defined.
*/
 ...
 *             CA_REQUEST_NO_ERROR. Possible values are:
 *
 *             - CA_PROCESSING_NO_ERROR
 *               The request has been processed successfully
 *             - CA_PROCESSING_NO_VALID_SMARTCARD
...
/**
 * @brief
 *   This function gets the server last connection.
 *
 *  @pre
 *    None.
 *
...
(
  const TCaServer*       pxThis,
  const TCaConnection** ppxLastConnection
);


#endif /* CA_CAK_H_PROTOTYPES */
