...
void TestSce_Scanning()
{
	...
	DMD_Scan.Ter.SymbolRateBw=8000000;
	DMD_Scan.Ter.Modulation=eTDAL_DMD_MOD_AUTO;
	DMD_Scan.Ter.SpecInv=eTDAL_DMD_SPECTRUM_AUTO;
	DMD_Scan.Ter.Mode=eTDAL_DMD_MODE_8K;
	DMD_Scan.Ter.Guard=eTDAL_DMD_GUARD_1_32;
	DMD_Scan.Ter.Hierarchy=eTDAL_DMD_HIER_AUTO;
	DMD_Scan.Ter.Priority=eTDAL_DMD_PRIORITY_STREAM_HIGH;
	DMD_Scan.Ter.ConvolutionHP=eTDAL_DMD_FEC_AUTO;
	DMD_Scan.Ter.ConvolutionLP=eTDAL_DMD_FEC_AUTO;
	DMD_Scan.Ter.Offset=eTDAL_DMD_OFFSET_AUTO;
...
#endif
#ifdef MEDIUM_SAT
    TestManager_AssertEqual(TDAL_DMD_StartScan(ucFeID, &DMD_Scan,10000000,15000000),
                            eTDAL_DMD_NO_ERROR,
                            "TDAL_DMD_StartScan");
#endif
#ifdef MEDIUM_CAB
    TestManager_AssertEqual(TDAL_DMD_StartScan(ucFeID, &DMD_Scan,360000000,400000000),
                            eTDAL_DMD_NO_ERROR,
                            "TDAL_DMD_StartScan");
#endif
	TestHelper_DMD_WaitStatus(ucFeID);
