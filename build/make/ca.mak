...
ifeq "$(PRODUCT_CCAS)" "PC_SIMULATOR"
    ...
    # Add libraries
    #
    ifeq "$(PRODUCT_CAK_LIBVER)" "PROD_REL"
        CAK_LIBS += $(CAK_PROD_RELEASE_LIBS)
        CAK_CFLAGS += -DCAK_PRODUCTION
    endif

	ifeq "$(PRODUCT_CAK_LIBVER)" "PROD_DBG"
		CAK_LIBS += $(CAK_PROD_DEBUG_LIBS)
		CAK_CFLAGS += -DCAK_PRODUCTION
	endif
	
	ifeq "$(PRODUCT_CAK_LIBVER)" "NAK_REL"
		CAK_LIBS += $(CAK_NAK_RELEASE_LIBS)
		CAK_CFLAGS += -DCAK_BETA
	endif

	ifeq "$(PRODUCT_CAK_LIBVER)" "NAK_DBG"
		CAK_LIBS += $(CAK_NAK_DEBUG_LIBS)
		CAK_CFLAGS += -DCAK_BETA
	endif
