...
#if defined(NEWLAND_BOOTLOADER) || defined(CHANGHONG_BOOTLOADER) || defined(SKYWORTH_BOOTLOADER) || defined(TELESYSTEM_BOOTLOADER) || defined(TELESYSTEM_MAP51_BOOTLOADER) || defined(TELESYSTEM_MAP34_BOOTLOADER) || (TECHNICOLOR_BOOTLOADER) || defined(KAON_MSD5C59_BOOTLOADER)
