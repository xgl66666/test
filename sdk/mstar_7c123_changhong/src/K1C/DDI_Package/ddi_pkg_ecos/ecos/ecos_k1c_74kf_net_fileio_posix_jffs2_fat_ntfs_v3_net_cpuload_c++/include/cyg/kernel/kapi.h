...
#ifdef CYGMFN_KERNEL_SYNCH_MUTEX_TIMED_WAIT
cyg_bool_t cyg_mutex_timed_lock( cyg_mutex_t *mutex,
                                 cyg_tick_count_t  abstime ) __THROW;
#endif
...
/*---------------------------------------------------------------------------*/
/* MStar API for eCos                                                        */
void MApi_eCos_GetCpuFreq(void);
void MApi_eCos_ThreadStackTrace_Show(void);
void MApi_eCos_ThreadStackTrace_Active(bool Enable);
void MApi_eCos_Get_CPU_Usage(cyg_uint16 period);
void MApi_eCos_STR_Init(void);
void MApi_eCos_STR_Enter(void);
