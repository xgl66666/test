...
//kevinhuang04262007, add LFN
#define S_FATFS_LFN     (0x0F) // LFN entry
...
//kvinhuang04262007, 0x0F is LFN
//#define S_FATFS_ISVOLUME(__mode)  ((__mode) & S_FATFS_VOLUME)
#define S_FATFS_ISVOLUME(__mode)  ((__mode) & S_FATFS_VOLUME && (__mode) != S_FATFS_LFN )
