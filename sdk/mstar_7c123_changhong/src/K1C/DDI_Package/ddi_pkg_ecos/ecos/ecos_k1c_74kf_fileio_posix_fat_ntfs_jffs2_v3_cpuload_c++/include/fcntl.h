...
/* open() mode flags */
#define O_NEW        (1<<2)    //kevinhuang06132007 /* Create a not existent file  */
...
extern int wopen( const unsigned short *wpath , int oflag , ... );

extern int wcreat( const unsigned short *wpath , mode_t mode );
#endif
