...
#include CYGBLD_HAL_MSTAR_K1C_PLATFORM_H               // Platform specific configuration
//-------------------------------------------------------------------------------------------------
...
#define TX_V6_CHECKSUM_ENABLE       (0x000C0000UL)
#define EMAC_MAX_TX_QUEUE           30
//Interrupt
#define MAC_IRQ                     (0x00 + 9)//E_INT_IRQ_EMAC//E_IRQ_EMAC
...
#define REG_GEMAC0_XIU32_BANK       0x1A1EUL
#define INTERNEL_PHY_REG_BASE       RIU_REG_BASE + ((REG_ALBANY0_BANK*0x100UL)<<1)
#define GEMAC0_XIU16_REG_ADDR_BASE  RIU_REG_BASE + ((REG_GEMAC0_BANK*0x100UL)<<1)
#define GEMAC0_XIU32_REG_ADDR_BASE  RIU_REG_BASE + ((REG_GEMAC0_XIU32_BANK*0x100UL)<<1)
#define REG_ADDR_BASE_XIU16         GEMAC0_XIU16_REG_ADDR_BASE
#define REG_ADDR_BASE_XIU32         GEMAC0_XIU32_REG_ADDR_BASE
#define REG_ADDR_BASE               REG_ADDR_BASE_XIU16
#define MIU0_BUS_BASE               0x0
...
#define RX_DESC_NUMBER              0x0040UL//0x0400UL                                //32 descriptor
...
#define TX_LOW_PRI_DESC_NUMBER      0x0180UL                                //32 descriptor
...
#ifdef NEW_TX_QUEUE
#define EMAC_REG_NEW_TX_QUEUE           0x0000042e
...
u32 MHal_EMAC_Read_Network_config_register5(void);
...
void MHal_EMAC_Write_Network_config_register5(u32 xval);
...
void MHal_EMAC_link_led_on(void);
void MHal_EMAC_link_led_off(void);
...
void MHal_EMAC_ROVR_Reset(void);
void MHal_EMAC_Diable_UART(void);
#endif
// -----------------------------------------------------------------------------
// Linux EMAC.c End
// -----------------------------------------------------------------------------
