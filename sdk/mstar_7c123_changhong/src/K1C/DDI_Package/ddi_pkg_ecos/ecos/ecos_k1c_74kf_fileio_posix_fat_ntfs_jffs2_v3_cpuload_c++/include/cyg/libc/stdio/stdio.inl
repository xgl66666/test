...
#elif defined(__cplusplus) && ((__GNUC__ > 3) || ((__GNUC__ == 3) && (__GNUC_MINOR__ >= 3)))
...
extern __inline__ int
__CYG_LIBC_STDIO_CXX_STD_(vprintf)( const char *format, va_list arg ) __THROW
{
...
extern __inline__ int
__CYG_LIBC_STDIO_CXX_STD_(vsprintf)( char *s, const char *format, va_list arg ) __THROW
{
...
extern __inline__ int
__CYG_LIBC_STDIO_CXX_STD_(vscanf)( const char *format, va_list arg ) __THROW
{
