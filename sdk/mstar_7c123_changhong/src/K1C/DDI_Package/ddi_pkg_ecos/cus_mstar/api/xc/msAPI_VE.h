...
typedef enum
{
    E_MSAPI_VE_VCHIP_MPA_START                      = 0x00,
    E_MSAPI_VE_VCHIP_MPA_NA                         = E_MSAPI_VE_VCHIP_MPA_START,
    E_MSAPI_VE_VCHIP_MPA_G,
    E_MSAPI_VE_VCHIP_MPA_PG,
    E_MSAPI_VE_VCHIP_MPA_PG_13,
    E_MSAPI_VE_VCHIP_MPA_R,
    E_MSAPI_VE_VCHIP_MPA_NC_17,
    E_MSAPI_VE_VCHIP_MPA_X,
    E_MSAPI_VE_VCHIP_MPA_NOT_RATED,

    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_START = 0x10,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_NONE1 = E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_START,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_TV_Y,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_TV_Y7,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_TV_G,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_TV_PG,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_TV_14,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_TV_MA,
    E_MSAPI_VE_VCHIP_US_TV_PARENTALGUIDELINES_NONE2,

    E_MSAPI_VE_VCHIP_MPA_2_START                    = 0x20,
    E_MSAPI_VE_VCHIP_MPA_2_NA                       = E_MSAPI_VE_VCHIP_MPA_2_START,
    E_MSAPI_VE_VCHIP_MPA_2_G,
    E_MSAPI_VE_VCHIP_MPA_2_PG,
    E_MSAPI_VE_VCHIP_MPA_2_PG_13,
    E_MSAPI_VE_VCHIP_MPA_2_R,
    E_MSAPI_VE_VCHIP_MPA_2_NC_17,
    E_MSAPI_VE_VCHIP_MPA_2_X,
    E_MSAPI_VE_VCHIP_MPA_2_NOT_RATED,

    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_START         = 0x30,   //CANADIAN_ENGLISH_LANGUAGE
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_E             = E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_START,
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_C,
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_C8_PLUS,
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_G,
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_PG,
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_L14_PLUS,
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_18_PLUS,
    E_MSAPI_VE_VCHIP_CANADIAN_ENGLISH_NOT_RATED,

    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_START          = 0x40,   //CANADIAN_FRENCH_LANGUAGE_RATINGS
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_E              = E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_START,
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_G,
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_8_ANS_PLUS,
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_13_ANS_PLUS,
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_16_ANS_PLUS,
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_18_ANS_PLUS,
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_NOT_RATED1,
    E_MSAPI_VE_VCHIP_CANADIAN_FRENCH_NOT_RATED2,

    E_MSAPI_VE_VCHIP_RESERVED1_START                = 0x50,   //Reserved for non-U.S. & non-Canadian system

    E_MSAPI_VE_VCHIP_RESERVED2_START                = 0x60,   //Reserved for non-U.S. & non-Canadian system
}E_MSAPI_VE_VCHIP_RATING_SYSTEM_TYPE;
...
//---------------------------------------------------------------------------------------------
/// @brief: //Set VE capture/crop/display window
//---------------------------------------------------------------------------------------------
extern MS_BOOL msAPI_VE_SetWin_EX(MS_VE_WINDOW_TYPE *pstSrcWin, MS_VE_WINDOW_TYPE *pstCropWin, MS_VE_WINDOW_TYPE *pstDstWin);

//---------------------------------------------------------------------------------------------
/// @brief: //Get VE source size by source type
//---------------------------------------------------------------------------------------------
extern MS_BOOL msAPI_VE_GetSourceSize(MS_U16 *u16SrcWidth, MS_U16 *u16SrcHeight);
...
//---------------------------------------------------------------------------------------------
/// @brief: msAPI VE set Pool ID for stack of functional task
//---------------------------------------------------------------------------------------------
extern void msAPI_VE_SetTaskPoolID(MS_S32 s32TaskPoolID);

//---------------------------------------------------------------------------------------------
/// @brief: msAPI VE enable/disable CC XDS task (send CC XDS control)
//---------------------------------------------------------------------------------------------
extern MS_BOOL msAPI_VE_CCXDSOnOff(MS_BOOL bEnable);

//---------------------------------------------------------------------------------------------
/// @brief: msAPI VE set CC XDS VChip Type
//---------------------------------------------------------------------------------------------
extern MS_BOOL msAPI_VE_CCXDSSetVChip(E_MSAPI_VE_VCHIP_RATING_SYSTEM_TYPE eVChip_RatingType);
