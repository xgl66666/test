...
typedef enum
{
    ...
    E_MSAPI_XC_INPUT_SOURCE_SCALER0_DI,    ///<43 scaler0 DI
...
#define MSAPI_XC_IsSrcTypeAV(x)             (((int)(x)>=(int)E_MSAPI_XC_INPUT_SOURCE_CVBS)&&((int)(x)<=(int)E_MSAPI_XC_INPUT_SOURCE_CVBS_MAX))/// x is AV
#define MSAPI_XC_IsSrcTypeSV(x)             (((int)(x)>=(int)E_MSAPI_XC_INPUT_SOURCE_SVIDEO)&&((int)(x)<=(int)E_MSAPI_XC_INPUT_SOURCE_SVIDEO_MAX))///< x is SV
#define MSAPI_XC_IsSrcTypeATV(x)            ((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_TV)///< x is ATV
#define MSAPI_XC_IsSrcTypeScart(x)          (((int)(x)>=(int)E_MSAPI_XC_INPUT_SOURCE_SCART)&&((int)(x)<=(int)E_MSAPI_XC_INPUT_SOURCE_SCART_MAX))///< x is Scart
#define MSAPI_XC_IsSrcTypeHDMI(x)           (((int)(x)>=(int)E_MSAPI_XC_INPUT_SOURCE_HDMI)&&((int)(x)<=(int)E_MSAPI_XC_INPUT_SOURCE_HDMI_MAX))///< x is HDMI
#define MSAPI_XC_IsSrcTypeVga(x)            ((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_VGA)///< x is VGA
#define MSAPI_XC_IsSrcTypeYPbPr(x)          (((int)(x)>=(int)E_MSAPI_XC_INPUT_SOURCE_YPBPR)&&((int)(x)<=(int)E_MSAPI_XC_INPUT_SOURCE_YPBPR_MAX))///<  x is YPbPr
#define MSAPI_XC_IsSrcTypeDTV(x)            (((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_DTV) || ((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_DTV2) || ((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_DTV3))///< x is DTV
#define MSAPI_XC_IsSrcTypeDVI(x)            (((int)(x)>=(int)E_MSAPI_XC_INPUT_SOURCE_DVI)&&((int)(x)<=(int)E_MSAPI_XC_INPUT_SOURCE_DVI_MAX))///< x is DVI
#define MSAPI_XC_IsSrcTypeJpeg(x)           ((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_JPEG)///< x is JPEG
#define MSAPI_XC_IsSrcTypeStorage(x)        ((int)((x)==(int)E_MSAPI_XC_INPUT_SOURCE_STORAGE) || ((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_STORAGE2) || MSAPI_XC_IsSrcTypeJpeg(x))///< x is Storage
#define MSAPI_XC_IsSrcTypeDigitalVD(x)      ( MSAPI_XC_IsSrcTypeAV(x)||MSAPI_XC_IsSrcTypeSV(x)||MSAPI_XC_IsSrcTypeATV(x)||MSAPI_XC_IsSrcTypeScart(x))///< x is VD
#define MSAPI_XC_IsSrcTypeAnalog(x)         ( MSAPI_XC_IsSrcTypeVga(x)|| MSAPI_XC_IsSrcTypeYPbPr(x))///< x is Analog
#define MSAPI_XC_IsSrcTypeVideo(x)          ( MSAPI_XC_IsSrcTypeYPbPr(x) || MSAPI_XC_IsSrcTypeATV(x) || MSAPI_XC_IsSrcTypeAV(x) || MSAPI_XC_IsSrcTypeSV(x) || MSAPI_XC_IsSrcTypeScart(x) || MSAPI_XC_IsSrcTypeDTV(x) ) ///< x is Video
#define MSAPI_XC_IsSrcTypeCapture(x)        ((int)(x)==(int)E_MSAPI_XC_INPUT_SOURCE_SCALER_OP)///< x is scaler OP
...
typedef enum
{
    ...
    E_MSAPI_XC_CMD_SET_SETWINDOW_TYPE               = 0x107,    ///< set setwindow type, Param: E_MSAPI_XC_SETWINDOW_TYPE
