...
#define CEC_MAX_LENGTH 14 //OSD
#define CEC_MESSAGE_BUFFER_SIZE 10
...
typedef struct
{
    ...
    MS_U8 u8Opcode;
    MS_U8 u8Length;
    MS_U8 u8Operand[CEC_MAX_LENGTH];
    MS_U32 u32RecvTime;
}E_MSAPI_CEC_MESSAGE_BUFFER;
...
MS_BOOL msAPI_CEC_Get_Device_List(MSAPI_XC_DEV_INFO* pstDeviceList);
MS_BOOL msAPI_CEC_GetMessageBuffer(E_MSAPI_CEC_MESSAGE_BUFFER* pstCecMessageBuffer, MS_U8* pu8LatestIndex);
MS_BOOL msAPI_CEC_OneTouchPlay(void);
MS_BOOL msAPI_CEC_Standby(E_MSAPI_CEC_DEVICELA eDeviceLA);
MS_BOOL msAPI_CEC_GiveDevicePowerStatus (E_MSAPI_CEC_DEVICELA eDeviceLA);
MS_BOOL msAPI_CEC_SystemAudioModeRequest(MS_BOOL bEnable);
