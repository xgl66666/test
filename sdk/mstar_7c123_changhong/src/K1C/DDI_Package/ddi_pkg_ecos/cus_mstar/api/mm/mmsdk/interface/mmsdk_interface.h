...
//-------------------------------------------------------------------------------------------------
/// Dequeue video input buffer for drm shared memory mode
/// @param Item              \b IN: Media item.
/// @param pSVPHandle       \b IN: The pointer of SVP handle
/// @param u32ESDataLength  \b IN: The size of decrypted ES data
///
/// @return TRUE: Success.
/// @return FALSE: Failure.
//-------------------------------------------------------------------------------------------------
MMSDK_BOOL MMSDK_DequeueVideoInputBuffer(MEDIAITEM Item, void *pSVPHandle, const MMSDK_U32 u32ESDataLength);

//-------------------------------------------------------------------------------------------------
/// Cancel video input buffer for drm shared memory mode
/// @param Item              \b IN: Media item.
/// @param pSVPHandle       \b IN: The pointer of SVP handle
///
/// @return TRUE: Success.
/// @return FALSE: Failure.
//-------------------------------------------------------------------------------------------------
MMSDK_BOOL MMSDK_CancelVideoInputBuffer(MEDIAITEM Item, void *pSVPHandle);

//=================  Download Module Related API  Begin =====================/
//-------------------------------------------------------------------------------------------------
///[Download Module] Set information to Download Module
/// @param eDownloadModuleInfo          \b IN: Download Module Info
/// @param u32Value                            \b IN: Value of eDownloadModuleInfo
///
///
/// @return TRUE: Success.
/// @return FALSE: Failure.
//-------------------------------------------------------------------------------------------------
MMSDK_BOOL MMSDK_SetDownloadModuleInfo_EX(EN_MMSDK_DOWNLOADMODULE_INFO eDownloadModuleInfo, MMSDK_U32 u32Value);
