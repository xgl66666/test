...
#ifndef _Dapi_STILLIMAGE_DLMALLOC_H_
#define _Dapi_STILLIMAGE_DLMALLOC_H_
...
// Defines & Macros
//------------------------------------------------------------------------------
#ifdef _Dapi_STILLIMAGE_DLMALLOC_C_
#define INTERFACE
#else
...
//------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
///This API is used to set the cache pool ID to malloc memory by other function
/// @param: s32CachePoolId: The address of the buffer assigned for dynamic memory pool
/// @return: TRUE if setting success. FALSE if s32CachePoolId.
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL Dapi_StillImage_Dlmalloc_SetCachePoolId(MS_S32 s32CachePoolId);
...
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL Dapi_StillImage_Dlmalloc_InitMemPool(void *pAddr, MS_U32 u32Size);
...
//-------------------------------------------------------------------------------------------------
INTERFACE void *Dapi_StillImage_Dlmalloc_Malloc(MS_U32 u32Size);
...
//-------------------------------------------------------------------------------------------------
INTERFACE void Dapi_StillImage_Dlmalloc_Free(void *pMem);
...
#endif  // #ifndef _Dapi_STILLIMAGE_DLMALLOC_H_
