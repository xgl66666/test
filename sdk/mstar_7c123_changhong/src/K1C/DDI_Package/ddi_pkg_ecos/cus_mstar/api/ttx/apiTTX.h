...
typedef enum
{
    ...
    TTX_CMD_SET_ON_SCREEN_BUFFER_SIZE,
    TTX_CMD_SET_OFF_SCREEN_BUFFER_SIZE,
...
typedef struct
{
    MS_U8 u8Background;                 // 5 bits
    MS_U8 u8Foreground;                 // 5 bits
    MS_BOOL bFlash;
} MsMW_Blink;
...
} MsMW_TtxRndOp_t; /* renderer operation */

typedef struct
{
    /* operate interface */
    MsMW_TtxRndOp_t stRndOp;
    MsMW_TtxMemOp_t stMemOp;
    /* decoder status */
    /* segment object record */
    /* dvb subtitling segment object */

    /* renderer parameters */
    /* self-renderer adaption layer */
    /* memory pool */
    /* data operation */
    /* task resource */
    /* dmx resource */
...
void apiTTX_SetDMXFltSrc(MS_U32 );

//-------------------------------------------------------------------------------------------------
/// Init teletext
/// @param MW memory operation
// @return TRUE
// @return FALSE
//-------------------------------------------------------------------------------------------------
MS_BOOL apiTTX_Init(MsMW_TtxMemOp_t *pMemOp, MS_S32 s32CachePoolID, MS_S32 s32NonCachePoolID);

//-------------------------------------------------------------------------------------------------
/// Init teletext with Renderer operator
/// @param MW memory operation
// @return TRUE
// @return FALSE
//-------------------------------------------------------------------------------------------------
MS_BOOL apiTTX_Init_EX(MsMW_TtxRndOp_t* pRndOp, MsMW_TtxMemOp_t *pMemOp, MS_S32 s32CachePoolID, MS_S32 s32NonCachePoolID);

//-------------------------------------------------------------------------------------------------

void apiTTX_MMPush(MS_U32 u32StartAddress, MS_U32 u32Length, MS_U32 u32PTSStart);

typedef enum _TTX_CHARSET
{
    E_TTX_CHARSET_G0_Latin,
    E_TTX_CHARSET_G2_Latin,
    E_TTX_CHARSET_G0_Cyrillic1,
    E_TTX_CHARSET_G0_Cyrillic2,
    E_TTX_CHARSET_G0_Cyrillic3,
    E_TTX_CHARSET_G2_Cyrillic,
    E_TTX_CHARSET_G0_Greek,
    E_TTX_CHARSET_G2_Greek,
    E_TTX_CHARSET_G0_Arabic,
    E_TTX_CHARSET_G2_Arabic,
    E_TTX_CHARSET_G0_Hebrew,
    E_TTX_CHARSET_G1_Block_Mosaic,
    E_TTX_CHARSET_G1_Block_Mosaic_Seperated,
    E_TTX_CHARSET_G3_Smooth_Mosaic,
    E_TTX_CHARSET_MAX
} TTX_CHARSET;

// Don't change the series
typedef enum _TTX_CHARSET_LG
{
    E_TTX_CHARSET_LG_Czech,
    E_TTX_CHARSET_LG_English,
    E_TTX_CHARSET_LG_Estonian,
    E_TTX_CHARSET_LG_French,
    E_TTX_CHARSET_LG_German,
    E_TTX_CHARSET_LG_Lettish,
    E_TTX_CHARSET_LG_Polish,
    E_TTX_CHARSET_LG_Spanish,
    E_TTX_CHARSET_LG_Rumanian,
    E_TTX_CHARSET_LG_Serbian,
    E_TTX_CHARSET_LG_Swedish,
    E_TTX_CHARSET_LG_Turkish,
    E_TTX_CHARSET_LG_MAX,
} TTX_CHARSET_LG;

typedef struct
{
    MS_U8 u8Code;
    MS_U32 u32ArrayIndex;
    TTX_CHARSET eCharset;
} stTTX_Charset;
...
void apiTTX_SetFontTable(MS_U8 *pu8Table, MS_U32 u32Size);

MS_BOOL apiTTX_SetCharset(stTTX_Charset *pstTable, MS_U16 u16Size);

MS_BOOL apiTTX_SetLatinNational(stTTX_LationNation *pstTable, MS_U16 u16Size);

MS_BOOL apiTTX_SetDiacritical(stTTX_Diacritcal *pstTable, MS_U16 u16Size);
