...
#define ENABLE_FREE_TYPE 1
#else
#define ENABLE_FREE_TYPE 0
#endif
...
// Subtitle True Type Font table init, it could be called before video play
INTERFACE BOOLEAN msAPI_DivXTTF_InitTTF(U32 u32addr, U32 u32size);
INTERFACE BOOLEAN msAPI_DivXTTF_DeinitTTF(void);
#endif
...
// Set subtitle highlight region information
INTERFACE void msAPI_MpegSP_Set_Highlight_Info(U16 u16Regionx, U16 u16Regiony, U16 u16RegionWidth, U16 u16RegionHeight, U32 *u32PaletteArray);

//set which gop use for subtitle
INTERFACE void msAPI_MpegSP_Set_GOP(U8 u8gop);

//set gop destination type use for subtitle
INTERFACE void msAPI_MpegSP_Set_GOP_Dst_Type(U8 u8GopDstType);
