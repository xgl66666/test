...
#define MP3_TAG_ID3v2_2_TP1      0x545031
...
INTERFACE U32 msAPI_Music_Parse_ID3v2(U32 u32FileBuffAddr, MP3_INFO *pMp3InfoPtr, BOOLEAN bGetMp3OffsetOnly);
INTERFACE void msAPI_Music_Parse_ID3v2_Ext(U32 u32FileBuffAddr, MP3_INFO *pMp3InfoPtr, U32 u32ID3TagV2Size);
...
INTERFACE U16 msAPI_Music_GetPCMBufferSize2(U16 u16BitRate,U16 u16SampleRate);
...
INTERFACE void msAPI_AUD_I2S_Amp_UnReset(void);
INTERFACE void msAPI_AUD_SW_Reset(void);
