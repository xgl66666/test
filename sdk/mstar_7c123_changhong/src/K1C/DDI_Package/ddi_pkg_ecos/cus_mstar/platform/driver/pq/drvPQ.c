...
#if(PQ_QM_VE_HVSP == 1)
MS_U32 gu32LastPQIPVEHSPSRAM1_Main = 0xFFFFFFFF;
MS_U32 gu32LastPQIPVEHSPSRAM2_Main = 0xFFFFFFFF;
MS_U32 gu32LastPQIPVEVSPSRAM1_Main = 0xFFFFFFFF;
MS_U32 gu32LastPQIPVEVSPSRAM2_Main = 0xFFFFFFFF;
#endif
...
//Main Window
        ...
        if(!pstPQInitInfo->bSkipCommTable)
        {
...
#if(PQ_QM_VE_HVSP == 1)
        if (gu32LastPQIPVEHSPSRAM1_Main != 0xFFFFFFFF)
        {
            Hal_PQ_set_ve_hvsp_h_sram_table(SC_FILTER_VE_HVSP_H_SRAM1, (void *)gu32LastPQIPVEHSPSRAM1_Main);
        }

        if (gu32LastPQIPVEHSPSRAM2_Main != 0xFFFFFFFF)
        {
            Hal_PQ_set_ve_hvsp_h_sram_table(SC_FILTER_VE_HVSP_H_SRAM2, (void *)gu32LastPQIPVEHSPSRAM2_Main);
        }

        if (gu32LastPQIPVEVSPSRAM1_Main != 0xFFFFFFFF)
        {
            Hal_PQ_set_ve_hvsp_v_sram_table(SC_FILTER_VE_HVSP_V_SRAM1, (void *)gu32LastPQIPVEVSPSRAM1_Main);
        }

        if (gu32LastPQIPVEVSPSRAM2_Main != 0xFFFFFFFF)
        {
            Hal_PQ_set_ve_hvsp_v_sram_table(SC_FILTER_VE_HVSP_V_SRAM2, (void *)gu32LastPQIPVEVSPSRAM2_Main);
        }
#endif
        //common bw table
