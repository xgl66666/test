...
//  Local Variables
//-------------------------------------------------------------------------------------------------
E_FRC_MODE _eScalerAdaptiveGetFRCMode = E_FRC_MODE_NONE;
...
{
    MS_U32 u32Reg78 = 0, u32Reg79 = 0, u32Reg7A = 0, u32Reg7B = 0, u32Reg7C = 0, u32Reg7D = 0, u32Reg7E = 0, filmFeatherCount = 0;
    MS_U32 curCounter3 = 0, cntDiff = 0;
    MS_U8 u8xxxCtrl = 0;
    MS_BOOL verticalMovingU = FALSE, horizontalMoving = FALSE, slowMotion = FALSE, featheringScene = FALSE, featheringScene2 = FALSE;
    static MS_U8 u8SkipCnt = 0;
    static MS_U8 featheringFrameCount = 0;
    static MS_U8 s8DeBouncingCnt = 0;
    ...
    MS_BOOL skipCond = FALSE;
    MS_BOOL verticalMoving2 = FALSE;

    MS_BOOL filmDisableMCDiDFK = FALSE;
    ...
    MS_U16 reg_debouncing_th = 0, reg_debouncing_cnt = 0;
...
void MDrv_SC_mcdi_driver_new(MS_U32 u32MotionValue, MS_U8 u8MotLvl)
{
    ...
    MS_U32 curCounter3 = 0, cntDiff = 0;
    MS_U8 u8xxxCtrl = 0;
    MS_BOOL verticalMovingU = FALSE, horizontalMoving = FALSE, slowMotion = FALSE, featheringScene = FALSE, featheringScene2 = FALSE, movingScene = FALSE;
    static MS_U8 u8SkipCnt = 0;
    static MS_U8 featheringFrameCount = 0;
    static MS_U8 s8DeBouncingCnt = 0;
    //static MS_U8 stillFrameCnt = 0;
...
{
    MS_U32 before_MC_feather = 0;
    MS_U32 nonMV0_Comfirm = 0, MV_Contradict = 0;
    MS_U32 MovingFeather = 0, MV_Confirm = 0;
...
MS_U32 MDrv_SC_T12_UC_InSearchRange_nonMv0Comfirm(void)
{
    ...
    static MS_U32 Prev_nonMV0_Comfirm = 0;
    static MS_U32 Prev_MV_Contradict = 0;
    MS_U32 MV_Comfirm = 0, Comfirm_Value = 0;
...
{
    MS_U32 Statistics_cplx_pixel = 0;
...
void MDrv_SC_mcnr_driver(void)
{
    ...
    MS_BOOL me_not_confirm = FALSE, me_vertical = FALSE/*, scene_change*/;
    static MS_U8 u8notConfirmCnt = 0;
    //static MS_U32 last_u32_mvNotFound = 0;
    //static MS_U8 u8SceneChangeFrame = 0, u8LastNRStrength = 0;
...
void MDrv_SC_de_bouncing(MS_U32 u32MotionValue)
{
    ...
    if(_eScalerAdaptiveGetFRCMode == E_FRC_MODE_VDEC_DROP)
    {
...
// In FRC case,because VDEC FRC drop frame ,cause motion detection calculate loss
// Add this function ,when FRC happen msapi can use this function setting variable "_eScalerAdaptiveGetFRCMode"
void MDrv_XC_ScalerAdaptiveGetFRCMode(E_FRC_MODE eFRCMode)
{
    _eScalerAdaptiveGetFRCMode = eFRCMode;
}
...
void MDrv_SC_de_pre_snr(MS_U32 u32MotionValue)
{
    ...
    MS_U32 reg_preSnr_th = 0;
    MS_U32 reg_preSnr_cnt = 0;
...
void MDrv_SC_dynamic_snr(MS_U32 u32MotionValue)
{
    ...
    MS_U8  u8SNR_Bypass = 0;
    MS_U32 reg_snr_cnt = 0;
...
void MDrv_SC_fantastic_dnr(void)
{
    ...
    MS_U8 u8DNR_TblY_0L = 0, u8DNR_TblY_0H = 0, u8DNR_TblY_1L = 0, u8DNR_TblY_1H = 0;
    MS_U8 u8DNR_TblY_2L = 0, u8DNR_TblY_2H = 0, u8DNR_TblY_3L = 0, u8DNR_TblY_3H = 0;
...
{
    MS_U8 u8Value = 0;
    MS_U16 u16_unmatch_3 = 0;
    static MS_U8 u8PrevLuma = 0, u8_unmatch_3_Cnt = 0;
...
{
    XC_ApiStatus stXCStatus;
    static MS_U8 u8FilmCnt = 0,u8_unmatch_3_Cnt = 0;

    MS_U32 u32Reg7C = 0, u32Reg7D = 0, u32Reg7E = 0, u16_unmatch_3 = 0;
    MS_BOOL verticalMovingU = FALSE;
...
void MDrv_SC_SDHD_DETECT_driver(void)
{
    ...
    MS_U16 u16MinPixel = 0, u16MaxPixel = 0, MaxMinPixel = 0;
        MS_U32 HDcnt_Act = 0, HDcnt_NonAct = 0;
        MS_U32 SDcnt_Act = 0, SDcnt_NonAct = 0;
    ...
    MS_U16 HDSDD_Det_threshold = 0, HDSDD_Det_offset = 0;
...
{
        MS_U8 u8Value = 0,FEATHER_CNT_TH = 0;
        MS_U16 u16MinPixel = 0,u16MaxPixel = 0, MaxMinPixel = 0;
        MS_U32 HDcnt_Act = 0, HDcnt_NonAct = 0,FeatherCnt = 0;
        MS_U32 SDcnt_Act = 0, SDcnt_NonAct = 0;
        ...
        static MS_U16 u16PrevMaxPixel = 0;
        MS_U32 HD_ConfirmCnt_Reg = 0;
        MS_U16 HDSDD_Det_threshold,HDSDD_Det_offset = 0;
...
void MDrv_SC_HISNR_Maria10_driver(MS_U16 u16Width, MS_U16 u16Height)
{
    ...
    MS_U16 noise_histogram[10] = {0};            //noise level detection
    MS_U16 noise_histogram_scaled[10] = {0};
    MS_U16 noise_histogram_hm[8] = {0};          // hismatching
    MS_U16 noise_histogram_hm_scaled[8] = {0};
    MS_U8 rounding_bit = 0;
    MS_U8 rounding_array[16] = {0};



    MS_U16 u16Height_div = 0;
...
//  MS_U32 md_lut_level3[16] = {0,1,3,5,7,9,11,13,15,15,12,10,8,6,3,0} ;
    ...
    MS_U16 H_start_width = 0, H_end_width = 0;
    ...
    if(histogram_ack_en)
    {
        ...
        MS_U16  LargerThanHigh = 0, Off_from_low = 0; // cond_diagonal, BitsValue_3,adjust_alpha;
        ...
        */
        ...
        MS_U16 BitsValue_4 = 0;
        MS_U16 decrease_alpha_final = 0;
...
void MApi_XC_AdaptiveTuning(void)
{
    ...
    MS_U8 u8CurrentVcnt = 0;
    MS_U8  u8Ctrl,ColorSum = 0;
    MS_U8  u8Ctrl2 = 0;
    MS_U32 u32MotionValue = 0,u32MotionValue2 = 0,OOSRMC = 0,OOSRF = 0,ISR_NONMV0 = 0,SmallMoving = 0,VerticalMoving = 0,HorizontalMoving = 0,TotalFeather = 0,TotalMvComfirm = 0;
    MS_U32 uComplex = 0;
    MS_U8 u8MotLvl = 0;
    XC_ApiStatus stXCStatus;
