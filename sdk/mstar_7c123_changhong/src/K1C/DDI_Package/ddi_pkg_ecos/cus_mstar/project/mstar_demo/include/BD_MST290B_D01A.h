...
#define BOARD_NAME                  "BD_MST290B_D01A"
...
//------TUNER 1 Setting----------------------------------------------------------
#define FRONTEND_TUNER_PORT1         E_HWI2C_PORT1_1 //con40
...
#define GPIO_USB0_POWER PAD_NC // please check again with Vic!!!!!
...
#define GPIO_SCART_PIN8                  PAD_NC        //SCART_PIN8_CTL0(Pin8_6V)      (NA)
#define GPIO_SCART_PIN16                 PAD_NC   //RGB/CVBS                      (GPIO19)
#define GPIO_SCART_ONSTBY                PAD_NC        //SCART_PIN8_CTL1(Pin8_0V)      (NA)
