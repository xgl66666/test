...
#define KERNEL_POOL_LEN                                        0x0003310000
#define KERNEL_POOL_MEMORY_TYPE                                (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* CACHED_POOL_BUF   */
//co_buffer L0
#define CACHED_POOL_BUF_AVAILABLE                              0x0003310000
#define CACHED_POOL_BUF_ADR                                    0x0003310000  //Alignment 0
...
/* PM51_BUF   */
//co_buffer L0
#define PM51_BUF_AVAILABLE                                     0x0003310000
#define PM51_BUF_ADR                                           0x0003310000  //Alignment 0x01000
...
/* NON_CACHED_POOL_BUF   */
//co_buffer L0
#define NON_CACHED_POOL_BUF_AVAILABLE                          0x0003329400
#define NON_CACHED_POOL_BUF_ADR                                0x0003329400  //Alignment 0
#define NON_CACHED_POOL_BUF_GAP_CHK                            0x0000000000
#define NON_CACHED_POOL_BUF_LEN                                0x00006A0000
#define NON_CACHED_POOL_BUF_MEMORY_TYPE                        (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* HW_BUF0_START_TAG   */
//co_buffer L0
#define HW_BUF0_START_TAG_AVAILABLE                            0x00039C9400
#define HW_BUF0_START_TAG_ADR                                  0x00039C9400  //Alignment 0
...
/* SECTION_BUF   */
//co_buffer L0
#define SECTION_BUF_AVAILABLE                                  0x00039C9400
#define SECTION_BUF_ADR                                        0x00039C9400  //Alignment 0x00010
...
/* SDRAM_ADR_BMP   */
//co_buffer L0
#define SDRAM_ADR_BMP_AVAILABLE                                0x00039C9400
#define SDRAM_ADR_BMP_ADR                                      0x00039C9400  //Alignment 0
...
/* SDRAM_ADR_FONT   */
//co_buffer L0
#define SDRAM_ADR_FONT_AVAILABLE                               0x00039C9400
#define SDRAM_ADR_FONT_ADR                                     0x00039C9400  //Alignment 0
...
/* SC0_MENULOAD_BUF   */
//co_buffer L0
#define SC0_MENULOAD_BUF_AVAILABLE                             0x00039C9400
#define SC0_MENULOAD_BUF_ADR                                   0x00039C9400  //Alignment 0x00010
...
/* TSP_VQ_BUF   */
//co_buffer L0
#define TSP_VQ_BUF_AVAILABLE                                   0x00039CD400
#define TSP_VQ_BUF_ADR                                         0x00039CD400  //Alignment 0
...
/* VE_FRAME_BUF   */
//co_buffer L0
#define VE_FRAME_BUF_AVAILABLE                                 0x00039CE400
#define VE_FRAME_BUF_ADR                                       0x00039CE400  //Alignment 0x00008
...
/* GOP_REG_DMA_BASE   */
//co_buffer L0
#define GOP_REG_DMA_BASE_AVAILABLE                             0x0003DC3020
#define GOP_REG_DMA_BASE_ADR                                   0x0003DC4000  //Alignment 0x04000
...
/* GOP_GWIN_RB   */
//co_buffer L0
#define GOP_GWIN_RB_AVAILABLE                                  0x0003DC5000
#define GOP_GWIN_RB_ADR                                        0x0003DC5000  //Alignment 0x00010
...
/* TSP_FW_BUF   */
//co_buffer L0
#define TSP_FW_BUF_AVAILABLE                                   0x0004795000
#define TSP_FW_BUF_ADR                                         0x0004795000  //Alignment 0x00100
...
/* MIU0_COBUF_START   */
//co_buffer L0
#define MIU0_COBUF_START_AVAILABLE                             0x000479B000
#define MIU0_COBUF_START_ADR                                   0x000479B000  //Alignment 0
...
/* Other   */
//co_buffer L5
#define Other_AVAILABLE                                        0x000479B000
#define Other_ADR                                              0x000479B000  //Alignment 0
...
/* VDPLAYER_TAG   */
//co_buffer L1
#define VDPLAYER_TAG_AVAILABLE                                 0x000479B000
#define VDPLAYER_TAG_ADR                                       0x000479B000  //Alignment 0
...
/* VDPLAYER_DATA   */
//co_buffer L1
#define VDPLAYER_DATA_AVAILABLE                                0x000479B000
#define VDPLAYER_DATA_ADR                                      0x000479B000  //Alignment 0
...
/* VDPLAYER_SUB_BS   */
//co_buffer L1
#define VDPLAYER_SUB_BS_AVAILABLE                              0x0004A2C000
#define VDPLAYER_SUB_BS_ADR                                    0x0004A2C000  //Alignment 0
...
/* VDPLAYER_BS   */
//co_buffer L1
#define VDPLAYER_BS_AVAILABLE                                  0x0004B7C000
#define VDPLAYER_BS_ADR                                        0x0004B7C000  //Alignment 0x01000
...
/* VDPLAYER_SUB   */
//co_buffer L1
#define VDPLAYER_SUB_AVAILABLE                                 0x0004F7C000
#define VDPLAYER_SUB_ADR                                       0x0004F7C000  //Alignment 0x01000
...
/* VDPLAYER_DMX_SEC   */
//co_buffer L1
#define VDPLAYER_DMX_SEC_AVAILABLE                             0x0004FBC000
#define VDPLAYER_DMX_SEC_ADR                                   0x0004FBC000  //Alignment 0
...
/* PHY_COPY_DATA   */
//co_buffer L1
#define PHY_COPY_DATA_AVAILABLE                                0x0004FC0000
#define PHY_COPY_DATA_ADR                                      0x0004FC0000  //Alignment 0x01000
...
//co_buffer L1
#define MIU0_COBUF_L1_END_TAG_AVAILABLE                        0x0004FE0000
#define MIU0_COBUF_L1_END_TAG_ADR                              0x0004FE0000  //Alignment 0
...
/* PHOTO_SHARE_MEM   */
//co_buffer L2
#define PHOTO_SHARE_MEM_AVAILABLE                              0x000479B000
#define PHOTO_SHARE_MEM_ADR                                    0x000479B000  //Alignment 0
...
/* PHOTO_DISPLAY   */
//co_buffer L2
#define PHOTO_DISPLAY_AVAILABLE                                0x000479C000
#define PHOTO_DISPLAY_ADR                                      0x000479C000  //Alignment 0x00010
...
/* JPD_INTER_BUF   */
//co_buffer L2
#define JPD_INTER_BUF_AVAILABLE                                0x0004B98000
#define JPD_INTER_BUF_ADR                                      0x0004B98000  //Alignment 0x00200
...
/* JPD_READ_BUF   */
//co_buffer L2
#define JPD_READ_BUF_AVAILABLE                                 0x00051C8000
#define JPD_READ_BUF_ADR                                       0x00051C8000  //Alignment 0x00010
...
/* JPD_OUT   */
//co_buffer L2
#define JPD_OUT_AVAILABLE                                      0x0005218000
#define JPD_OUT_ADR                                            0x0005218000  //Alignment 0x00008
...
/* TSP_FQ_BUF   */
//co_buffer L2
#define TSP_FQ_BUF_AVAILABLE                                   0x000560C800
#define TSP_FQ_BUF_ADR                                         0x000560C800  //Alignment 0x00010
...
//co_buffer L2
#define MIU0_COBUF_L2_END_TAG_AVAILABLE                        0x0005A0C880
#define MIU0_COBUF_L2_END_TAG_ADR                              0x0005A0C880  //Alignment 0
...
//co_buffer L3
#define MIU0_COBUF_L3_END_TAG_AVAILABLE                        0x000479B000
#define MIU0_COBUF_L3_END_TAG_ADR                              0x000479B000  //Alignment 0
...
//co_buffer L4
#define MIU0_COBUF_L4_END_TAG_AVAILABLE                        0x000479B000
#define MIU0_COBUF_L4_END_TAG_ADR                              0x000479B000  //Alignment 0
...
/* MIU0_COBUF_END_TAG   */
//co_buffer L0
#define MIU0_COBUF_END_TAG_AVAILABLE                           0x0005A0C880
#define MIU0_COBUF_END_TAG_ADR                                 0x0005A0C880  //Alignment 0
...
/* VDPLAYER_SHARE_MEM   */
//co_buffer L0
#define VDPLAYER_SHARE_MEM_AVAILABLE                           0x0005A0C880
#define VDPLAYER_SHARE_MEM_ADR                                 0x0005A0D000  //Alignment 0x01000
...
/* MAD_ADV_BUF   */
//co_buffer L0
#define MAD_ADV_BUF_AVAILABLE                                  0x0005A0E000
#define MAD_ADV_BUF_ADR                                        0x0005A0E000  //Alignment 0x01000
#define MAD_ADV_BUF_GAP_CHK                                    0x0000000000
#define MAD_ADV_BUF_LEN                                        0x0000500000
#define MAD_ADV_BUF_MEMORY_TYPE                                (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* VDEC_MEM_START_TAG   */
//co_buffer L0
#define VDEC_MEM_START_TAG_AVAILABLE                           0x0005F0E000
#define VDEC_MEM_START_TAG_ADR                                 0x0005F0E000  //Alignment 0
...
/* VDEC_AEON   */
//co_buffer L0
#define VDEC_AEON_AVAILABLE                                    0x0005F0E000
#define VDEC_AEON_ADR                                          0x0005F0E000  //Alignment 0
...
/* VDEC_FRAME_BUF   */
//co_buffer L0
#define VDEC_FRAME_BUF_AVAILABLE                               0x00060DACD0
#define VDEC_FRAME_BUF_ADR                                     0x00060DAE00  //Alignment 0x00200
...
/* VDEC_BIT_STREAM   */
//co_buffer L0
#define VDEC_BIT_STREAM_AVAILABLE                              0x00078DAE00
#define VDEC_BIT_STREAM_ADR                                    0x00078DAE00  //Alignment 0x00008
...
/* SC0_MAIN_FB   */
//co_buffer L0
#define SC0_MAIN_FB_AVAILABLE                                  0x0007CDAE00
#define SC0_MAIN_FB_ADR                                        0x0007CDAE00  //Alignment 0
...
/* UNUSED   */
//co_buffer L0
#define UNUSED_AVAILABLE                                       0x0007FDAE00
#define UNUSED_ADR                                             0x0007FDAE00  //Alignment 0
#define UNUSED_GAP_CHK                                         0x0000000000
#define UNUSED_LEN                                             0x0000005200
