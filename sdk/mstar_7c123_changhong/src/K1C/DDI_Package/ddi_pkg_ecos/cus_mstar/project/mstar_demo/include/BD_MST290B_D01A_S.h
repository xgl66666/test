...
#define BOARD_NAME                  "BD_MST290B_D01A_S"
...
#define FRONTEND_TUNER_PORT0        E_HWI2C_PORT0_1
#define FRONTEND_TUNER_CTRL         PIU_IIC_0
#define FRONTEND_PORT0_WO_EXT_DEMOD
//------TUNER 1 Setting----------------------------------------------------------
#define FRONTEND_TUNER_PORT1         E_HWI2C_PORT1_1
#define FRONTEND_TUNER_CTRL1         PIU_IIC_0
#define FRONTEND_TUNER_PORT1_INT     E_INT_IRQ_TS0_VLD
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO		        PAD_HDMI_HPD

// ----- USB Port0 Power Control -----------------------------------------------
#define GPIO_USB0_POWER PAD_NC //check again with Vic!!!!!!
...
#define GPIO_FE_RST                      PAD_SM0_PCT //Tuner RST
#define GPIO_FE_RST1                     PAD_SM0_PCT //The same as GPIO_FE_RST since QFP does not have enough GPIO
#define GPIO_SMC0_EXT_8024_VOL_CTRL      PAD_SM0_GPIO //SMC EXT8024 Voltage Ctrl

//------GPIO/SCART pin mapping------------------------------------
#define GPIO_SCART_PIN8                  PAD_NC   //SCART_PIN8_CTL0(Pin8_6V)      (GPIO_108)
#define GPIO_SCART_PIN16                 PAD_NC   //RGB/CVBS                      (GPIO_109)
#define GPIO_SCART_ONSTBY                PAD_NC //SCART_PIN8_CTL1(Pin8_0V)      (GPIO_3)
