...
//------------------------------DRAM Type---------------------------------------
#define DDR2_SELFREFRESH    0
#define DDR3_SELFREFRESH    1
...
#define MMAP_256MB_256MB        12
#define MMAP_512MB              13
#define MMAP_512MB_512MB        14
#define MMAP_256MB              15
...
// K1C
#define BD_MST290A_D01A                 0x0A90
#define BD_MST290A_D01A_S               0x0A91
#define BD_MST290B_D01A                 0x0A92
#define BD_MST290B_D01A_S               0x0A93
#define BD_MST290C_D01A_S               0x0A95
...
#define MODEL_NAME              "DVB-----"     // Used in imginfo.c. 9 characters.
...
#if (MS_BOARD_TYPE_SEL == BD_MST290A_D01A)
	#include "BD_MST290A_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST290A_D01A_S)
	#include "BD_MST290A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST290B_D01A)
	#include "BD_MST290B_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST290B_D01A_S)
	#include "BD_MST290B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST290C_D01A_S)
	#include "BD_MST290C_D01A_S.h"
#else
...
//------------------------------ PM-STR Usage -------------------------------
#define STR_STATUS_REG       0x1cec  // Use REG_PM_RIU_DUMMY7
#define STR_IRQ_FORCE_REG    0x334c // Use CEC IRQ, at REG_HST2_IRQ_FORCE_63_48
#define STR_IRQ_FORCE_CLEAR_NUM    (0x1 << 5) // CEC IRQ Number
#define STR_IRQ_FORCE_NUM    E_INT_IRQ_CEC

// ------------------------------Support MSPI load demod FW -------------------
#ifndef SUPPORT_MSPI_LOAD_CODE
#define SUPPORT_MSPI_LOAD_CODE 1

#if SUPPORT_MSPI_LOAD_CODE
#define MSPI_PATH_MAX 2
#define MSPI_PATH_NONE 0xff
#define MSPI_PATH_DETECT 1
#endif
