...
static inline void unlock_usb_core(void)
{
    USB_core_lock = 0;
}

static inline void lock_usb_core(void)
{
...
extern void *ncmem_alloc_block(size_t size);
extern void ncmem_free_block(U32 addr);
...
static inline void Chip_Read_Memory(void)
{
    MsOS_ReadMemory();
}
