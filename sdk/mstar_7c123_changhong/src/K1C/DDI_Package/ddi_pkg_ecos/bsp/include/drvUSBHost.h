...
#define MS_FLAG_URB_TRANSFER_DMA_MAP    0x0004  // set the bit if urb->transfer_dma valid
#define MS_FLAG_URB_SETUP_DMA_MAP       0x0008  // set the bit if urb->setup_dma valid
...
extern int ms_usb_get_device_string(struct usb_device *udev);
