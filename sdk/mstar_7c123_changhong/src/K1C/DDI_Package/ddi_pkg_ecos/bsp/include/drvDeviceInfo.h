...
#define SERFLASH_SECTOR_SIZE                SIZE_64KB
...
#define SERFLASH_OPT_TABLE                  (u32OtpTblSize)
...
typedef   struct   {
     MS_U32  u32OTPLowerBound;
     MS_U32  u32OTPUpperBound;
}ST_OTP_REGION;
...
typedef   struct   {
    ...
    MS_U32  u32FlashSize;
    MS_U32  u32NumSec;
    MS_U8   u8WrsrBlkProtect;
    MS_U16  u16SPIMaxClk[2];
    MS_BOOL b2XREAD;
    ST_HYBRID_BLOCK *pHybridBlcoks;
    ST_OTP_REGION   *pOTP_RegionTable;
    MS_U16  u16ProtectTbl_Size;
    MS_U8   u8SRSDatByte;
}hal_SERFLASH_t;
...
{
     {ISP_SPI_CMD_64BE,          0x0,     0xFF,     SIZE_64KB},
     {ISP_SPI_CMD_SE,          0x100,     0x10E,     SIZE_4KB},
     {0x0,                    0xFFFF,     0xFFFF,     0xFFFFFFFF},
};
static ST_HYBRID_BLOCK _stHybridBlocks_S25FL127S_bot[] =
{
     {ISP_SPI_CMD_SE,          0x0,     0xF,     SIZE_64KB},
     {ISP_SPI_CMD_64BE,          0x10,     0x10E,     SIZE_64KB},
     {0x0,                    0xFFFF,     0xFFFF,     0xFFFFFFFF},
};
static ST_HYBRID_BLOCK _stHybridBlocks_S25FL128S[] =
{
     {ISP_SPI_CMD_64BE,          0x0,     0xFD,     SIZE_64KB},
     {ISP_SPI_CMD_SE,          0xFE,     0x10D,     SIZE_4KB},
     {ISP_SPI_CMD_SE,          0x10E,     0x11D,     SIZE_4KB},
     {0x0,                    0xFFFF,     0xFFFF,     0xFFFFFFFF},
};
static ST_HYBRID_BLOCK _stHybridBlocks_S25FL128P[] =
{
     {ISP_SPI_CMD_64BE,          0x0,     0xFD,     SIZE_64KB},
     {ISP_SPI_CMD_SE,          0xFE,     0x10D,     SIZE_4KB},
     {ISP_SPI_CMD_SE,          0x10E,     0x11D,     SIZE_4KB},
...
{
     {ISP_SPI_CMD_SE,          0x0,     0xF,     SIZE_4KB},
     {ISP_SPI_CMD_SE,          0x10,     0x1F,     SIZE_4KB},
     {ISP_SPI_CMD_64BE,          0x20,     0x12D,     SIZE_64KB},
     {0x0,                    0xFFFF,     0xFFFF,     0xFFFFFFFF},
};
...
static ST_WRITE_PROTECT   _pstWriteProtectTable_W25X64_Top[] =
{
    {  BITS(5:2, 1),  FROM_BLK(0, SIZE_64KB),  TO_BLK(1, SIZE_64KB)  },
    {  BITS(5:2, 2),  FROM_BLK(0, SIZE_64KB),  TO_BLK(3, SIZE_64KB)  },
    {  BITS(5:2, 3),  FROM_BLK(0, SIZE_64KB),  TO_BLK(7, SIZE_64KB)  },
    {  BITS(5:2, 4),  FROM_BLK(0, SIZE_64KB),  TO_BLK(15, SIZE_64KB)  },
    {  BITS(5:2, 5),  FROM_BLK(0, SIZE_64KB),  TO_BLK(31, SIZE_64KB)  },
    {  BITS(5:2, 6),  FROM_BLK(0, SIZE_64KB),  TO_BLK(63, SIZE_64KB)  },
...
static ST_WRITE_PROTECT   _pstWriteProtectTable_MX25L6455E_TOP[] =
{
    {  BITS(5:2, 1),  FROM_BLK(0, SIZE_64KB),  TO_BLK(0, SIZE_64KB)  },
    {  BITS(5:2, 2),  FROM_BLK(0, SIZE_64KB),  TO_BLK(1, SIZE_64KB)  },
    {  BITS(5:2, 3),  FROM_BLK(0, SIZE_64KB),  TO_BLK(3, SIZE_64KB)  },
...
{
    {  BITS(5:2, 1),  FROM_BLK(0, SIZE_64KB),  TO_BLK(3, SIZE_64KB)  },
    {  BITS(5:2, 2),  FROM_BLK(0, SIZE_64KB),  TO_BLK(7, SIZE_64KB)  },
    {  BITS(5:2, 3),  FROM_BLK(0, SIZE_64KB),  TO_BLK(15, SIZE_64KB)  },
    {  BITS(5:2, 4),  FROM_BLK(0, SIZE_64KB),  TO_BLK(31, SIZE_64KB)  },
    {  BITS(5:2, 5),  FROM_BLK(0, SIZE_64KB),  TO_BLK(63, SIZE_64KB)  },
    {  BITS(5:2, 6),  FROM_BLK(0, SIZE_64KB),  TO_BLK(127, SIZE_64KB)  },
    {  BITS(5:2, 7),  FROM_BLK(0, SIZE_64KB),  TO_BLK(255, SIZE_64KB)  },
    {  BITS(5:2, 0),  0xFFFFFFFF,        0xFFFFFFFF            },
};
...
static ST_OTP_REGION _pstOtpRegionTable_GD25Q128C[] =
{
      {0x001000,   0x0011FF },
      {0x002000,   0x0021FF },
      {0x003000,   0x0031FF },
};
static ST_OTP_REGION _pstOtpRegionTable_MX25L6406E[] =
{
      {0x000000,   0x00000F },
      {0x000010,   0x00003F },
};
static ST_OTP_REGION _pstOtpRegionTable_S25FL128P[] =
{
      {0x000000,   0x0003FF },
};
static ST_OTP_REGION _pstOtpRegionTable_W25Q128FV[] =
{
      {0x001000,   0x0010FF },
      {0x002000,   0x0020FF },
      {0x003000,   0x0030FF },
};
static ST_OTP_REGION _pstOtpRegionTable_W25Q64FV[] =
{
      {0x001000,   0x0010FF },
      {0x002000,   0x0020FF },
      {0x003000,   0x0030FF },
};
static ST_OTP_REGION _pstOtpRegionTable_MX25L12855E[] =
{
      {0x000000,   0x00000F },
      {0x000010,   0x0001FF },
};
static ST_OTP_REGION _pstOtpRegionTable_MX25L6455E[] =
{
      {0x000000,   0x00000F  },
      {0x000010,   0x000FFF },
};
static ST_OTP_REGION _pstOtpRegionTable_MX25L3254E[] =
{
      {0x000000,   0x00000F },
      {0x000010,   0x0001FF },
};
...
static hal_SERFLASH_t _hal_SERFLASH_table[] =
{ 
     { FLASH_IC_MX25L1655D,          MID_MXIC,        0x26,     0x15,   NULL,                                  NULL,                       SIZE_2MB,       32,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_MX25L3205D,          MID_MXIC,        0x20,     0x16,   _pstWriteProtectTable_MX25L3205D,      NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_MX25L3205D),     1},
     { FLASH_IC_MX25L3254E,          MID_MXIC,        0x9E,     0x16,   _pstWriteProtectTable_MX25L3254E,      NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     _pstOtpRegionTable_MX25L3254E,      sizeof(_pstWriteProtectTable_MX25L3254E),     1},
     { FLASH_IC_MX25L6406E,          MID_MXIC,        0x20,     0x17,   _pstWriteProtectTable_MX25L6406E,      NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     _pstOtpRegionTable_MX25L6406E,      sizeof(_pstWriteProtectTable_MX25L6406E),     1},
     { FLASH_IC_MX25L1606E,          MID_MXIC,        0x20,     0x15,   _pstWriteProtectTable_MX25L1606E,      NULL,                       SIZE_2MB,       32,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_MX25L1606E),     1},
     { FLASH_IC_MX25L12805D,         MID_MXIC,        0x20,     0x18,   _pstWriteProtectTable_MX25L12805D,     NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_MX25L12805D),    1},
     { FLASH_IC_MX25L6455E,          MID_MXIC,        0x26,     0x17,   _pstWriteProtectTable_MX25L6455E,      NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     _pstOtpRegionTable_MX25L6455E,      sizeof(_pstWriteProtectTable_MX25L6455E),     1},
     { FLASH_IC_MX25L12855E,         MID_MXIC,        0x26,     0x18,   _pstWriteProtectTable_MX25L12855E,     NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     _pstOtpRegionTable_MX25L12855E,     sizeof(_pstWriteProtectTable_MX25L12855E),    1},
     { FLASH_IC_MX25L4006E,          MID_MXIC,        0x20,     0x13,   _pstWriteProtectTable_MX25L4006E,      NULL,                       SIZE_512KB,     8,            BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_MX25L4006E),     1},
     { FLASH_IC_MX25L8006E,          MID_MXIC,        0x20,     0x14,   NULL,                                  NULL,                       SIZE_1MB,       16,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_W25Q16,              MID_WB,          0x40,     0x15,   NULL,                                  NULL,                       SIZE_2MB,       32,           BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            2},
     { FLASH_IC_W25Q80,              MID_WB,          0x40,     0x14,   _pstWriteProtectTable_W25Q80,          NULL,                       SIZE_1MB,       16,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_W25Q80),         1},
     { FLASH_IC_W25X32,              MID_WB,          0x30,     0x16,   _pstWriteProtectTable_W25X32,          NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_W25X32),         2},
     { FLASH_IC_W25Q32,              MID_WB,          0x40,     0x16,   _pstWriteProtectTable_W25Q32,          NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_W25Q32),         2},
     { FLASH_IC_W25X64,              MID_WB,          0x30,     0x17,   _pstWriteProtectTable_W25X64,          NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_W25X64),         2},
     { FLASH_IC_W25X80,              MID_WB,          0x30,     0x14,   _pstWriteProtectTable_W25X80,          NULL,                       SIZE_1MB,       16,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_W25X80),         1},
     { FLASH_IC_W25Q64FV,            MID_WB,          0x40,     0x17,   _pstWriteProtectTable_W25Q64FV,        NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     _pstOtpRegionTable_W25Q64FV,        sizeof(_pstWriteProtectTable_W25Q64FV),       1},
     { FLASH_IC_W25Q128FV,           MID_WB,          0x40,     0x18,   _pstWriteProtectTable_W25Q128FV,       NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     _pstOtpRegionTable_W25Q128FV,       sizeof(_pstWriteProtectTable_W25Q128FV),      1},
     { FLASH_IC_W25X40,              MID_WB,          0x30,     0x13,   _pstWriteProtectTable_W25X40,          NULL,                       SIZE_512KB,     8,            BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_W25X40),         1},
     { FLASH_IC_AT26DF321,           MID_ATMEL,       0x47,     0x00,   _pstWriteProtectTable_AT26DF321,       NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_AT26DF321),      1},
     { FLASH_IC_STM25P32,            MID_ST,          0x20,     0x16,   NULL,                                  NULL,                       SIZE_512KB,     8,            BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_EN25B32B,            MID_EON,         0x20,     0x16,   NULL,                                  &_stSpecialBlocks_EN25B32B, SIZE_4MB,       64,           BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_EN25B64B,            MID_EON,         0x20,     0x17,   NULL,                                  &_stSpecialBlocks_EN25B64B, SIZE_8MB,       128,          BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_S25FL032P,           MID_SPAN,        0x02,     0x15,   _pstWriteProtectTable_S25FL032P,       NULL,                       SIZE_4MB,       64,           BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_S25FL032P),      1},
     { FLASH_IC_S25FL064P,           MID_SPAN,        0x02,     0x16,   _pstWriteProtectTable_S25FL064P,       NULL,                       SIZE_8MB,       128,          BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_S25FL064P),      1},
     { FLASH_IC_S25FL128P,           MID_SPAN,        0x20,     0x18,   _pstWriteProtectTable_S25FL128P,       NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, _stHybridBlocks_S25FL128P,_pstOtpRegionTable_S25FL128P,       sizeof(_pstWriteProtectTable_S25FL128P),      1},
     { FLASH_IC_S25FL008A,           MID_SPAN,        0x20,     0x13,   _pstWriteProtectTable_S25FL008A,       NULL,                       SIZE_1MB,       16,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_S25FL008A),      1},
     { FLASH_IC_S25FL164K,           MID_SPAN,        0x40,     0x17,   _pstWriteProtectTable_S25FL164K,       NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_S25FL164K),      1},
     { FLASH_IC_S25FL128L,           MID_SPAN,        0x60,     0x18,   _pstWriteProtectTable_S25FL128L,       NULL,                       SIZE_8MB,       128,          BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_S25FL128L),      1},
     { FLASH_IC_EN25F10,             MID_EON,         0x31,     0x11,   NULL,                                   &_stSpecialBlocks_EN25F10, SIZE_256KB,     4,            BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_EN25F16,             MID_EON,         0x31,     0x15,   _pstWriteProtectTable_EN25F16,         NULL,                       SIZE_8MB,       128,          BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25F16),        1},
     { FLASH_IC_EN25F32,             MID_EON,         0x31,     0x16,   _pstWriteProtectTable_EN25F32,         NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25F32),        1},
     { FLASH_IC_EN25F80,             MID_EON,         0x31,     0x14,   _pstWriteProtectTable_EN25F80,         NULL,                       SIZE_256KB,     4,            BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25F80),        1},
     { FLASH_IC_EN25P16,             MID_EON,         0x20,     0x15,   _pstWriteProtectTable_EN25P16,         NULL,                       SIZE_2MB,       32,           BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25P16),        1},
     { FLASH_IC_EN25Q32A,            MID_EON,         0x30,     0x16,   _pstWriteProtectTable_EN25Q32A,        NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25Q32A),       1},
     { FLASH_IC_EN25Q64,             MID_EON,         0x30,     0x17,   _pstWriteProtectTable_EN25Q64,         NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25Q64),        1},
     { FLASH_IC_EN25QA64A,           MID_EON,         0x60,     0x17,   _pstWriteProtectTable_EN25QA64A,       NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25QA64A),      1},
     { FLASH_IC_EN25Q128,            MID_EON,         0x30,     0x18,   _pstWriteProtectTable_EN25Q128,        NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25Q128),       1},
     { FLASH_IC_EN25F40,             MID_EON,         0x31,     0x13,   _pstWriteProtectTable_EN25F40,         NULL,                       SIZE_512KB,     8,            BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25F40),        1},
     { FLASH_IC_EN25QH16,            MID_EON,         0x70,     0x15,   _pstWriteProtectTable_EN25QH16,        NULL,                       SIZE_2MB,       32,           BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_EN25QH16),       1},
     { FLASH_IC_NUMONYX_M25PX16,     MID_NUMONYX,     0x73,     0x15,   _pstWriteProtectTable_NUMONYX_M25PX16, NULL,                       SIZE_2MB,       32,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_NUMONYX_M25PX16),1},
     { FLASH_IC_NUMONYX_N25Q32,      MID_NUMONYX,     0xBA,     0x16,   _pstWriteProtectTable_NUMONYX_N25Q32,  NULL,                       SIZE_4MB,       64,           BITS(4:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_NUMONYX_N25Q32), 1},
     { FLASH_IC_NUMONYX_N25Q64,      MID_NUMONYX,     0xBA,     0x17,   _pstWriteProtectTable_NUMONYX_N25Q64,  NULL,                       SIZE_8MB,       128,          BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_NUMONYX_N25Q64), 1},
     { FLASH_IC_PM25LQ032C,          MID_PMC,         0x9D,     0x46,   _pstWriteProtectTable_PM25LQ032C,      NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_PM25LQ032C),     1},
     { FLASH_IC_GD25S80,             MID_GD,          0x40,     0x14,   NULL,                                  NULL,                       SIZE_1MB,       16,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            2},
     { FLASH_IC_GD25Q16,             MID_GD,          0x40,     0x15,   _pstWriteProtectTable_GD25Q16,         NULL,                       SIZE_2MB,       32,           BITS(6:2,  0x1F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_GD25Q16),        1},
     { FLASH_IC_GD25Q32,             MID_GD,          0x40,     0x16,   NULL,                                  NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_GD25Q64,             MID_GD,          0x40,     0x17,   NULL,                                  NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_GD25Q128C,           MID_GD,          0x40,     0x18,   _pstWriteProtectTable_GD25Q128C,       NULL,                       SIZE_16MB,      256,          BITS(6:2,  0x1F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     _pstOtpRegionTable_GD25Q128C,       sizeof(_pstWriteProtectTable_GD25Q128C),      1},
     { FLASH_IC_A25LM032,            MID_AM,          0x30,     0x16,   NULL,                                  NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               0,                                            1},
     { FLASH_IC_ESMT_F25L032QA,      MID_ESMT,        0x41,     0x16,   _pstWriteProtectTable_ESMT_F25L032QA,  NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_ESMT_F25L032QA), 1},
     { FLASH_IC_ESMT_F25L032PA,      MID_ESMT,        0x20,     0x16,   _pstWriteProtectTable_ESMT_F25L032PA,  NULL,                       SIZE_4MB,       64,           BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_ESMT_F25L032PA), 1},
     { FLASH_IC_IS25LP64,            MID_ISSI,        0x60,     0x17,   _pstWriteProtectTable_IS25LP64,        NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_IS25LP64),       1},
     { FLASH_IC_IS25CQ032,           MID_ISSI,        0x15,     0x46,   _pstWriteProtectTable_IS25CQ032,       NULL,                       SIZE_4MB,       64,           BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_IS25CQ032),      1},
     { FLASH_IC_XM25QH64A,           MID_XM,          0x70,     0x17,   _pstWriteProtectTable_XM25QH64A,       NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_XM25QH64A),      2},
     { FLASH_IC_XM25QH128A,          MID_XM,          0x70,     0x18,   _pstWriteProtectTable_XM25QH128A,      NULL,                       SIZE_16MB,      256,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_XM25QH128A),     2},
     { FLASH_IC_ZB25VQ32,            MID_ZB,          0x40,     0x16,   _pstWriteProtectTable_ZB25VQ32,        NULL,                       SIZE_4MB,       64,           BITS(4:2,  0x07),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_ZB25VQ32),       1},
     { FLASH_IC_ZB25Q64A,            MID_ZB,          0x70,     0x17,   _pstWriteProtectTable_ZB25Q64A,        NULL,                       SIZE_8MB,       128,          BITS(5:2,  0x0F),      {E_SPI_54M , E_FAST_MODE  }, TRUE, NULL,                     NULL,                               sizeof(_pstWriteProtectTable_ZB25Q64A),       1},
};
#endif
