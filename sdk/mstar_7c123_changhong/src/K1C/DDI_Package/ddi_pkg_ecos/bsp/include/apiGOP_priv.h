...
int Ioctl_GOP_PowerState(void* pInstance, MS_U32 u32PowerState, void* pModule);
MS_U32 MAPI_GOP_SET_LAYER(void* pInstance,PGOP_SETLayer pLayer,MS_U32 u32Size);
MS_U32 MAPI_GOP_GET_LAYER(void* pInstance,PGOP_SETLayer pLayer,MS_U32 u32Size);
#endif
