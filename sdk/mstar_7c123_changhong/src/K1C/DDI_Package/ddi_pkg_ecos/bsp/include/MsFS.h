...
#if defined(MSOS_TYPE_LINUX) && !(defined(_FILE_OFFSET_BITS) && _FILE_OFFSET_BITS == 64)

//-------------------------------------------------------------------------------------------------
// Defines
//------------------------------------------------------------------------------------------------

#define MsFS_Init      MsFS32_Init
#define MsFS_Mount     MsFS32_Mount
#define MsFS_Umount    MsFS32_Umount

//
// File/Directory operations
//
#define MsFS_Open      MsFS32_Open
#define MsFS_Unlink    MsFS32_Unlink
#define MsFS_MkDir     MsFS32_MkDir
#define MsFS_RmDir     MsFS32_RmDir
#define MsFS_ChDir     MsFS32_ChDir
#define MsFS_Rename    MsFS32_Rename
#define MsFS_Link      MsFS32_Link
#define MsFS_Stat      MsFS32_Stat
#define MsFS_FStat     MsFS32_FStat
#define MsFS_PathConf  MsFS32_PathConf
#define MsFS_FPathConf MsFS32_FPathConf
#define MsFS_Access    MsFS32_Access
#define MsFS_GetCwd    MsFS32_GetCwd
#define MsFS_OpenDir   MsFS32_OpenDir
#define MsFS_ReadDir   MsFS32_ReadDir
#define MsFS_RewindDir MsFS32_RewindDir
#define MsFS_CloseDir  MsFS32_CloseDir

//
// File IO operations
//
#define MsFS_Read      MsFS32_Read
#define MsFS_Write     MsFS32_Write
#define MsFS_Close     MsFS32_Close
#define MsFS_FCntl     MsFS32_FCntl
#define MsFS_FSync     MsFS32_FSync
#define MsFS_Sync      MsFS32_Sync

//
// Standard C Library's counterparts
//
#define MsFS_Setvbuf    MsFS32_Setvbuf
#define MsFS_Fopen      MsFS32_Fopen
#define MsFS_Fclose     MsFS32_Fclose
#define MsFS_Fread      MsFS32_Fread
#define MsFS_Fwrite     MsFS32_Fwrite
#define MsFS_Fftruncate MsFS32_Fftruncate
#define MsFS_Fseek      MsFS32_Fseek
#define MsFS_Rewind     MsFS32_Rewind
#define MsFS_Ftell      MsFS32_Ftell
#define MsFS_Fflush     MsFS32_Fflush

#define MApi_FS_Info    MApi_FS32_Info
