...
typedef CH34_Drv_Result              (*IOCTL_CH34_SET_ATTRIBUTE)    (CH34_ATTRIBUTE_INFO*);
typedef CH34_Drv_Result              (*IOCTL_CH34_GENERALCTRL)    (MS_U32, void*, MS_U32);
...
typedef struct _CH34_INSTANT_PRIVATE
{
    ...
    IOCTL_CH34_SET_ATTRIBUTE    fpCH34SetAttribute;
    IOCTL_CH34_GENERALCTRL  fpCH34_GeneralCtrl;
...
CH34_Drv_Result MDrv_Ch34_SetAttribute_U2(CH34_ATTRIBUTE_INFO* pInfo);
MS_BOOL MDrv_Ch34_GeneralCtrl_U2(MS_U32 u32Cmd, void* pBuf, MS_U32 u32BufSize);
