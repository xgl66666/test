...
extern __attribute__((weak)) MS_U32 TVENCODEROpenMinimum(void** ppInstance, const void* const pAttribute);
...
#define MODULE_TYPE_TVENCODER_MINIMUM TVENCODEROpenMinimum
