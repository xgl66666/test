...
int Ioctl_GFX_SetSrcBuffer(void* pInstance, void* pArgs);
int Ioctl_GFX_SetDstBuffer(void* pInstance, void* pArgs);
int Ioctl_GFX_LineDraw(void* pInstance, void* pArgs);
int Ioctl_GFX_RectFill(void* pInstance, void* pArgs);
int Ioctl_GFX_BatchRectFill(void* pInstance, void* pArgs);
int Ioctl_GFX_TriFill(void* pInstance, void* pArgs);
int Ioctl_GFX_SpanFill(void* pInstance, void* pArgs);
int Ioctl_GFX_BitBlt(void* pInstance, void* pArgs);
int Ioctl_GFX_TwoSrcBitBlt(void* pInstance, void* pArgs);
int Ioctl_GFX_SetABL(void* pInstance, void* pArgs);
int Ioctl_GFX_SetConfig(void* pInstance, void* pArgs);
int Ioctl_GFX_Bitmap(void* pInstance, void* pArgs);
int Ioctl_GFX_Font(void* pInstance, void* pArgs);
int Ioctl_GFX_PowerState(void* pInstance, void* pArgs);
int Ioctl_GFX_CB(void* pInstance, void* pArgs);
int Ioctl_GFX_MISC(void* pInstance, void* pArgs);
int Ioctl_GFX_TLB(void* pInstance, void* pArgs);
int Ioctl_GFX_DrawOval(void* pInstance, void* pArgs);
#endif
