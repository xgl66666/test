...
// INIT  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// INIT_GPIO  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_GPIO_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_GPIO_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// INIT_SC  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_SC_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_SC_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};
...
// INIT_MOD  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_MOD_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_MOD_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};
...
// INIT_HDGEN  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_HDGEN_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_HDGEN_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};

//****************************************************
// INIT_HDMITX_8BIT  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_HDMITX_8BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_HDMITX_8BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_8BIT_Divider  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_HDMITX_8BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_HDMITX_8BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_10BIT  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_HDMITX_10BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_HDMITX_10BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_10BIT_Divider  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_HDMITX_10BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_HDMITX_10BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_12BIT  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_HDMITX_12BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_HDMITX_12BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_12BIT_Divider  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_INIT_HDMITX_12BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_24_INIT_HDMITX_12BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// Gamma  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_Gamma_TBL[][4] =
{               // Reg           Mask  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 720P_24
//****************************************************
MS_U8 MST_DAC_720P_24_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// INIT  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// INIT_GPIO  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_GPIO_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_GPIO_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// INIT_SC  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_SC_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_SC_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};
...
// INIT_MOD  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_MOD_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_MOD_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};
...
// INIT_HDGEN  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_HDGEN_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_HDGEN_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};

//****************************************************
// INIT_HDMITX_8BIT  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_HDMITX_8BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_HDMITX_8BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_8BIT_Divider  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_HDMITX_8BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_HDMITX_8BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_10BIT  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_HDMITX_10BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_HDMITX_10BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_10BIT_Divider  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_HDMITX_10BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_HDMITX_10BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_12BIT  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_HDMITX_12BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_HDMITX_12BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_12BIT_Divider  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_INIT_HDMITX_12BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_25_INIT_HDMITX_12BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// Gamma  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_Gamma_TBL[][4] =
{               // Reg           Mask  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 720P_25
//****************************************************
MS_U8 MST_DAC_720P_25_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// INIT  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// INIT_GPIO  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_GPIO_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_GPIO_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// INIT_SC  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_SC_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_SC_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};
...
// INIT_MOD  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_MOD_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_MOD_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};
...
// INIT_HDGEN  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_HDGEN_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_HDGEN_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00 }
};

//****************************************************
// INIT_HDMITX_8BIT  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_HDMITX_8BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_HDMITX_8BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_8BIT_Divider  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_HDMITX_8BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_HDMITX_8BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_10BIT  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_HDMITX_10BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_HDMITX_10BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_10BIT_Divider  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_HDMITX_10BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_HDMITX_10BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_12BIT  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_HDMITX_12BIT_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_HDMITX_12BIT_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};

//****************************************************
// INIT_HDMITX_12BIT_Divider  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_INIT_HDMITX_12BIT_Divider_TBL[][REG_ADDR_SIZE+REG_MASK_SIZE+DAC_TAB_720P_30_INIT_HDMITX_12BIT_Divider_NUMS]=
{                 // Reg           Mask  Value
 { DRV_DAC_REG(REG_TABLE_END)   , 0x00, 0x00,  }
};
...
// Gamma  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_Gamma_TBL[][4] =
{               // Reg           Mask  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT  720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_SC1_INIT_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
// SC1_INIT_SC 720P_30
//****************************************************
MS_U8 MST_DAC_720P_30_SC1_INIT_SC_TBL[][4] =
{               // Reg           Value  Value
 {  DRV_DAC_REG(REG_TABLE_END) , 0x00, 0x00  }
};
...
{
*MST_DAC_720P_24_INIT_TBL, DAC_TABTYPE_INIT,
*MST_DAC_720P_24_INIT_GPIO_TBL, DAC_TABTYPE_INIT_GPIO,
*MST_DAC_720P_24_INIT_SC_TBL, DAC_TABTYPE_INIT_SC,
*MST_DAC_720P_24_INIT_MOD_TBL, DAC_TABTYPE_INIT_MOD,
*MST_DAC_720P_24_INIT_HDGEN_TBL, DAC_TABTYPE_INIT_HDGEN,
*MST_DAC_720P_24_INIT_HDMITX_8BIT_TBL, DAC_TABTYPE_INIT_HDMITX_8BIT,
*MST_DAC_720P_24_INIT_HDMITX_8BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_8BIT_Divider,
*MST_DAC_720P_24_INIT_HDMITX_10BIT_TBL, DAC_TABTYPE_INIT_HDMITX_10BIT,
*MST_DAC_720P_24_INIT_HDMITX_10BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_10BIT_Divider,
*MST_DAC_720P_24_INIT_HDMITX_12BIT_TBL, DAC_TABTYPE_INIT_HDMITX_12BIT,
*MST_DAC_720P_24_INIT_HDMITX_12BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_12BIT_Divider,
*MST_DAC_720P_24_Gamma_TBL, DAC_TABTYPE_Gamma,
*MST_DAC_720P_24_SC1_INIT_TBL, DAC_TABTYPE_SC1_INIT,
*MST_DAC_720P_24_SC1_INIT_SC_TBL, DAC_TABTYPE_SC1_INIT_SC,
},
{
*MST_DAC_720P_25_INIT_TBL, DAC_TABTYPE_INIT,
*MST_DAC_720P_25_INIT_GPIO_TBL, DAC_TABTYPE_INIT_GPIO,
*MST_DAC_720P_25_INIT_SC_TBL, DAC_TABTYPE_INIT_SC,
*MST_DAC_720P_25_INIT_MOD_TBL, DAC_TABTYPE_INIT_MOD,
*MST_DAC_720P_25_INIT_HDGEN_TBL, DAC_TABTYPE_INIT_HDGEN,
*MST_DAC_720P_25_INIT_HDMITX_8BIT_TBL, DAC_TABTYPE_INIT_HDMITX_8BIT,
*MST_DAC_720P_25_INIT_HDMITX_8BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_8BIT_Divider,
*MST_DAC_720P_25_INIT_HDMITX_10BIT_TBL, DAC_TABTYPE_INIT_HDMITX_10BIT,
*MST_DAC_720P_25_INIT_HDMITX_10BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_10BIT_Divider,
*MST_DAC_720P_25_INIT_HDMITX_12BIT_TBL, DAC_TABTYPE_INIT_HDMITX_12BIT,
*MST_DAC_720P_25_INIT_HDMITX_12BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_12BIT_Divider,
*MST_DAC_720P_25_Gamma_TBL, DAC_TABTYPE_Gamma,
*MST_DAC_720P_25_SC1_INIT_TBL, DAC_TABTYPE_SC1_INIT,
*MST_DAC_720P_25_SC1_INIT_SC_TBL, DAC_TABTYPE_SC1_INIT_SC,
},
{
*MST_DAC_720P_30_INIT_TBL, DAC_TABTYPE_INIT,
*MST_DAC_720P_30_INIT_GPIO_TBL, DAC_TABTYPE_INIT_GPIO,
*MST_DAC_720P_30_INIT_SC_TBL, DAC_TABTYPE_INIT_SC,
*MST_DAC_720P_30_INIT_MOD_TBL, DAC_TABTYPE_INIT_MOD,
*MST_DAC_720P_30_INIT_HDGEN_TBL, DAC_TABTYPE_INIT_HDGEN,
*MST_DAC_720P_30_INIT_HDMITX_8BIT_TBL, DAC_TABTYPE_INIT_HDMITX_8BIT,
*MST_DAC_720P_30_INIT_HDMITX_8BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_8BIT_Divider,
*MST_DAC_720P_30_INIT_HDMITX_10BIT_TBL, DAC_TABTYPE_INIT_HDMITX_10BIT,
*MST_DAC_720P_30_INIT_HDMITX_10BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_10BIT_Divider,
*MST_DAC_720P_30_INIT_HDMITX_12BIT_TBL, DAC_TABTYPE_INIT_HDMITX_12BIT,
*MST_DAC_720P_30_INIT_HDMITX_12BIT_Divider_TBL, DAC_TABTYPE_INIT_HDMITX_12BIT_Divider,
*MST_DAC_720P_30_Gamma_TBL, DAC_TABTYPE_Gamma,
*MST_DAC_720P_30_SC1_INIT_TBL, DAC_TABTYPE_SC1_INIT,
*MST_DAC_720P_30_SC1_INIT_SC_TBL, DAC_TABTYPE_SC1_INIT_SC,
},
};
