...
#ifndef __mmsdk_porting_layer_header__
#define __mmsdk_porting_layer_header__

/// @file
/// @defgroup porting porting functions
/// @{

// The following include file should order by naming
...
#endif// __mmsdk_porting_layer_header__
