...
////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __API_PVRPL_CA_H__
#define __API_PVRPL_CA_H__
...
typedef enum
{
    PVRPL_CA_STATUS_OK,               ///< PVR CPL status OK
    PVRPL_CA_STATUS_ERROR,            ///< PVR CPL status ERROR
} PVRPL_CA_STATUS;
...
typedef enum
{
    EN_PVRPL_ENCRYPTION_NONE    = 0,
    EN_PVRPL_ENCRYPTION_DEFAULT = 1,//default-defination  key
    EN_PVRPL_ENCRYPTION_CIPLUS  = 2,//not support for now
    EN_PVRPL_ENCRYPTION_USER    = 3,//user-defination key
    EN_PVRPL_ENCRYPTION_SMARTCARD  = 4,//Key-ladder generated key
    EN_PVRPL_ENCRYPTION_DYNAMICKEY = 5,//Dynamic key
    EN_PVRPL_ENCRYPTION_AESDMA_NUM,//AESDMA(Block) Encryption above
    ...
    EN_PVRPL_ENCRYPTION_CLEAR  = 0x100,//record to clear from scrambled, no encryption anymore
    EN_PVRPL_ENCRYPTION_MAX,
} PVRPL_ENCRYPTION_TYPE;
...
{
    MS_U32 u32AESDMAKey[4]; // for USER MODE
    MS_U32 u32KeyIdx; // for Dynamic Key Mode
};

typedef struct
{
    PVRPL_ENCRYPTION_TYPE enEncryptType;
