...
////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __API_PVRPL_AUDIO_H__
#define __API_PVRPL_AUDIO_H__
...
typedef enum
{
    PVRPL_AUDIO_STATUS_OK,               ///< PVR CPL status OK
    PVRPL_AUDIO_STATUS_ERROR,            ///< PVR CPL status ERROR
} PVRPL_AUDIO_STATUS;

// Audio CPL enum
typedef enum
{
    EN_AUDIO_CPL_INFO_NONE = 0,

    //TS Player used
    EN_AUDIO_CPL_INFO_STCPTS_DIFF = 1,
    EN_AUDIO_CPL_INFO_PCMBUFF_LEVEL = 2,
    EN_AUDIO_CPL_INFO_ESBUFF_LEVEL = 3,

    //ES player
    EN_AUDIO_CPL_INFO_PTS_IN_33BITS = 50,
    EN_AUDIO_CPL_INFO_GET_WATER_LEVEL = 51,
    EN_AUDIO_CPL_INFO_GET_TIMESTAMP = 52,

    // For monitor AV Sync
    EN_AUDIO_CPL_INFO_IS_SYNC,
...
typedef enum
{
    ...
    EN_AUDIO_CPL_DEC_INVALID                       = -1,
    /// Audio 1-Decoder ID
    EN_AUDIO_CPL_DEC_ID1                           =  0,
    /// Audio 2-Decoder ID
    EN_AUDIO_CPL_DEC_ID2                           =  1,
    /// Audio 3-Decoder ID
    EN_AUDIO_CPL_DEC_ID3                           =  2,
    EN_AUDIO_CPL_DEC_MAX                           =  3

} EN_AUDIO_CPL_DEC_ID;

//--------------------------------------------------------
//multiple audio decode
typedef enum
{
    AUDIO_APP_ES_PLAY = 0,
    AUDIO_APP_DTV,
...
#endif // #ifndef __API_PVRPL_AUDIO_H__
