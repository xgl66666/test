...
#ifndef __mw_porting_vdec__
#define __mw_porting_vdec__
...
typedef enum
{
    /// Get CC write address
    E_CMD_GET_CC_WRITE_ADDR = 0,
    /// GET CC read address
    E_CMD_GET_CC_READ_ADDR,
    /// Update CC write address
    E_CMD_UPDATE_CC_WRITE_ADDR,
    /// Update CC read address
    E_CMD_UPDATE_CC_READ_ADDR,
    /// Set CC buffer start address
    E_CMD_SET_CC_START_ADDR,
} MPL_VDEC_BUFF_CMD;

//-------------------------------------------------------------------------------------------------
/// Stop updating frames
/// @param pStreamId              \b IN: Vdec stream id
...
//-------------------------------------------------------------------------------------------------
/// Get vdec control parameter
/// @param pStreamId                 \b IN: Vdec stream id
/// @param cmd_id                       \b IN: User command
/// @param param                        \b OUT: Parameter
/// @return VDEC_EX_Result
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
/// Get CC buffer address
/// @param pStreamId                 \b IN: Vdec stream id
/// @param eFmt                          \b IN: CC format
/// @param cmd                           \b IN: Buffer contorl command
/// @return Write buffer physical address
//-------------------------------------------------------------------------------------------------
MS_PHYADDR MPL_VDEC_CC_GetBuffAddr(VDEC_StreamId *pStreamId, VDEC_EX_CCFormat eFmt, MPL_VDEC_BUFF_CMD cmd);

//-------------------------------------------------------------------------------------------------
/// VEC CC address control
/// @param pStreamId                 \b IN: Vdec stream id
/// @param eFmt                          \b IN: CC format
/// @param cmd                           \b IN: Buffer contorl command
/// @param pData                        \b IN: Input data
...
/// Get decoder status
/// @param pStreamId                 \b IN: Vdec stream id
/// @param pStatus                     \b OUT : Decoder status
/// @return TRUE: Success
...
//-------------------------------------------------------------------------------------------------
/// Check decoder is overflow or not
/// @param pStreamId                 \b IN: Vdec stream id
/// @param eFmt                          \b IN: CC format
/// @return VDEC_EX_Result
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
/// Check decoder CC info
/// @param pStreamId                 \b IN: Vdec stream id
/// @param pInfo                         \b IN: CC info
/// @param u32Size                     \b IN: Decoder CC info size
/// @return VDEC_Result
//-------------------------------------------------------------------------------------------------
