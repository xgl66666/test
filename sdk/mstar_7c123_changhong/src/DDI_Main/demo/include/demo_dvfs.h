...
#define DVFS_LINUX_NODE_CPU_BOF     0x5F
#define DVFS_LINUX_NODE_CPU_EOF     0x5F

#define DVFS_LINUX_NODE_VALUE_BOF   0x3A
#define DVFS_LINUX_NODE_VALUE_EOF   0x3A

#define DVFS_TEMP_BUFF_SIZE         300
typedef struct
{
    MS_S32  s32volt_avg;
    MS_S32  s32volt_min;
