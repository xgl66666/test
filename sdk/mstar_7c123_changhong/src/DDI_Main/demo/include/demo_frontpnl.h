...
typedef enum
{
    EN_FRONTPANEL_KEYPAD_VOLMINUS = 0x1,
    EN_FRONTPANEL_KEYPAD_VOLPLUS = 0x2,
    EN_FRONTPANEL_KEYPAD_CHMINUS = 0x4,
    EN_FRONTPANEL_KEYPAD_CHPLUS = 0x8,
    EN_FRONTPANEL_KEYPAD_STANDBY = 0x10,

} EN_FRONTPANEL_KEYPAD_VALUE;
