...
//
//******************************************************************************
#ifndef _DEMO_OSD_RESOURCE_H_
#define _DEMO_OSD_RESOURCE_H_
//<MStar Software>
...
typedef struct
{
    ...
    EN_BMP_Buffer_Format fmt;
    MS_U32 inUsed;
    MS_U32 reserved_tag;
    MS_U8 reserved[8];
} ST_OSD_RESOURCE_FONT_INFO;
...
typedef struct
{
    ...
    MS_U32 reserved_tag;
    MS_U8 reserved[8];
} ST_OSD_RESOURCE_BITMAP_INFO;

FONTHANDLE Demo_OSD_RESOURCE_LoadFont (MS_U32 start_addr, MS_U32 glyph_addr, MS_U32 bbox_addr, MS_U32 codemap_addr, MS_U16 MS_U16char_num, MS_U16 codemap_block_num, MS_U8 width, MS_U8 height, MS_U8 bpp, MS_U16 char_glyph_bytes, MS_U32 pitch);
