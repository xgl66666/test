...
typedef enum
{
    E_DDI_POOL_SYS_CACHE,
    E_DDI_POOL_SYS_NONCACHE,
    E_DDI_POOL_MIU1_SYS_CACHE,
    E_DDI_POOL_MIU1_SYS_NONCACHE,
    E_DDI_POOL_MIU2_SYS_CACHE,
    E_DDI_POOL_MIU2_SYS_NONCACHE,
    E_DDI_POOL_SYS_UNDEFINE,
}E_DDI_UTIL_SYSPOOLID;
