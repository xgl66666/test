...
struct BIOPMessageHeader
{
    ...
    U8                  byte_order;                     /* 0 = big endian */
    U8                  message_type;                   /* should be 0 */
    U32                 message_size;                   /* not including this header */
} __attribute__ ((packed)) ;
...
struct biop_iop_ior
{
    U16                     association_tag;    /* maps to an elementary_PID */
    U32                     carousel_id;
    U16                     module_id;
