...
#define MSIF_IR_LIBVER                 {'0','4'}
#define MSIF_IR_BUILDNUM               {'0','0' }
#define MSIF_IR_CHANGELIST             {'0','0','3','5','2','1','6','3'}
...
typedef void ( *IR_Callback ) (MS_U32 u32IRKey, MS_U8 u8RepeatFlag);/*both IR_TYPE_SWDECODE_MODE and IR_TYPE_FULLDECODE_MODE*/
