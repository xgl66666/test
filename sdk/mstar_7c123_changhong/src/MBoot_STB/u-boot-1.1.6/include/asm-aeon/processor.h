...
#ifndef _AEON_PROCESSOR_H
#define _AEON_PROCESSOR_H
...
/* BA has no problems with write protection */
 ...
 * in BA, a page is 8192 bytes, which seems like a sane size
 */

#define THREAD_SIZE       AEON_PAGE_SIZE
