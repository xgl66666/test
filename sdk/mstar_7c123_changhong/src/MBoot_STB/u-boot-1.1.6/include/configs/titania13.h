...
#include "../../../sboot/inc/titania13/board/Board.h"
...
#define CONFIG_TITANIA13    1


// Use unsigned long to avoid compile warning in Net.c
#define CPU_CLOCK_RATE	    552000000UL   /* 552 MHz clock for the MIPS core */
...
#define CFG_CBSIZE		    384 // 256		        /* Console I/O Buffer Size   */ // REVIEW: please sync with COMMAND_LINE_SIZE @ kernel, 384 should be enough (for "bootargs" with "mtdparts"), but please check the stack size if using larger size for console buffer
