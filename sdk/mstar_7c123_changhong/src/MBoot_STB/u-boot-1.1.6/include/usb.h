...
#if defined(CONFIG_USB_UHCI) || defined(CONFIG_USB_OHCI) || defined (CONFIG_USB_SL811HS) || defined(CONFIG_USB_EHCI)
...
#if (!defined(CONFIG_KAPPA)) && (!defined(CONFIG_KELTIC))&& (!defined(CONFIG_KRITI))&& (!defined(CONFIG_KERES)) 
#define ENABLE_SECOND_EHC
#endif

#if defined(CONFIG_URANUS4) || defined(CONFIG_TITANIA8) || defined(CONFIG_TITANIA12) || defined(CONFIG_AMBER2) || defined(CONFIG_KAISERIN)
