...
#define BOARD_NAME                  "BD_MST221D_D01A"
...
//------TUNER Setting----------------------------------------------------------
#define FRONTEND_TUNER_PORT         E_HWI2C_PORT1_1 // byKOR, kaon E_HWI2C_PORT_0

#define FRONTEND_TUNER_PORT0        E_HWI2C_PORT1_1 // byKOR, kaon E_HWI2C_PORT0_1
#define FRONTEND_TUNER_CTRL         PIU_IIC_1 		// byKOR, kaon PIU_IIC_0

//------TUNER 1 Setting----------------------------------------------------------
#define FRONTEND_TUNER_PORT1         E_HWI2C_PORT1_1
#define FRONTEND_TUNER_CTRL1         PIU_IIC_1
...
#define DMX_INPUT                       DMX_INPUT_EXT_INPUT1
#else
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO		        BALL_C9

// ----- USB Port0 Power Control -----------------------------------------------
#define GPIO_USB0_POWER BALL_K12
#define GPIO_USB1_POWER BALL_H16
...
#define GPIO_FE_RST                     BALL_P14  //Frontend RST
#define GPIO_FE_RST1                    BALL_P14 //Frontend RST
#define GPIO_SMC0_EXT_8024_VOL_CTRL     BALL_P13 //SMC EXT8024 Voltage Ctrl
#ifdef __cplusplus
}
#endif
