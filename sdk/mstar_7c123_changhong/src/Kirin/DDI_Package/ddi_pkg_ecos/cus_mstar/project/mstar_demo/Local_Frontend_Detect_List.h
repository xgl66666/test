...
//------------------------------------------------------------------------------------
#define DEMOD_00TH_SCAN_DEVICE DEMOD_MSKERES_DVBC //byKOR, kaon DEMOD_MSB124X //DEMOD_MSKERES_DVBC //DEMOD_MSB124X
#define DEMOD_01ST_SCAN_DEVICE DEMOD_NULL
...
//------------------------------------------------------------------------------------
#define TUNER_00TH_SCAN_DEVICE TUNER_R836 // byKOR, kaon
#define TUNER_01ST_SCAN_DEVICE TUNER_NULL //if crystal is 16,set this to TUNER_TDA18250B
#define TUNER_02ND_SCAN_DEVICE TUNER_NULL
#define TUNER_03RD_SCAN_DEVICE TUNER_NULL
#define TUNER_04TH_SCAN_DEVICE TUNER_NULL
...
/* Supported external demod devices
TUNER_MXL603              DVBC/DVBT/DVBT2/ATSC/ISDBT/DTMB
