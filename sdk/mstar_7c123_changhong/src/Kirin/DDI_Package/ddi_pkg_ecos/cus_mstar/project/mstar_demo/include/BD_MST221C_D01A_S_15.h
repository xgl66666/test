...
#define BOARD_NAME                  "BD_MST221C_D01A_S_15"
...
//------TUNER Setting----------------------------------------------------------
#define FRONTEND_TUNER_PORT         E_HWI2C_PORT_0
...
//------TUNER 2 Setting----------------------------------------------------------
#define FRONTEND_TUNER_PORT2         E_HWI2C_PORT1_1
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO		        BALL_C6

// ----- USB Port0 Power Control -----------------------------------------------
#define GPIO_USB0_POWER BALL_J2
#define GPIO_USB1_POWER BALL_H1
...
#define GPIO_FE_RST                     BALL_D13  //Tuner RST
#define GPIO_FE_RST1                    BALL_C14 //Frontend RST
#define GPIO_FE_RST2                    BALL_D13 //Tuner RST
//to be fixed, by Teddy.Chen
#define GPIO_DEMOD_RST                  9999 // MCP Windermere RST
#define GPIO_SMC0_EXT_8024_VOL_CTRL     BALL_R7 //SMC EXT8024 Voltage Ctrl
#ifdef __cplusplus
}
#endif
