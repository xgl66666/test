...
#define PHOTO_SHARE_MEM_BUFFER_ADDR ((FUN_PHOTO_SHARE_MEM_ADR))
#define PHOTO_SHARE_MEM_BUFFER_SIZE (FUN_PHOTO_SHARE_MEM_LEN)


// Memory Layout for PHOTO decoder
// data buffer
#define PHOTO_DATA_BUFFER_ADDR      (PHOTO_ALIGNMENT(FUN_MAD_JPEG_READBUFF_ADR))//PHOTO_ALIGNMENT(((MAD_JPEG_READBUFF_MEMORY_TYPE & MIU1) ? (FUN_MAD_JPEG_READBUFF_ADR | MIU_INTERVAL) : (FUN_MAD_JPEG_READBUFF_ADR)))
#define PHOTO_DATA_BUFFER_SIZE      (FUN_MAD_JPEG_READBUFF_LEN)

#define PHOTO_OUTPUT_BUFFER_ADDR    (PHOTO_ALIGNMENT(FUN_MAD_JPEG_OUT_ADR))//PHOTO_ALIGNMENT(((MAD_JPEG_OUT_MEMORY_TYPE & MIU1) ? (FUN_MAD_JPEG_OUT_ADR | MIU_INTERVAL) : (FUN_MAD_JPEG_OUT_ADR)))
#define PHOTO_OUTPUT_BUFFER_SIZE    (FUN_MAD_JPEG_OUT_LEN)

// 0.0, Photo display buffer for full screen / preview
#define PHOTO_DISPLAY_BUFFER_ADDR   PHOTO_ALIGNMENT((FUN_MAD_JPEG_DISPLAY_ADR))
#define PHOTO_DISPLAY_BUFFER_SIZE   (FUN_MAD_JPEG_DISPLAY_LEN)
...
#define PHOTO_THUMBNAIL_SHRINK_BUFFER_0_SIZE    (2L * PHOTO_SHRINK_BUFFER_0_WIDTH * PHOTO_SHRINK_BUFFER_0_HEIGHT)
...
#define PHOTO_THUMBNAIL_SHRINK_BUFFER_1_SIZE    (2L * PHOTO_SHRINK_BUFFER_1_WIDTH * PHOTO_SHRINK_BUFFER_1_HEIGHT)

#define PHOTO_POOL_BUFFER_ADDR      (PHOTO_ALIGNMENT(FUN_MAD_JPEG_INTERBUFF_ADR))//PHOTO_ALIGNMENT(((MAD_JPEG_INTERBUFF_MEMORY_TYPE & MIU1) ? (FUN_MAD_JPEG_INTERBUFF_ADR | MIU_INTERVAL) : (FUN_MAD_JPEG_INTERBUFF_ADR)))
#define PHOTO_POOL_BUFFER_SIZE      (FUN_MAD_JPEG_INTERBUFF_LEN)
...
#define PHOTO_SHRINK_BUFFER_0_SIZE      (2L * PHOTO_SHRINK_BUFFER_0_WIDTH * PHOTO_SHRINK_BUFFER_0_HEIGHT)
...
// co-buffers using PHOTO_SHRINK_BUFFER_0_ADDR
#define PHOTO_GIF_INTERNAL_BUFFER_ADDR      PHOTO_ALIGNMENT(PHOTO_GIF_FRAME_INFO_ARRAY_BUFFER_ADDR + PHOTO_GIF_FRAME_INFO_ARRAY_BUFFER_SIZE)
#define PHOTO_GIF_INTERNAL_BUFFER_SIZE      (2L * PHOTO_DECODE_GIF_MAX_WIDTH * PHOTO_DECODE_GIF_MAX_HEIGHT)
...
typedef enum
{
    ...
    E_PHOTO_INFO_GIF_ANIMATION_LOOP_TIMES,
} EN_PHOTO_INFO;
...
INTERFACE void MApp_Photo_EnableGIFAnimationLoop(BOOLEAN bEnabled);
INTERFACE void MApp_Photo_OnlyDecodeGIFFirstFrame(BOOLEAN bEnabled);
...
INTERFACE void              MApp_Photo_ClearOutputBuffer(void);
INTERFACE BOOLEAN MApp_Photo_ID3_DecodeFile_Init(FileEntry *pFileEntry, BOOLEAN bThumbnail,MS_U32 Offset);
