...
#define VDPLAYER_CHECK_PREVIEW_ABORT    0       //TODO
#define VDPLAYER_CHECK_COPROCESSOR_STATUS      0
...
#define VDPLAYER_INIT_TIMEOUT   5000
#define VDPLAYER_COPROCESSOR_CHECK_TIMEOUT     8000

#define DYNSCALING 0
#define DYNAMIC_SCALING_VB_H 960
...
typedef struct
{
    MS_BOOL  bIsFrameReady;
    MS_U8    u8VideoType;
    MS_U8    u8Interlace;
    MS_U32   u32FrameRate;
    MS_U16   u16PicWidth;
    MS_U16   u16PicHeight;
    MS_U8*   pVIDframeBuffer;
    MS_U8    u8IsTsStream;
}VD_Decode_Info;
...
typedef enum
{
    ...
    E_SUBTITLE_INFO_TRACK_LANGUAGE,
...
typedef struct
{
    EN_PLAY_TRICKMODE enTrickMode;
    EN_PLAY_SPEED enPlaySpeed;
} TRICK_STATUS;
...
typedef enum
{
    ...
    E_VDPLAYER_INFO_AUDIO_TRACK_LANGUAGE,
    E_VDPLAYER_INFO_NB_SUBTITLE_TRACK,
    E_VDPLAYER_INFO_SUBTITLE_TRACK_ID,
    E_VDPLAYER_INFO_SUBTITLE_TRACK_LANGUAGE,
    E_VDPLAYER_INFO_NB_PROGRAM,
    E_VDPLAYER_INFO_PROGRAM_ID,

    E_VDPLAYER_INFO_DIVX_TPT_MODE_EXIST,
    E_VDPLAYER_INFO_AUDIO_CHANNEL_CONFIGURATION,
    E_VDPLAYER_INFO_LAW_RATING,
    E_VDPLAYER_INFO_DIVX_NB_TITLE,
    E_VDPLAYER_INFO_DIVX_NB_EDITION,
    E_VDPLAYER_INFO_DIVX_NB_CHAPTER,
    E_VDPLAYER_INFO_DIVX_NB_AUTOCHAPTER,
    E_VDPLAYER_INFO_DIVX_TITLE_NAME,
    E_VDPLAYER_INFO_DIVX_EDITION_NAME,
    E_VDPLAYER_INFO_DIVX_CHAPTER_NAME,
    E_VDPLAYER_INFO_DIVX_AUTOCHAPTER_NAME,
    E_VDPLAYER_INFO_DIVX_AUDIO_TRACK_NAME,
    E_VDPLAYER_INFO_DIVX_SUBTITLE_TRACK_NAME,
    ...
    E_VDPLAYER_INFO_CURRENT_INTERNAL_SUBTITLE_TYPE,
...
#endif
    E_VDPLAYER_INFO_INTERLACE,
    E_VDPLAYER_INFO_NB_TTX_TRACK,
}EN_VDPLAYER_INFO;
#else
typedef enum
{
...
#define VDPLAYER_SHAREMEM_ADDR  (FUN_VDPLAYER_DATA_ADR)
#define VDPLAYER_SHAREMEM_SIZE  0x1000   // 4K
#ifdef MSOS_TYPE_ECOS
#define VDPLAYER_AEON_DATABUFF_ADDR   VDPLAYER_SHAREMEM_ADDR
#define VDPLAYER_AEON_DATABUFF_SIZE   FUN_VDPLAYER_DATA_LEN
#else
#define VDPLAYER_AEON_DATABUFF_ADDR   VDPLAYER_SHAREMEM_ADDR+VDPLAYER_SHAREMEM_SIZE
#define VDPLAYER_AEON_DATABUFF_SIZE   FUN_VDPLAYER_DATA_LEN-VDPLAYER_SHAREMEM_SIZE
#endif
...
{
    E_VDPLAYER_NULL,
    E_VDPLAYER_PREDECODE_OK,
    E_VDPLAYER_DECODING,
    E_VDPLAYER_EXIT,
    E_VDPLAYER_TRAN_STANDBY,
    E_VDPLAYER_WAIT,
    E_VDPLAYER_WAIT_PLAY_PREV,
}EN_VDPLAYER_STATE;
...
typedef BOOLEAN (*pfnForceStopCallBack)(EN_VDPLAYER_FORCE_STOP eType);
...
#endif
INTERFACE BOOLEAN g_bNonBlockingRead;
INTERFACE BOOLEAN g_bNonBlockingSeek;
#if ((OBA2 == 1) && (ENABLE_BABAO_PLAYER == ENABLE))
INTERFACE BOOLEAN g_bStreamIsSD;
#endif
...
INTERFACE U32 MApp_VDPlayer_GetSubtitleInfo(EN_SUBTITLE_INFO eInfo, U8 u8TrackId);
INTERFACE void msAPI_VDPlayer_SubtitlePushQueue(EN_VDP_CODECID sbtype, U32 StarAddr, U32 size , U32 PTSstart  , U32 PTSend  );

INTERFACE BOOLEAN MApp_MM_VDPlayer_SetSubtitleTrackID(U8 u8TrackId);
...
INTERFACE BOOLEAN MApp_VDPlayer_SubtitleTimeShift(BOOLEAN bDirection, U16 u16TimeShift);
...
INTERFACE BOOLEAN MApp_MM_VDPlayer_SetAudioTrackID(U8 u8TrackId);
#if (ENABLE_DIVX_PLUS == 1)
...
INTERFACE EN_VDPLAYER_STATE MApp_VDPlayer_Main (void);
INTERFACE BOOLEAN MApp_MM_VDPlayer_Pause(void);
INTERFACE BOOLEAN MApp_MM_VDPlayer_Resume(void);

INTERFACE void MApp_MM_VDPlayer_Stop(void);
INTERFACE void MApp_MM_VDPlayer_StopAndCloseDisplay(void);
INTERFACE BOOLEAN MApp_VDPlayer_SetCfg(EN_VDPLAYER_CFG eCfg, U32 u32Value);
INTERFACE BOOLEAN MApp_MM_VDPlayer_Init(VIDEO_PLAYER_INPUT_SOURCE_TYPE eInSrcType, VIDEO_PLAYER_PLAYING_TYPE eType, FileEntry *pFileEntry);
INTERFACE BOOLEAN MApp_MM_VDPlayer_Play(void);
INTERFACE BOOLEAN MApp_MM_VDPlayer_SetTrickMode(EN_PLAY_MODE enPlayMode, EN_PLAY_SPEED enPlaySpeed);
INTERFACE BOOLEAN MApp_MM_VDPlayer_SetRepeatAB(EN_SET_REPEATAB enAction);
...
INTERFACE void MApp_MM_VDPlayer_StopPreview(void);
INTERFACE void MApp_VDPlayer_SetPreviewWindow(U16 u16X, U16 u16Y, U16 u16Width, U16 u16Height);
...
INTERFACE void MApp_VDPlayer_CodecDbgMsg(BOOLEAN bEnable);
...
#ifdef TRITON_DDI
INTERFACE BOOLEAN MApp_MM_VDPlayer_Init_DDI(U32 _itemID, U32 _FileLength);
INTERFACE BOOLEAN MApp_MM_VDPlayer_SetTrickMode_DDI(EMP_TRICK_MODE_PARAM_T *param);
...
INTERFACE void MApp_MM_VDPlayer_StopThumbnail(void);
INTERFACE U32 MApp_VDPlayer_Get_Buffer_Info(EN_BUFFER_INFO_INDEX eIndex);
INTERFACE void MApp_VDPlayer_Set_Buffer_Info(EN_BUFFER_INFO_INDEX eIndex, U32 u32Data);
INTERFACE void MApp_VDPlayer_MovieThumbnail_OutputImage(
...
INTERFACE BOOLEAN MApp_VDPlayer_MovieThumbnail_SetMVOP(void);
#if ENABLE_DRM
...
INTERFACE void MApp_VDPlayer_EnableSeamless(BOOLEAN bEnableSeamless);
INTERFACE BOOLEAN MApp_VDPlayer_GetSeamlessMode(void);
#endif
INTERFACE BOOLEAN MApp_VDPlayer_DeBlocking(BOOLEAN bEnable);
INTERFACE BOOLEAN MApp_VDPlayer_QuarterPixel(BOOLEAN bEnable);

#if SUPPORTED_PLAYABLE_AUDIO_TRACK_CHECK==1
INTERFACE void MApp_VDPlayer_SetSupportedAudio(U32 u32SupportedFormat);
INTERFACE U32 MApp_VDPlayer_GetSupportedAudio(void);
#endif
INTERFACE MS_U8 _MApp_Video_Free_ShareMemory(void);
INTERFACE void _MM_SetDisplayRdy(BOOLEAN bEnable);
INTERFACE BOOLEAN _MM_GetDisplayRdy(void);
#undef INTERFACE
