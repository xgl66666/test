...
_RV32_2(0x0d30, 0x1b87),      // ddfset
_RV32_2(0x0d32, 0x0028),      // ddrpll_reset/ddrpll_porst/ddrpl_pd
...
#if (ENABLE_MSTAR_DDR_128MB_128MB)
...
_RV32_2(0x0db0, 0x1b87),      // ddfset
_RV32_2(0x0db2, 0x0028),      // ddrpll_reset/ddrpll_porst/ddrpl_pd
...
#if (ENABLE_MSTAR_DDR_128MB_128MB)
_RV32_2(0x0628, 0xf270),      //pack_en enable
#else
