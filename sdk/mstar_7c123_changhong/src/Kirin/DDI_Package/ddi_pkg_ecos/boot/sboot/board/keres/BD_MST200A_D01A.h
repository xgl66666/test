...
#define PAD_CI_D5_IS_GPIO       GPIO_LOW // LED_CONTROL_0
#define PAD_CI_D6_IS_GPIO       GPIO_LOW // LED_CONTROL_1
...
#define PAD_PM_GPIO12_IS_GPIO    GPIO_OUT_HIGH  // Front Panel LED RED
