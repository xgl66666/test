...
U32  nand_set_param (NAND_DRIVER *pNandDrv, U16 u16_PageByteCnt, U16 u16_SpareByteCnt, U16 u16_BlkPageCnt, U16 u16_ECCType)
{
	U32 u32_Err = 0;

	pNandDrv->u16_BlkPageCnt = u16_BlkPageCnt;
