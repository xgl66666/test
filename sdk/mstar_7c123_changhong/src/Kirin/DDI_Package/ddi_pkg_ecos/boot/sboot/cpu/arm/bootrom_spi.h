...
// For K3S otp code enable SPI
#if defined(CONFIG_MSTAR_KAISER) 
#define CHIPTOP_BANK_ADDRESS 0x1F000000 + (0x101e<<9)
#define CHIPTOP_CHIP_ID CHIPTOP_BANK_ADDRESS + (0x67<<2)

#define PM_SLEEP_BANK_ADDRESS 0x1F000000 + (0x700<<2)
#define PM_SLEEP_0x39  PM_SLEEP_BANK_ADDRESS + (0x39<<2)
#endif 
