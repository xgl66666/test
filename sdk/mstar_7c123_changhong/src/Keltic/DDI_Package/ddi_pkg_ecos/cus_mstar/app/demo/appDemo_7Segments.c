...
//------------------------------------------------------------------------------
/// @brief The sample code to  show time Hours:Minutes 
...
//------------------------------------------------------------------------------
/// @brief The sample code to  stop  time Hours:Minutes 
/// @return TRUE: Process success.
/// @return FALSE: Process fail.
/// @sa
/// @note
...
/// @param 0 : Digital 
/// @param 1 : Value
/// @param 2 : DP is Set or not
/// @return TRUE: Process success.
/// @return FALSE: Process fail.
/// @sa
/// @note
/// Command: \b 7SegmentSet 3 5 1  => 5. 0 0 0 \n
// 
//------------------------------------------------------------------------------
