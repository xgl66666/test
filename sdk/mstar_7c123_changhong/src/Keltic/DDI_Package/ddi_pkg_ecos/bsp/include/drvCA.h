...
DLL_PUBLIC MS_BOOL MDrv_CA_OTP_DeactiveHCPU2DMA(void);
DLL_PUBLIC MS_BOOL MDrv_CA_OTP_IsHCPU2DMADeactived(void);

DLL_PUBLIC MS_BOOL MDrv_CA_OTP_DisableSPIFastBurn(void);
DLL_PUBLIC MS_BOOL MDrv_CA_OTP_IsSPIFastBurnDisabled(void);

DLL_PUBLIC MS_BOOL MDrv_CA_OTP_SetExtraData(MS_U8 *pu8Data, MS_U32 u32Size);
DLL_PUBLIC MS_BOOL MDrv_CA_OTP_GetExtraData(MS_U8 *pu8Data, MS_U32 u32Size);
DLL_PUBLIC MS_U32 MDrv_CA_OTP_QueryExtraDataSize(void);
