...
typedef struct do_partitions_info    do_partitions_info;
...
struct do_partitions_info
{
    char* devname;
    cyg_uint8 part_count;
    cyg_uint32 p1_size_MB;
    cyg_uint32 p2_size_MB;
    cyg_uint32 p3_size_MB;
    cyg_uint32 p4_size_MB;
};

Cyg_ErrNo write_mbr(cyg_io_handle_t  handle,cyg_uint32 partition_size_MB[],cyg_uint8 partition_count);//added by samson.huang
