...
if [ "$CMD_TYPE" == "dump" ]; then
    if [ "$2" == "cfg" ]; then
        ...
        if [ "$3" == "set_config" ] || [ "$3" == "set_partition" ] || [ "$3" == "all" ] || [ "$3" == "app" ] || [ "$3" == "conf" ] || [ "$3" == "config" ] || [ "$3" == "kernel" ] || [ "$3" == "lib" ] || [ "$3" == "mwlib" ] || [ "$3" == "rfs" ]; then
    ...
    elif [ "$2" == "var_list" ] || [ "$2" == "conf_list" ] || [ "$2" == "ref_info" ]; then
        cat ../../../bsp/linux/partition/auto_gen_output/$2
    elif [ "$2" == "cc_opts" ] || [ "$2" == "cl_info" ] || [ "$2" == "conf_info" ] || [ "$2" == "sys_info" ]; then
        cat ../../../bsp/linux/partition/auto_gen_output/application/auto_gen/$2
    else
        agc_usage
    fi
elif [ "$CMD_TYPE" == "exec" ]; then
    if [ "$2" == "build" ]; then
