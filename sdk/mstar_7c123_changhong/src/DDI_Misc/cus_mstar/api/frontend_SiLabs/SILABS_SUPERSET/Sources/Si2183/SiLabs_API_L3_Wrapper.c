...
#endif /* DEMOD_DVB_C2 */
#ifdef    DEMOD_DVB_T2
      case Si2183_DVBT_STATUS_RESPONSE_RATE_HP_1_2    : return SILABS_CODERATE_1_2;
      case Si2183_DVBT_STATUS_RESPONSE_RATE_HP_2_3    : return SILABS_CODERATE_2_3;
      case Si2183_DVBT_STATUS_RESPONSE_RATE_HP_3_4    : return SILABS_CODERATE_3_4;
#endif /* DEMOD_DVB_T2 */
#ifdef    DEMOD_DVB_S_S2_DSS
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_4_5 : return SILABS_CODERATE_4_5;
#endif /* DEMOD_DVB_S_S2_DSS */
#ifdef    DEMOD_DVB_T2
      case Si2183_DVBT_STATUS_RESPONSE_RATE_HP_5_6    : return SILABS_CODERATE_5_6;
      case Si2183_DVBT_STATUS_RESPONSE_RATE_HP_7_8    : return SILABS_CODERATE_7_8;
#endif /* DEMOD_DVB_T2 */
#ifdef    DEMOD_DVB_S_S2_DSS
  #ifndef    Si2183_DVBT_STATUS_RESPONSE_RATE_HP_1_2
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_1_2 : return SILABS_CODERATE_1_2;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_2_3 : return SILABS_CODERATE_2_3;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_3_4 : return SILABS_CODERATE_3_4;
  #endif  /* Si2183_DVBT_STATUS_RESPONSE_RATE_HP_1_2 */
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_5_6 : return SILABS_CODERATE_5_6;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_8_9 : return SILABS_CODERATE_8_9;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_9_10: return SILABS_CODERATE_9_10;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_1_3 : return SILABS_CODERATE_1_3;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_1_4 : return SILABS_CODERATE_1_4;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_2_5 : return SILABS_CODERATE_2_5;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_3_5 : return SILABS_CODERATE_3_5;
      case 7                                          : return SILABS_CODERATE_7_8; // for DVBS
#endif /* DEMOD_DVB_S_S2_DSS */
#ifdef    DEMOD_DVB_S2X
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_13_45 : return SILABS_CODERATE_13_45;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_9_20  : return SILABS_CODERATE_9_20;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_8_15  : return SILABS_CODERATE_8_15;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_11_20 : return SILABS_CODERATE_11_20;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_5_9   : return SILABS_CODERATE_5_9;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_26_45 : return SILABS_CODERATE_26_45;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_28_45 : return SILABS_CODERATE_28_45;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_23_36 : return SILABS_CODERATE_23_36;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_25_36 : return SILABS_CODERATE_25_36;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_32_45 : return SILABS_CODERATE_32_45;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_13_18 : return SILABS_CODERATE_13_18;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_11_15 : return SILABS_CODERATE_11_15;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_7_9   : return SILABS_CODERATE_7_9;
      case Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_77_90 : return SILABS_CODERATE_77_90;
#endif /* DEMOD_DVB_S2X */
#ifdef    DEMOD_DVB_T2
  #ifndef    Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_4_5
      case Si2183_DVBT2_STATUS_RESPONSE_CODE_RATE_4_5 : return SILABS_CODERATE_4_5;
      case Si2183_DVBT2_STATUS_RESPONSE_CODE_RATE_1_3 : return SILABS_CODERATE_1_3;
      case Si2183_DVBT2_STATUS_RESPONSE_CODE_RATE_2_5 : return SILABS_CODERATE_2_5;
      case Si2183_DVBT2_STATUS_RESPONSE_CODE_RATE_3_5 : return SILABS_CODERATE_3_5;
  #endif /* Si2183_DVBS2_STATUS_RESPONSE_CODE_RATE_4_5 */
#endif /* DEMOD_DVB_T2 */
      default                                         : return -1;
    }
...
signed   int  SiLabs_API_Demod_status_selection     (SILABS_FE_Context* front_end,    CUSTOM_Status_Struct *status, unsigned char status_selection)
{
  ...
  if (front_end->chip ==   0x2183 ) {
    ...
    #ifdef    DEMOD_DVB_T
      /* to be able to pass TERACOM DVB-T and DVB-T2 certification,
          BER (exp;mant) values must be set to (6;1) for DVB-T, and (7;1) for all other standards */
        if (status->standard == SILABS_DVB_T) {
          front_end->Si2183_FE->demod->prop->dd_ber_resol.exp  =     6;
          front_end->Si2183_FE->demod->prop->dd_ber_resol.mant =     1;
        } else {
          front_end->Si2183_FE->demod->prop->dd_ber_resol.exp  =     7;
          front_end->Si2183_FE->demod->prop->dd_ber_resol.mant =     1;
        }
        /* In 'DOWNLOAD_ON_CHANGE' mode, the property will only be set if it's changing, so the i2c impact is small */
...
signed   int  SiLabs_API_FE_status_selection        (SILABS_FE_Context* front_end,    CUSTOM_Status_Struct *status, unsigned char status_selection)
{
  ...
  #endif /* SiTRACES */
  __attribute__((unused))signed   int   res;
...
signed   int  SiLabs_API_Text_status_selection      (SILABS_FE_Context* front_end,    CUSTOM_Status_Struct *status, char *formatted_status, unsigned char status_selection)
{
  ...
  switch (status->standard)
  {
    ...
    case SILABS_ISDB_T: {
      STRING_APPEND_SAFE(formatted_status,1000, " characteristics     %s ", Silabs_FFT_Text(status->fft_mode));
      STRING_APPEND_SAFE(formatted_status,1000, " %s "                    , Silabs_GI_Text(status->guard_interval));
      STRING_APPEND_SAFE(formatted_status,1000, " nb_segments %d/%d/%d "  , status->nb_seg_a, status->nb_seg_b, status->nb_seg_c );
...
#ifdef    UNICABLE_II_COMPATIBLE
           (void*)&SiLabs_API_SAT_read_diseqc_reply,
#endif /* UNICABLE_II_COMPATIBLE */
...
************************************************************************************************************************/
signed   int  SiLabs_API_Set_Index_and_Tag          (SILABS_FE_Context* front_end,    unsigned char index, char* tag)
{
...
{
  __attribute__((unused)) signed   int i;
...
#ifdef    Si2183_COMPATIBLE
  if (front_end->chip ==   0x2183 ) {
    return Si2183_L2_lock_to_carrier  (front_end->Si2183_FE, standard_code, freq
                                  , bandwidth_Hz
#ifdef    DEMOD_DVB_T
                                  , stream_code
#endif /* DEMOD_DVB_T */
...
signed   int  SiLabs_API_TS_Mode                    (SILABS_FE_Context *front_end,    signed   int ts_mode)
{
  ...
  valid_mode = 0;
    ...
    if ( (streaming_used == 1) ) {
      /* First go to tristate when changing between GPIF and SLAVE */
      if (ts_mode != front_end->active_TS_mode) {
...
#ifdef    UNICABLE_COMPATIBLE
signed   int  SiLabs_API_SAT_Unicable_Config        (SILABS_FE_Context *front_end,    signed  int unicable_mode,  unsigned  int ub,  unsigned  int Fub_kHz,  unsigned  int Fo_kHz_low_band,  unsigned  int Fo_kHz_high_band )
{
  SiTRACE("API CALL CONFIG: SiLabs_API_SAT_Unicable_Config (front_end, %d, %d, %d, %d, %d, %d);\n", unicable_mode, ub, Fub_kHz, Fo_kHz_low_band, Fo_kHz_high_band );
...
/************************************************************************************************************************
  ...
  Parameter: front_end, Pointer to SILABS_FE_Context
  Parameter: layer_mon        the ISDB-T monitoring mode (0='ALL', 0xA='LAYER_A', 0xB='LAYER_B', 0xC='LAYER_C')
...
************************************************************************************************************************/
signed   int  Silabs_API_Test                       (SILABS_FE_Context *front_end,    char *target, char *cmd, char *sub_cmd, double dval, double *retdval, char **rettxt)
{
    ...
    if (strcmp_nocase(cmd ,"c_n_loop"  ) == 0) {
      ...
      *retdval = 0.0;
      ...
      for (i=0; i< res; i++) {
        ...
        if (*retdval != custom_status->c_n_100/100.0) {
...
************************************************************************************************************************/
char*         SiLabs_API_TAG_TEXT                   (void) { return (char *)"V2.7.3"; }
