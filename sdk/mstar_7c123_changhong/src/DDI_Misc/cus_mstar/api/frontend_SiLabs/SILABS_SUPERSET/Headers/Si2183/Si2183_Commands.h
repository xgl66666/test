...
/* Change log:
 ...
 As from V0.2.1.0:
  <new_feature>[DUALS/TS_Bonding] Upgrading Si2183_DD_TS_PINS_CMD to allow channel bonding
...
#define   Si2183_DD_TS_PINS_CMD 0x80
  ...
  #define Si2183_DD_TS_PINS_CMD_CODE 0x010080
   ...
   #define  Si2183_DD_TS_PINS_CMD_MASTER_FREQ_MAX         -1
...
#define   Si2183_DVBS2_STATUS_CMD 0x70
  ...
  #define Si2183_DVBS2_STATUS_CMD_CODE 0x010070
   ...
   /* DVBS2_STATUS command, STREAM_TYPE field definition (address 10, size 2, lsb 5, unsigned)*/
   #define  Si2183_DVBS2_STATUS_RESPONSE_STREAM_TYPE_LSB         5
   #define  Si2183_DVBS2_STATUS_RESPONSE_STREAM_TYPE_MASK        0x03
