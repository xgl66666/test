 ...
 As from V0.2.3.0:
    ...
    <new_feature>[init/force_full_init] In Si2183_L2_switch_to_standard: using new defines for force_full_init (instead of using only 0 or 1).
      This is useful to allow setting up the entire frontend in any mode using a single call to Si2183_L2_switch_to_standard.
        ...
        #define Si2183_FORCE_DEMOD_INIT     0x10 (useful to initialize the TER tuner while the final standard is SLEEP)
...
/* Re-definition of SiTRACE for L1_Si2183_Context */
...
#ifdef    DEMOD_ISDB_T
#ifdef    Si2180_B60_COMPATIBLE
 #include "Si2180_ROM2_Patch16_6_0b6.h"
 #define   Si2180_FIRMWARE_FOR_x60_PARTS          Si2180_PATCH16_6_0b6/* was 63b1 */
 /* #include "Si2180_ROM2_SPI_6_3b1.h" */
 ...
 #include "Si2180_ROM1_Patch16_5_8b2.h"     /* firmware compatible with Si2180     (ROM0/NVM 5_1b3), without T2/C2/S2 FW  */
 #define   Si2180_FIRMWARE_FOR_x55_PARTS          Si2180_PATCH16_5_8b2
/* #include "Si2180_ROM1_SPI_5_8b2.h"     */    /* SPI mode compatible with Si2180     (ROM0/NVM 5_1b3), without T2/C2/S2 FW  */
 ...
 /* This is only used for Si2180 parts, since the FW contains no T2/C2/S2 */
 #include "Si2180_ROM0_Patch16_5_3b4.h"     /* firmware compatible with Si2180     (ROM0/NVM 5_0b3), without T2/C2/S2 FW  */
 #define   Si2180_FIRMWARE_FOR_x50_PARTS          Si2180_PATCH16_5_3b4
 ...
 #include "Si2183_ROM2_Patch16_6_3b1.h"     /* firmware compatible with Si2183     (ROM2/NVM 6_3b1)                                       */
 #define   Si2183_FIRMWARE_FOR_x63_PARTS           Si2183_PATCH16_6_3b1
#endif /* Si2183_B63_COMPATIBLE */
#ifdef    Si2183_B60_COMPATIBLE
 #include "Si2183_ROM2_Patch16_6_0b6.h"     /* firmware compatible with Si2183     (ROM2/NVM 6_0b1)                                       */
 #define   Si2183_FIRMWARE_FOR_x60_PARTS           Si2183_PATCH16_6_0b6
/* SPI FW download */
 ...
 #include "Si2183_ROM1_Patch16_5_5b13.h"     /* firmware compatible with Si2183     (ROM1/NVM 5_5b1)                                       */
 #define   Si2183_FIRMWARE_FOR_x55_PARTS          Si2183_PATCH16_5_5b13
/* #include "Si2183_ROM1_SPI_5_5b7.h"       */  /* SPI mode compatible with Si2183     (ROM1/NVM 5_5b1)                                       */
 ...
 /* When using Si2180 parts, including 'full' FW for all standards is not needed. The 5_6bx FW is smaller (since it contains no T2/C2/S2) */
 #include "Si2183_ROM0_Patch16_5_0b16.h"     /* firmware compatible with Si2183     (ROM0/NVM 5_0b3)                                      */
 #define   Si2183_FIRMWARE_FOR_x50_PARTS          Si2183_PATCH16_5_0b16
 #ifdef    FW_DOWNLOAD_OVER_SPI
...
//  #define   Si2164_DVB_C2_FIRMWARE_FOR_x40_PARTS  Si2164_PATCH16_4_4b26
 ...
 /* 16 bytes mode patch compatible with Si2164-A40, Si2169-B40 and Si268-B40 (smaller patch with no DVB-C2) */
   #include "Si2164_ROM1_Patch16_4_0b30.h"
   #define   Si2164_FIRMWARE_FOR_x40_PARTS          Si2164_PATCH16_4_0b30
...
//  #define   Si2167B_DVB_C_FIRMWARE_FOR_x22_PARTS  Si2167B_PATCH_2_8b1
 #endif /* DEMOD_DVB_C */
 #include "Si2167B_ROM0_Patch_2_2b9.h"
 #define   Si2167B_FIRMWARE_FOR_x22_PARTS         Si2167B_PATCH_2_2b9
...
void Si2183_plot                             (Si2183_L2_Context   *front_end, const char* source, char signed_val, long currentRF) {
  ...
  int tune_freq = 0;
  int spectrum_start_freq = 0;
  int spectrum_stop_freq = 0;
  int analysis_bw = 0;
  int analyzis_start_freq = 0;
  int analyzis_stop_freq = 0;
  ...
  __attribute__((unused)) L1_Si2183_Context *api;
        ...
        if ((w < nb_word-0) && (w > nb_skip_first_words)) {
          ...
          if (currentRF >= LIMITED_RANGE_MIN_RF) {
            ...
            if ((count%1) ==0 ) {
              ...
              Si2183_FORCED_TRACE("%10d %8d (%3d) [%4d] |%*s\n", (int)(currentRF/1000), (int)(msb), w, blanks, blanks,"*");
              /* DEBUG */
              blanks = (int)((lsb/standard_specific_spectrum_scaling) -standard_specific_spectrum_offset);
              Si2183_FORCED_TRACE("%10d %8d (%3d) [%4d] |%*s\n", (int)((currentRF + inter_carrier_space)/1000), (int)(lsb), w, blanks, blanks,"*");
...
signed   int Si2183_PowerUpWithPatch    (L1_Si2183_Context *api)
{
  ...
  if (!(api->load_control & Si2183_SKIP_LOADFIRMWARE )) {
...
#ifdef    DEMOD_ISDB_T
#ifdef    Si2180_B60_COMPATIBLE
    SiLOGS ("Build Option: Si2180_B60_COMPATIBLE (smaller FW without T2/C2/S2)\n");
#ifdef FW_DOWNLOAD_OVER_SPI
    #ifdef    Si2180_SPI_6_3b1_LINES
    if ( (api->spi_download) & (!fw_loaded) ) {
      SiLOGS   ("Checking if we can load Si2180_SPI_6_3b1\n");
      SiTRACE  ("Si2180_SPI_6_3b1_LINES: Is this part a  'Si21%2d_ROM%x_%c_%c_b%d'?\n", Si2180_SPI_6_3b1_PART, Si2180_SPI_6_3b1_ROM, Si2180_SPI_6_3b1_PMAJOR, Si2180_SPI_6_3b1_PMINOR, Si2180_SPI_6_3b1_PBUILD );
      if ((api->rsp->part_info.romid  == Si2180_SPI_6_3b1_ROM   )
        &(
        ...
        if ((return_code = Si2183_LoadFirmwareSPI(api, Si2180_SPI_6_3b1, Si2180_SPI_6_3b1_LINES, Si2180_SPI_6_3b1_KEY, Si2180_SPI_6_3b1_NUM )) != NO_Si2183_ERROR) {
          SiTRACE ("Si2183_LoadFirmwareSPI  error 0x%02x: %s\n", return_code, Si2183_L1_API_ERROR_TEXT(return_code) );
          return return_code;
        }
        #ifdef    Si2180_SPI_6_3b1_INFOS
          SiERROR(Si2180_SPI_6_3b1_INFOS);
        #endif /* Si2180_SPI_6_3b1_INFOS */
        fw_loaded++;
      }
    }
    #endif /* Si2180_SPI_6_3b1_LINES */
#endif /* FW_DOWNLOAD_OVER_SPI */
    #ifdef    Si2180_FIRMWARE_FOR_x60_PARTS
    if (!fw_loaded) {
      SiTRACE ("Checking if we can load firmware for a Si2180 6_0b1 part\n");
      if   (((api->rsp->part_info.romid  == 2 )
        ...
        if ((return_code = Si2183_LoadFirmware_16(api, Si2180_FIRMWARE_FOR_x60_PARTS, sizeof(Si2180_FIRMWARE_FOR_x60_PARTS)/(sizeof(firmware_struct)))) != NO_Si2183_ERROR) {
    ...
    #endif /* Si2180_FIRMWARE_FOR_x60_PARTS */
    ...
    #endif /* Si2183_FIRMWARE_FOR_B5A_PARTS */
#endif /* Si2183_B5A_COMPATIBLE */
#ifdef    Si2183_A55_COMPATIBLE
...
signed   int Si2183_PowerUpUsingBroadcastI2C    (L1_Si2183_Context *demods[], signed   int demod_count )
{
...
#ifdef    TERRESTRIAL_FRONT_END
    api->standard = Si2183_TERRESTRIAL;
#endif /* TERRESTRIAL_FRONT_END */
#ifdef    SATELLITE_FRONT_END
    api->standard = Si2183_SATELLITE;
#endif /* SATELLITE_FRONT_END */
  ...
  if ( (return_code = Si2183_PowerUpWithPatch(demods[Si2183_DEMOD_BROADCAST_INDEX])) != NO_Si2183_ERROR) {
                                   ...
                                   )
{
    ...
    front_end->misc_infos = 0x00000000;
...
************************************************************************************************************************/
signed   int  Si2183_L2_Set_Index_and_Tag  (Si2183_L2_Context *front_end, unsigned char index, char* tag)
{
...
{
  __attribute__((unused)) signed   int start_time_ms;
...
signed   int  Si2183_L2_switch_to_standard (Si2183_L2_Context *front_end, unsigned char new_standard, unsigned char force_full_init)
{
  ...
  if (dtv_demod_needed == 1) {
    ...
    front_end->demod->media = Si2183_Media(front_end->demod, front_end->demod->prop->dd_mode.modulation);
  }
    ...
    if (front_end->demod->media == Si2183_SATELLITE  ) {
      ...
      if (front_end->SAT_init_done == 0) {
        ...
        if (Si2183_Configure(front_end->demod) == NO_Si2183_ERROR) {
          ...
          if ( new_standard == Si2183_DD_MODE_PROP_MODULATION_DSS ) {
...
/*      lpf_khz = (int)((symbol_rate_bps*(1.35/2.0))/1000 + front_end->demod->prop->dvbs2_afc_range.range_khz); */
  ...
  if (lock) {
    ...
    printf ("Si2183_lock_to_carrier 'lock'  took %3d ms\n"        , searchDelay);
  } else {
    ...
    printf ("Si2183_lock_to_carrier at %10d (%s) failed after %d ms\n",freq, Si2183_standardName(front_end->demod->rsp->dd_status.modulation), searchDelay);
  }
...
/************************************************************************************************************************
  ...
  Parameter:  agc1_mode:  where the AGC 1 PWM comes from.
              possible modes:
                0x0: Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_NOT_USED,
                0xA: Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_A,
                0xB: Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_B,
                0xC: Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_C,
                0xD: Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_D,
...
signed   int  Si2183_L2_TER_AGC            (Si2183_L2_Context *front_end, signed   int agc1_mode, signed   int agc1_inversion, signed   int agc2_mode, signed   int agc2_inversion)
{
  switch (agc1_mode) {
    default:
    case 0x0: { front_end->demod->cmd->dd_ext_agc_ter.agc_1_mode  = Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_NOT_USED; break; }
    case 0xA: { front_end->demod->cmd->dd_ext_agc_ter.agc_1_mode  = Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_A    ; break; }
    case 0xB: { front_end->demod->cmd->dd_ext_agc_ter.agc_1_mode  = Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_B    ; break; }
    case 0xC: { front_end->demod->cmd->dd_ext_agc_ter.agc_1_mode  = Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_C    ; break; }
    case 0xD: { front_end->demod->cmd->dd_ext_agc_ter.agc_1_mode  = Si2183_DD_EXT_AGC_TER_CMD_AGC_1_MODE_MP_D    ; break; }
  }

  if (agc1_inversion == 0) {
                front_end->demod->cmd->dd_ext_agc_ter.agc_1_inv   = Si2183_DD_EXT_AGC_TER_CMD_AGC_1_INV_NOT_INVERTED;}
   else {       front_end->demod->cmd->dd_ext_agc_ter.agc_1_inv   = Si2183_DD_EXT_AGC_TER_CMD_AGC_1_INV_INVERTED;    }
...
/************************************************************************************************************************
  ...
  Parameter:  agc2_mode:  where the AGC 2 PWM comes from.
              possible modes:
                0x0: Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_NOT_USED,
                0xA: Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_A,
                0xB: Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_B,
                0xC: Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_C,
                0xD: Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_D,
...
signed   int  Si2183_L2_SAT_AGC            (Si2183_L2_Context *front_end, signed   int agc1_mode, signed   int agc1_inversion, signed   int agc2_mode, signed   int agc2_inversion)
{
  ...
  switch (agc2_mode) {
    default  :
    case 0x0: { front_end->demod->cmd->dd_ext_agc_sat.agc_2_mode  = Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_NOT_USED; break; }
    case 0xA: { front_end->demod->cmd->dd_ext_agc_sat.agc_2_mode  = Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_A    ; break; }
    case 0xB: { front_end->demod->cmd->dd_ext_agc_sat.agc_2_mode  = Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_B    ; break; }
    case 0xC: { front_end->demod->cmd->dd_ext_agc_sat.agc_2_mode  = Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_C    ; break; }
    case 0xD: { front_end->demod->cmd->dd_ext_agc_sat.agc_2_mode  = Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_MODE_MP_D    ; break; }
  }
  if (agc2_inversion == 0) {
                front_end->demod->cmd->dd_ext_agc_sat.agc_2_inv   = Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_INV_NOT_INVERTED; }
  else {        front_end->demod->cmd->dd_ext_agc_sat.agc_2_inv   = Si2183_DD_EXT_AGC_SAT_CMD_AGC_2_INV_INVERTED;     }
...
signed   int  Si2183_L2_prepare_diseqc_sequence(Si2183_L2_Context *front_end, signed   int sequence_length, unsigned char *sequenceBuffer, unsigned char cont_tone, unsigned char tone_burst, unsigned char burst_sel, unsigned char end_seq)
{
  ...
  bus_state          = Si2183_DD_DISEQC_STATUS_RESPONSE_BUS_STATE_BUSY;
                                           ...
                                           )
{
    ...
    ddRestartTime        = 0; /* To avoid code checker warning */
    ...
    *constellation   = 0;
    ...
    switch ( front_end->demod->standard )
    {
      ...
      case Si2183_DD_MODE_PROP_MODULATION_DVBC : {
        blind_mode = 1;
        max_lock_time_ms = Si2183_DVBC_MAX_SEARCH_TIME;
        min_lock_time_ms = Si2183_DVBC_MIN_LOCK_TIME;
        break;
      }
#endif /* DEMOD_DVB_C */
  ...
  if (blind_mode == 0) { /* DVB-T / DVB-T2 / ISDB-T / DVB-C2 */
    ...
    while ( seek_freq <= front_end->rangeMax )
    {
      if (start_resume) {
        ...
        if (Si2183_L2_Tune (front_end, seek_freq )!= seek_freq) {
          ...
          if ( ( front_end->demod->rsp->dvbc2_status.pcl      == Si2183_DVBC2_STATUS_RESPONSE_PCL_LOCKED           ) ) {
            *standard     = Si2183_DD_MODE_PROP_MODULATION_DVBC2;
            ...
            if (front_end->demod->rsp->dvbc2_status.rf_freq != seek_freq) {
              ...
              while (system_time() - ddRestartTime < max_lock_time_ms) {
                Si2183_L1_DVBC2_STATUS   (api, Si2183_DVBC2_STATUS_CMD_INTACK_CLEAR);
...
#define get_reg_from_code(ptr,register)      SiTRACE("%s %3d  ", #register, Si2183_L2_GET_REG (ptr, Si2183_##register##_CODE));
  ...
  #define Si2183_auto_relock_CODE          0,78,10
  #define Si2183_en_rst_error_CODE         0,244,9
  #define Si2183_demod_lock_t_CODE         0,0,8
  #define Si2183_fec_lock_t2_CODE          0,140,18
  #define Si2183_tbd_a_CODE               15,88,10
  #define Si2183_trap_type_CODE            7,246,9
  #define Si2183_firmware_sm_CODE          7,76,10
  #define Si2183_pre_crc_ok_CODE           0,82,12
  #define Si2183_pre_crc_nok_tog_CODE      0,84,12
  #define Si2183_l1_post_crc_ok_CODE       0,14,12
  #define Si2183_l1_post_crc_nok_tog_CODE  0,15,12
  #define Si2183_td_alarms_CODE            8,148,14
  #define Si2183_td_alarms_first_CODE      8,144,14
  #define Si2183_fd_alarms_CODE           31,56,14
  #define Si2183_fd_alarms_first_CODE     31,60,14
  ...
  #define Si2183_wdog_error_CODE          66,245,9
...
/*#include "Doc/Si_2183_fft.c"*/
/*#include "Si_2183_dump.c" */
/*#include "Doc/Si_2183_Get_Echoes.c"*/
...
unsigned int   Si2183_n_bits             (unsigned int *wordTable, int n, unsigned int *bitIndex) {
  ...
  signed   int b;
  unsigned int res;
  SiTRACE_X("Si2183_n_bits(wordTable, %2d, %4d) ", n, *bitIndex);
...
************************************************************************************************************************/
signed   int   Si2183_L2_Test                         (Si2183_L2_Context *front_end, char *target, char *cmd, char *sub_cmd, double dval, double *retdval, char **rettxt)
{
  signed   int i,c,p;
 ...
 return 1;
    ...
    if (strcmp_nocase(cmd,"t2"    ) == 0) { /* Kevin */
      if (strcmp_nocase(sub_cmd,"plp_info"   ) == 0) {
        if (Si2183_L1_DVBT2_PLP_INFO(front_end->demod, dval) != NO_Si2183_ERROR) {
          SiTRACE("Si2164_L2_Test plp_info error when checking PLP index %d!\n", dval);
          SiERROR("Si2164_L2_Test plp_info error!\n");
          sprintf(*rettxt, "error when checking PLP index %d\n", (int)dval );

          return 1;
        }

        int    i_plp_id              = front_end->demod->rsp->dvbt2_plp_info.plp_id;
        int    i_plp_type            = front_end->demod->rsp->dvbt2_plp_info.plp_type;
        int    i_plp_payload_type    = front_end->demod->rsp->dvbt2_plp_info.plp_payload_type;
        int    i_group_id            = front_end->demod->rsp->dvbt2_plp_info.plp_group_id_lsb;
        int    i_plp_cod             = front_end->demod->rsp->dvbt2_plp_info.plp_cod;
        int    i_plp_mod             = front_end->demod->rsp->dvbt2_plp_info.plp_mod_lsb;
        int    i_plp_rot             = front_end->demod->rsp->dvbt2_plp_info.plp_rot;
        int    i_plp_fec_type        = front_end->demod->rsp->dvbt2_plp_info.plp_fec_type;
        int    i_plp_num_blocks_max  = front_end->demod->rsp->dvbt2_plp_info.plp_num_blocks_max_lsb;
        int    i_frame_interval      = front_end->demod->rsp->dvbt2_plp_info.frame_interval_lsb;
        int    i_time_il_length      = front_end->demod->rsp->dvbt2_plp_info.time_il_length_lsb;
        int    i_time_il_type        = front_end->demod->rsp->dvbt2_plp_info.time_il_type;
        int    i_plp_mode            = front_end->demod->rsp->dvbt2_plp_info.plp_mode;
        int    i_static_flag         = front_end->demod->rsp->dvbt2_plp_info.static_flag;
        int    i_static_padding_flag = front_end->demod->rsp->dvbt2_plp_info.static_padding_flag;
        char  s_plp_type [100];
      ...
      if (strcmp_nocase(sub_cmd,"tx_id"      ) == 0) {
        ...
        int tx_id_availability = front_end->demod->rsp->dvbt2_tx_id.tx_id_availability;
        int cell_id            = front_end->demod->rsp->dvbt2_tx_id.cell_id;
        int network_id         = front_end->demod->rsp->dvbt2_tx_id.network_id;
        int t2_system_id       = front_end->demod->rsp->dvbt2_tx_id.t2_system_id;
      ...
      if (strcmp_nocase(sub_cmd,"fef"      ) == 0) {
        ...
        int fef_repetition  = front_end->demod->rsp->dvbt2_fef.fef_repetition;
        int fef_type        = front_end->demod->rsp->dvbt2_fef.fef_type;
        int fef_length      = front_end->demod->rsp->dvbt2_fef.fef_length;
    ...
    if (strcmp_nocase(cmd,"ber"         ) == 0) {
     ...
     if (strcmp_nocase(sub_cmd,"loop" ) == 0) {
       ...
       for (i=0; i< (int)dval; i++) {
        ...
        printf("%4d: (%6d ms) BER %8.2e C/N_100 %d", i+1, system_time() - start_time_ms, *retdval, front_end->demod->rsp->dvbt_status.cnr*25 );
     ...
     if (strcmp_nocase(sub_cmd,"after_reset" ) == 0) {
       ...
       for (i=0; i< (int)dval; i++) {
         ...
         *retdval = 1.0;
          printf("%4d: (%6d ms) BER unavailable C/N_100 %d", i+1, system_time() - start_time_ms, front_end->demod->rsp->dvbt_status.cnr*25 );
        }
        printf("\n");
        system_wait(0);
       }
    ...
    if (strcmp_nocase(cmd,"isdb-t"      ) == 0) {
      if (strcmp_nocase(sub_cmd,"layer_info"   ) == 0) {
        ...
        int i_constellation  = front_end->demod->rsp->isdbt_layer_info.constellation;
        char s_constellation [100];
        int i_code_rate    = front_end->demod->rsp->isdbt_layer_info.code_rate   ;
        char s_code_rate [100];
        int IL             = front_end->demod->rsp->isdbt_layer_info.il            ;
        int nb_seg         = front_end->demod->rsp->isdbt_layer_info.nb_seg        ;
