...
void          Si2141_storeUserProperties    (Si2141_PropObj   *prop) {
  ...
  prop->dtv_pga_limits.min                             =    24; /* (default    -1) */
  prop->dtv_pga_limits.max                   =    -1; /* (default    -1) */
#endif /* Si2141_DTV_PGA_LIMITS_PROP */

#ifdef    Si2141_DTV_PGA_TARGET_PROP
  prop->dtv_pga_target.pga_target                      =     6; /* (default     0) */
  prop->dtv_pga_target.override_enable                 = Si2141_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_ENABLE ; /* (default 'DISABLE') */
  ...
  prop->dtv_rf_top.dtv_rf_top                          = Si2141_DTV_RF_TOP_PROP_DTV_RF_TOP_P7DB ; /* (default 'AUTO') */
  ...
  prop->tuner_tf1_boundary_offset.tf1_boundary_offset  =     -30; /* (default     0) */
