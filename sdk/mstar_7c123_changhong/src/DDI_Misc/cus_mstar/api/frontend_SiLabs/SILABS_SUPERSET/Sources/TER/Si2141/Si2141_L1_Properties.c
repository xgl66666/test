...
int  Si2141_downloadTUNERProperties       (L1_Si2141_Context *api) {
  ...
  if (Si2141_L1_SetProperty2(api, Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CODE  ) != NO_Si2141_ERROR) {return ERROR_Si2141_SENDING_COMMAND;}
#endif /* Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP */
#ifdef    Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP
  if (Si2141_L1_SetProperty2(api, Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_CODE) != NO_Si2141_ERROR) {return ERROR_Si2141_SENDING_COMMAND;}
    ...
    switch (prop_code) {
     ...
     case         Si2141_DTV_WB_AGC_SPEED_PROP_CODE:
      sprintf(msg,"DTV_WB_AGC_SPEED");
       ...
       strncat(msg,separator,1000); strcat(msg,"-DECAY ");
