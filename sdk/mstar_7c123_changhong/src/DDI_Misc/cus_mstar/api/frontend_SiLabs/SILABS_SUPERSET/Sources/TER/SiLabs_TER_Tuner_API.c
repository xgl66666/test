...
#endif /* TER_TUNER_Si2190 */
#ifdef    TER_TUNER_Si2190B
  if (silabs_tuner->ter_tuner_code == 0x2190B) { return (char*)Si2190B_L1_API_ERROR_TEXT(_error_code); }
#endif /* TER_TUNER_Si2190B */
#ifdef    TER_TUNER_Si2191
...
#ifdef    TER_TUNER_Si2141
  if (silabs_tuner->ter_tuner_code == 0x2141) { return -1; /* No ATV support with Si2141 */ }
#endif /* TER_TUNER_Si2141 */
#ifdef    TER_TUNER_Si2144
...
signed   int   SiLabs_TER_Tuner_VCO_Blocking_PostTune(SILABS_TER_TUNER_Context *tuners[], signed   int tuner_num, signed   int tuner_count) {
  ...
  __attribute__((unused))SILABS_TER_TUNER_Context *silabs_tuner;
...
************************************************************************************************************************/
signed   int   SiLabs_TER_Tuner_Test                 (SILABS_TER_TUNER_Context *silabs_tuner, char *target, char *cmd, char *sub_cmd, double dval, double *retdval, char **rettxt)
{
