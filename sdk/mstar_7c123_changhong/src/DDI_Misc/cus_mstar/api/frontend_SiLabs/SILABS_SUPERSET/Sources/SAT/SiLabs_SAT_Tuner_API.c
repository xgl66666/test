...
char*          SiLabs_SAT_Tuner_Tag            (SILABS_SAT_TUNER_Context *silabs_tuner) {
...
#endif /* SAT_TUNER_RDA5816SD */
  return (char *)"unknown tuner_code";
}
...
************************************************************************************************************************/
signed   int   SiLabs_SAT_Tuner_Test           (SILABS_SAT_TUNER_Context *silabs_tuner, char *target, char *cmd, char *sub_cmd, double dval, double *retdval, char **rettxt)
{
...
sat_tuner address <address>            : set the i2c address 5if '0', returns the current address)\n\
");
 return 1;
  }
