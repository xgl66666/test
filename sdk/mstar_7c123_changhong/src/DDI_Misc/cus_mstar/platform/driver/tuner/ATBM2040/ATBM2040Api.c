...
ATBM2040_ERROR_e ATBM2040Init(UINT8 u8TunerIndex, UINT32 DevId, ATBM2040InitConfig_t *pConfig)
{
    ...
    ATBM2040CfgPrint(u8TunerIndex, pTuner); /*Debug info print*/
...
ATBM2040_ERROR_e ATBM2040DefaultCfgGet(UINT8 u8TunerIndex, ATBM2040InitConfig_t *pConfig)
{
    ...
    pConfig->I2CAddr = ATBM_TUNER_DEFAULT_I2C_ADDR;
...
* Retrun: ATBM2040_ERROR_NO_ERROR -- no error; others refer to ATBM2040_ERROR_e
********************************************************************/
ATBM2040_ERROR_e ATBM2040CfgSet(UINT8 u8TunerIndex, UINT32 DevId, ATBM2040CfgCMD_t *pCfg)
{
    ATBM2040_ERROR_e ret = ATBM2040_NO_ERROR;
    ATBM2040_t *pTuner = NULL;
    ...
    ret = ATBM2040DrvCfgSet(u8TunerIndex, pTuner, pCfg);
...
ATBM2040_ERROR_e ATBM2040ChannelTune(UINT8 u8TunerIndex, UINT32 DevId, ATBM2040_SIGNAL_MODE_e Mode, UINT32 FreqKHz, UINT32 BandWidthKHz, ATBM2040_SPECTRUM_MODE_e SpectrumMode)
{
    ...
    ret = ATBM2040DrvFreqTune(u8TunerIndex, pTuner);
    pTuner->BWKHzBak = pTuner->BWKHz;
    pTuner->MixerIFBak = pTuner->MixerIF;    
    pTuner->BandBak = pTuner->Band;
    ATBM2040Print(("[Info]ATBM2040ChannelTune(%d,%d,%d),ret =%d\n",FreqKHz,BandWidthKHz,SpectrumMode,ret));
    return ret;
}
...
ATBM2040_ERROR_e ATBM2040GetLockStatus(UINT8 u8TunerIndex, UINT32 DevId, BOOL *pLockStatus)
{
    ...
    *pLockStatus = FALSE;
    ret = ATBM2040RegRead(u8TunerIndex, pTuner->Config.I2CAddr, 0x14, 0xAA, &Val); /*ro_reg_agc_setting_state[1:0]*/
    if ((ATBM2040_NO_ERROR == ret) && (0x02 == Val))
    {
        *pLockStatus = TRUE;
    }
    return ret;
...
* Retrun: ATBM2040_ERROR_NO_ERROR -- no error; others refer to ATBM2040_ERROR_e
********************************************************************/
ATBM2040_ERROR_e ATBM2040GetIFFreq(UINT8 u8TunerIndex,UINT32 DevId,UINT32 *pIFFreqHz)
{
    ATBM2040_ERROR_e ret = ATBM2040_NO_ERROR;
    ATBM2040_t *pTuner = NULL;
    ...
    {
        ret = ATBM2040DefaultCfgGet(u8TunerIndex,&Config);
        if(ATBM2040_NO_ERROR != ret)
        {
...
* Retrun: ATBM2040_ERROR_NO_ERROR -- no error; others refer to ATBM2040_ERROR_e
********************************************************************/
ATBM2040_ERROR_e ATBM2040GetRSSI(UINT8 u8TunerIndex, UINT32 DevId, SINT32 *pRSSI)
{
    ATBM2040_ERROR_e ret = ATBM2040_NO_ERROR;
    SINT16 SignalPow = 0;
    ATBM2040_t *pTuner = NULL;
    ...
    ret = ATBM2040DrvGetRSSI(u8TunerIndex, pTuner->Config.I2CAddr, &SignalPow);
    *pRSSI = SignalPow / 16;
...
ATBM2040_ERROR_e ATBM2040Standby(UINT8 u8TunerIndex, UINT32 DevId)
{
    ...
    ret = ATBM2040DrvStandby(u8TunerIndex, pTuner);
...
ATBM2040_ERROR_e ATBM2040GetSDKVer(UINT8 u8TunerIndex, UINT32 DevId, UINT32 *pVersion)
{
    ...
    ret = ATBM2040DrvGetSDKVer(u8TunerIndex, pTuner, pVersion);
...
ATBM2040_ERROR_e ATBM2040Process(UINT8 u8TunerIndex, UINT32 DevId)
{
    ...
    ret = ATBM2040DrvProcess(u8TunerIndex, pTuner);
    return ret;
}

#ifdef ATBM2040_CHIP_DEBUG_OPEN
ATBM2040_t *ATBM2040ObjGet(UINT8 u8TunerIndex, UINT32 DevId)
{
    ATBM2040_t *pTuner = NULL;
