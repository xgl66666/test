...
#define TDA18250A_ERR_POWER_LEVEL_TOO_LOW        (TDA18250A_ERR_COMP + 0x0006)
#define TDA18250A_ERR_POWER_LEVEL_TOO_HIGH       (TDA18250A_ERR_COMP + 0x0007)
...
typedef enum _TDA18250AStandardMode_t {
    ...
    TDA18250A_QAM_7MHz,                                  /* Digital TV QAM 7MHz */
