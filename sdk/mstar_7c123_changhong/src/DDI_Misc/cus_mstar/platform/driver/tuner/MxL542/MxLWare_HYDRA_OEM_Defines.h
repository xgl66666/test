...
#else
#define MXL_HYDRA_DEBUG(x...)              // printf(x)           
#define MXL_HYDRA_ERROR(x...)               //printf
#define MXL_HYDRA_PRINT(x...)               //printf
#endif
#endif
...
#define MXL_MODULE_DEBUG_LEVEL_MxL542 3
//#define MXL_MODULE_DEBUG_OPTIONS MXLDBG_ERROR+MXLDBG_API
#define MXL_MODULE_DEBUG_OPTIONS_MxL542 MXLDBG_ERROR+MXLDBG_ENTER+MXLDBG_EXIT+MXLDBG_API
//#define MXL_MODULE_DEBUG_OPTIONS MXLDBG_ERROR
#define MXL_MODULE_DEBUG_FCT_MxL542 MXL_HYDRA_DEBUG
