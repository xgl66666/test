...
#define MDrv_IIC_Read(a, b, c, d, e) MDrv_IIC_ReadBytes(FRONTEND_TUNER_PORT,a, c, b, e, d)
#define MDrv_IIC_Write(a, b, c, d, e) MDrv_IIC_WriteBytes(FRONTEND_TUNER_PORT,a, c, b, e, d)
