...
#ifndef _TUNERNULL_C_
#define _TUNERNULL_C_
...
MS_BOOL MDrv_Tuner_Null_Initial(MS_U8 u8TunerIndex,TUNER_MS_INIT_PARAM* pParam)
{
...
MS_BOOL MDrv_Tuner_Null_CheckExist(MS_U8 u8TunerIndex, MS_U32* pu32channel_cnt)
{
    TUNER_DBG(("%s, %d \n", __FUNCTION__,__LINE__));
    return TRUE;
}
...
{                                                                       
    ...
    .data               = TUNER_NULL,            // private data value
    .Init               = MDrv_Tuner_Null_Initial,
