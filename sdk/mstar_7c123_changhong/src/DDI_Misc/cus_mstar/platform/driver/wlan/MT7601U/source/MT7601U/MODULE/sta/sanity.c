			...
			if (pEid->Len >= SIZE_HT_CAP_IE) {	/* Note: allow extension.!! */
...
#ifdef UNALIGNMENT_SUPPORT
				{
					...
					EXT_HT_CAP_INFO 		ExtHtCapInfo;  
								...
								{
									NdisMoveMemory((PUCHAR)(&HtCapInfo), (PUCHAR)(&pHtCapability->HtCapInfo), sizeof(HT_CAP_INFO));
									*(USHORT *)(&HtCapInfo) = cpu2le16(*(USHORT *)(&HtCapInfo));
									NdisMoveMemory((PUCHAR)(&pHtCapability->HtCapInfo), (PUCHAR)(&HtCapInfo), sizeof(HT_CAP_INFO));
								}
