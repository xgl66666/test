...
//diag_printf("%s  %d  Eid =%d\n",__FUNCTION__,__LINE__,pEid->Eid);
        ...
        switch(pEid->Eid)
	{
		case IE_SSID:
			...
			//DBGPRINT(RT_DEBUG_TRACE, ("%s() - wrong IE_SSID (len=%d)\n",__FUNCTION__,pEid->Len));
			//DBGPRINT(RT_DEBUG_TRACE, ("%s() -  IE_SSID ssid=%s\n",__FUNCTION__,ie_list->Ssid));


			//diag_printf("%s  %d  ssid=%s\n",__FUNCTION__,__LINE__,pEid->Octet);
...
#ifdef UNALIGNMENT_SUPPORT
{
	...
	ADD_HTINFO3			AddHtInfo3;	 
				...
				{
					NdisMoveMemory((PUCHAR)(&AddHtInfo2), (PUCHAR)(&ie_list->AddHtInfo.AddHtInfo2), sizeof(ADD_HTINFO2));
					*(USHORT *)(&AddHtInfo2) = cpu2le16(*(USHORT *)(&AddHtInfo2));
					NdisMoveMemory((PUCHAR)(&ie_list->AddHtInfo.AddHtInfo2), (PUCHAR)(&AddHtInfo2), sizeof(ADD_HTINFO2));
				}

				{
					NdisMoveMemory((PUCHAR)(&AddHtInfo3), (PUCHAR)(&ie_list->AddHtInfo.AddHtInfo3), sizeof(ADD_HTINFO3));
					*(USHORT *)(&AddHtInfo3) = cpu2le16(*(USHORT *)(&AddHtInfo3));
					NdisMoveMemory((PUCHAR)(&ie_list->AddHtInfo.AddHtInfo3), (PUCHAR)(&AddHtInfo3), sizeof(ADD_HTINFO3));
				}
//diag_printf("%s  %d \n",__FUNCTION__,__LINE__);
