...
ifeq ($(OSABL),NO)
$(MOD_NAME)-objs += \
        ../../os/ecos/rt_usb_util.o\
        ../../os/ecos/usb_main_dev.o\
		../../os/ecos/usb_main_end.o\
        ../../os/ecos/sta_ioctl.o\
			../../os/ecos/iwpriv.o\
		../../os/ecos/api_for_uplayer_app.o\
		../../common/rtusb_dev_id.o\
...
EXTRA_CFLAGS = $(CC_OPTS) $(CC_DEFS) $(CC_INCS) $(DRV_CC_INCS) -D_KERNEL $(WFLAGS)

#all: $(MODULE)
#$(MODULE): $(ALL_OBJS:.o)
#	$(CC) -r $(ENDIAN) -o $(MODULE) $(ALL_OBJS)
#========= for GX ==========
#	$(AR) rcs libusbwifi.a $(ALL_OBJS)
#	mv libusbwifi.a $(ECOS_INSTALL_DIR)/lib/
...
#clean:
#	for o in `find ../../ -name "*.[od]"`; do rm $$o; done
