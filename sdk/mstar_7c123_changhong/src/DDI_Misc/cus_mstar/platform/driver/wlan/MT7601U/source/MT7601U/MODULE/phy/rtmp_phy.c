...
{
	UCHAR bbp_value1, bbp_value2, bbp_value3, bbp_value4, bbp_value5;

	RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R50, &bbp_value1);
	RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R51, &bbp_value2);
	RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R52, &bbp_value3);
	RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R53, &bbp_value4);
	RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R54, &bbp_value5);

	return (bbp_value1^bbp_value2^bbp_value3^bbp_value4^bbp_value5);
}
