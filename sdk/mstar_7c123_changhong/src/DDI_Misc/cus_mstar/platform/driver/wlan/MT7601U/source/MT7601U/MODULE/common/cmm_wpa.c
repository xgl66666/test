    ...
    IN MLME_QUEUE_ELEM  *Elem) 
{
	...
	mt7601_connect_status = 3;//start of 4-way-handshark
	
	DBGPRINT(RT_DEBUG_ERROR, ("%s: mt7601_connect_status =%d\n",  __FUNCTION__,mt7601_connect_status));
    ...
    IN MLME_QUEUE_ELEM  *Elem) 
{
		...
		pEntry->AuthMode == Ndis802_11AuthModeWPA2)
	{
		...
		mt7601_connect_status = 33;	
		DBGPRINT(RT_DEBUG_ERROR, ("%s: mt7601_connect_status =%d\n",  __FUNCTION__,mt7601_connect_status));
		
		mt7601_connect_status = 4;	
		DBGPRINT(RT_DEBUG_ERROR, ("%s: mt7601_connect_status =%d\n",  __FUNCTION__,mt7601_connect_status));
    ...
    OUT PEAPOL_PACKET       pMsg)
{
...
#ifdef UNALIGNMENT_SUPPORT
	{
		...
		{
			NdisMoveMemory((PUCHAR)(&KeyInfo), (PUCHAR)(&pMsg->KeyDesc.KeyInfo), sizeof(KEY_INFO));
			*(USHORT *)(&KeyInfo) = cpu2le16(*(USHORT *)(&KeyInfo));
			NdisMoveMemory((PUCHAR)(&pMsg->KeyDesc.KeyInfo), (PUCHAR)(&KeyInfo), sizeof(KEY_INFO));
		}	
	}
#else
