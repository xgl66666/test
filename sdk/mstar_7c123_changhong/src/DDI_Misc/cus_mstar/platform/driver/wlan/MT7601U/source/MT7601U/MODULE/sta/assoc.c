...
/* mark here because linkdown also call this function */
	...
	mt7601_connect_status = 0;//disconnect by sta
}
...
/* mark here because linkdown also call this function */
	...
	mt7601_connect_status = 0; //disconnect by ap
}
...
{
	USHORT Status;
	DBGPRINT(RT_DEBUG_ERROR, ("ASSOC - AssocTimeoutAction\n"));
	pAd->Mlme.AssocMachine.CurrState = ASSOC_IDLE;
