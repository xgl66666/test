...
#ifndef _MDRV_IR_TX_H_
#define _MDRV_IR_TX_H_
...
/// Define NEC IR Spec. param 
typedef struct
{
    MS_U8                 u8Customer_Code;
    MS_U8                 u8Command_Code;
    MS_BOOL               bRepeat;
}IR_TX_NEC_KEY_CODE;
...
typedef struct
{
    union
    {
        IR_TX_NEC_KEY_CODE NECKeyCode;                           ///< Paramters for NEC
    };
}IR_TX_KEY_CODE;

typedef struct
{
    MS_BOOL bEnable_IR_TX;
    MS_BOOL bEnable_IR_TX_Interrupt;
    MS_BOOL bOutput_Invert;
    MS_BOOL bOutput_With_Carrier;
}IR_TX_INIT_PARAM;
...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#define MCU_CLK    108000UL  //kHz, depend on reg_ckg_mcu in PM_TOP bank
#define SAMPLING_RATE_NEC 6000UL //KHz
#define IR_TX_TIMEOUT 1000 //ms

#define IR_TX_STATUS_EN           0x01
#define IR_TX_STATUS_RST_RELEASE  0x02
#define IR_TX_STATUS_INT_EN       0x04
#define IR_TX_STATUS_CARRIER_EN   0x10

//define NEC timming
#define NEC_HEADER_CODE     9000UL //us
#define NEC_OFF_CODE        4500UL
#define NEC_OFF_CODE_REPEAT 2500UL
#define NEC_LOGIC_0_H       560UL
#define NEC_LOGIC_0_L       560UL
#define NEC_LOGIC_1_H       560UL
#define NEC_LOGIC_1_L       1680UL
#define NEC_CYCLE_TIME      108000UL
#define NEC_CARRIER_CLK     38UL //kHz
#define NEC_CARRIER_DUTY    33UL //percentage
