...
MS_BOOL MDrv_Demod_null_init(MS_U8 u8DemodIndex,DEMOD_MS_INIT_PARAM* pParam)
{
...
MS_BOOL MDrv_Demod_null_Restart(MS_U8 u8DemodIndex,DEMOD_MS_FE_CARRIER_PARAM* pParam,MS_U32 u32BroadCastType)
{
    DMD_DBG(("%s, %d \n", __FUNCTION__,__LINE__));
    return TRUE;
}
...
MS_BOOL MDrv_Demod_null_GetScanTypeStatus(MS_U8 u8DemodIndex)
{
    DMD_DBG(("%s, %d \n", __FUNCTION__,__LINE__));
    return TRUE;
}

MS_BOOL MDrv_Demod_null_GetNextPLPID(MS_U8 u8DemodIndex, MS_U8 Index, MS_U8* pu8PLPID)
{
    DMD_DBG(("%s, %d \n", __FUNCTION__,__LINE__));
    return TRUE;
}
