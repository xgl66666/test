...
#define CHANNEL_SCAN_AUTO_TEST          1
#define SFU_AUTO_TEST                   1
...
INTERFACE BOOLEAN UART_GetChar(U8 *u8Char);
//--------------------------------------------------------------------------
...
INTERFACE void Cus_UART_DecodeExtCommand(void);
