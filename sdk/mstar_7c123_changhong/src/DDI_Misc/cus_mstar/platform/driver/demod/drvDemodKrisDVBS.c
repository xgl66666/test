...
static MS_U32 u32INTERNAL_DVBS2_DJB_ADR = NULL;
...
MS_BOOL MDrv_Kris_DVBS_Demod_Init(MS_U8 u8DemodIndex,DEMOD_MS_INIT_PARAM* pParam)
{
    ...
    sDMD_DVBS_InitData.u32DjbStartAddr = INTERNAL_DVBS2_DJB_ADR;
#else
    if(NULL == u32INTERNAL_DVBS2_DJB_ADR)
        return FALSE;
    else
        sDMD_DVBS_InitData.u32DjbStartAddr = u32INTERNAL_DVBS2_DJB_ADR;
#endif
    ...
    DMD_DBG(("Kris DVBS DMD FW Ver. %x\n", u16FWVer));
...
MS_BOOL MDrv_Kris_DVBS_Demod_GetParam(MS_U8 u8DemodIndex, DEMOD_MS_FE_CARRIER_PARAM* pParam)
{
   ...
   if(FALSE == MDrv_DMD_DVBS_GetParam(&SatParam))
    {
        HB_ReleaseMutex(_s32MutexId);
        return FALSE;
    }
    ...
    switch (QAMMode)
    {
     ...
     switch (SatParam.eCodeRate)                      //modify parameters
    {
        case HAL_DEMOD_CONV_CODE_RATE_1_2:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_1_2\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_1_2;
            break;
        case HAL_DEMOD_CONV_CODE_RATE_1_3:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_1_3\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_1_3;
            break;
        case HAL_DEMOD_CONV_CODE_RATE_2_3:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_2_3\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_2_3;
            break;
        case HAL_DEMOD_CONV_CODE_RATE_1_4:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_1_4\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_1_4;
            break;
        case HAL_DEMOD_CONV_CODE_RATE_3_4:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_3_4\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_3_4;
            break;
        case HAL_DEMOD_CONV_CODE_RATE_2_5:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_2_5\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_2_5;
            break;
        case HAL_DEMOD_CONV_CODE_RATE_3_5:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_3_5\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_3_5;
            break;
        case HAL_DEMOD_CONV_CODE_RATE_4_5:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_4_5\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_4_5;
            break;           
        case HAL_DEMOD_CONV_CODE_RATE_5_6:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_5_6\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_5_6;
            break;  
        case HAL_DEMOD_CONV_CODE_RATE_7_8:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_7_8\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_7_8;
            break;  
        case HAL_DEMOD_CONV_CODE_RATE_8_9:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_8_9\n"));
            pParam->SatParam.eCodeRate = DEMOD_CONV_CODE_RATE_8_9;
            break;  
        case HAL_DEMOD_CONV_CODE_RATE_9_10:
            DMD_DBG(("Kris DMD_CONV_CODE_RATE_9_10\n"));
...
MS_BOOL MDrv_Kris_DVBS_Demod_Restart(MS_U8 u8DemodIndex, DEMOD_MS_FE_CARRIER_PARAM* pParam,MS_U32 u32BroadCastType)
{
...
MS_BOOL MDrv_Demod_Kris_Get_Packet_Error(MS_U8 u8DemodIndex, MS_U16 *u16_data)
{
    MS_BOOL bRet = FALSE;
...
MS_BOOL MDrv_Demod_Kris_Extension_Function(MS_U8 u8DemodIndex, DEMOD_EXT_FUNCTION_TYPE fuction_type, void *data)
{
    ...
    switch(fuction_type)
    {
        ...
        case DEMOD_EXT_FUNC_SET_BUFFER_ADDR:
            u32INTERNAL_DVBS2_DJB_ADR = *(MS_U32*)data;
            break;
        default:
...
DRV_DEMOD_TABLE_TYPE GET_DEMOD_ENTRY_NODE(DEMOD_MSKRIS_DVBS) DDI_DRV_TABLE_ENTRY(demodtab) =
{
     ...
     .Get_Packet_Error              = MDrv_Demod_Kris_Get_Packet_Error,
#if MS_DVBT2_INUSE
