...
typedef enum
{
    DEV_MSB1236C_FFT_2K      = 0x0,
    DEV_MSB1236C_FFT_8K      = 0x1,
    DEV_MSB1236C_FFT_4K      = 0x2,
    DEV_MSB1236C_FFT_1K      = 0x3,
    DEV_MSB1236C_FFT_16K      = 0x4,
    DEV_MSB1236C_FFT_32K      = 0x5,
    DEV_MSB1236C_FFT_8K_     = 0x6,
    DEV_MSB1236C_FFT_32K_    = 0x7,
} DEV_MSB1236C_FFT_VAL;
