...
IR_DECODE_STATUS _ParsePANASONIC7051(U32 *pu32CustCode, U16 *pu16KeyCode, U8 *pu8State, U8 *pu8Reserved)
{
    ...
    if (MsOS_GetSystemTime() - _ulPanasonic7051PreDecodeTime > 60)//IR_TIME_UPD(IR_TIME_PANASONIC7051_TIMEOUT, IR_TIME_PANASONIC7051_TOLERENCE)/1000)
    {
    ...
    _ulPanasonic7051PreDecodeTime = MsOS_GetSystemTime();
