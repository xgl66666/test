...
#include "Keltic_Main_HSDRule.h"      // table config parameter
#include "Keltic_Main_VSDRule.h"      // table config parameter
#include "Keltic_Main_HSPRule.h"      // table config parameter
#include "Keltic_Main_VSPRule.h"      // table config parameter
#include "Keltic_Main_CSCRule.h"      // table config parameter
#include "Keltic_Main_GRule.h"        // table config parameter
#include "Keltic_Main_Ex.h"           // table config parameter
