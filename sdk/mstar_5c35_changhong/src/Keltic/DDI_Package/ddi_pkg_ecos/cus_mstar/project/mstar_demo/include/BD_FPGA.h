...
#define GPIO_SCART_PIN8 13
#define GPIO_SCART_PIN16 15
#define GPIO_SCART_ONSTBY 14
...
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSKAPPA_DVBC//DEMOD_NULL
...
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSB131X //AVAILINK_2108_DEMOD
...
#elif((MS_DVB_TYPE_SEL == DVBS))
#define FRONTEND_TUNER_TYPE                      TUNER_AV2012 //TUNER_SHARP_BS2S7HZ6306
#elif((MS_DVB_TYPE_SEL == INTERNAL_DVBT))
...
#undef DMX_INPUT
#if((MS_DVB_TYPE_SEL == DVBC)||(MS_DVB_TYPE_SEL == INTERNAL_DVBT)||(MS_DVB_TYPE_SEL == INTERNAL_ISDBT))
