...
#define USE_SW_I2C 1
#define DISABLE 0
#define KEYPAD_TYPE_ORIG 1
#define KEYPAD_TYPE_CUSTMOER 3
...
//------Chip Type---------------------------------------------------------------
#if defined CFG_CHIP_MSD5XX5
#include "chip/MSD5XX5.h"
#elif defined CFG_CHIP_MSD5XX3
#include "chip/MSD5XX3.h"
#elif defined CFG_CHIP_MSD5XX1
...
#define AUDIO_MUTE_GPIO  61//124A_S�G19 124A�G15 LOW to HIGH 59 //mz
#define AUDIO_MUTE_GPIO_LEVEL 0 // HIGH:0,LOW:1
#if(AUDIO_MUTE_GPIO_LEVEL == 0)
#define AUDIO_MUTE_SET_GPIO_UP mdrv_gpio_set_high
#define AUDIO_MUTE_SET_GPIO_DOWN mdrv_gpio_set_low
#else
#define AUDIO_MUTE_SET_GPIO_UP mdrv_gpio_set_low
#define AUDIO_MUTE_SET_GPIO_DOWN mdrv_gpio_set_high
#endif
#endif
...
#ifndef FRONTEND_DEMOD_TYPE
#if((MS_DVB_TYPE_SEL == DVBC))
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSKELTIC_DVBC//DEMOD_NULL
#elif((MS_DVB_TYPE_SEL == DVBT))
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSB123X//DEMOD_MSB122x
#elif((MS_DVB_TYPE_SEL == DVBT2))
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSB1233C
#elif((MS_DVB_TYPE_SEL == ISDBT))
#define FRONTEND_DEMOD_TYPE                      DIBCOM_DIB8096_DEMOD
#elif((MS_DVB_TYPE_SEL == DVBS))
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSKELTIC_DVBS //DEMOD_MSB131X //AVAILINK_2108_DEMOD
#elif((MS_DVB_TYPE_SEL == INTERNAL_DVBT))
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSKAPPA_DVBT
#elif((MS_DVB_TYPE_SEL == INTERNAL_ISDBT))
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSKAPPA_ISDBT
#elif((MS_DVB_TYPE_SEL == J83B))
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSKELTIC_ATSC//DEMOD_NULL
#endif
#endif
...
#define FRONTEND_DEMOD_IQ_TYPE      DEMOD_IQ_I_IN // C:Q T:I
#elif(MS_DVB_TYPE_SEL == DVBS)
#define FRONTEND_DEMOD_IQ_TYPE      DEMOD_IQ_IQ_IN // C:Q T:I
#endif

//------IF DEMOD Setting----------------------------------------------------------
#ifndef FRONTEND_IF_DEMODE_TYPE
#if((MS_DVB_TYPE_SEL == DVBC))
#define FRONTEND_IF_DEMODE_TYPE                     MSTAR_VIF_MSB1210
#elif((MS_DVB_TYPE_SEL == INTERNAL_DVBT))
#define FRONTEND_IF_DEMODE_TYPE                     MSTAR_VIF_MSB1210
#elif((MS_DVB_TYPE_SEL == J83B))
#define FRONTEND_IF_DEMODE_TYPE                     MSTAR_VIF_MSB1210
#else
#define FRONTEND_IF_DEMODE_TYPE                      MSTAR_VIF_MSB1228
#endif
#endif


//------TUNER Setting----------------------------------------------------------
#ifndef FRONTEND_TUNER_TYPE
#if((MS_DVB_TYPE_SEL == DVBC))
#define FRONTEND_TUNER_TYPE                      TUNER_TDA18250A//TUNER_MXL603//TUNER_PHILIPS_TDA18250HN // TUNER_PHILIPS_CD1616LF_GIGH_4
#elif((MS_DVB_TYPE_SEL == DVBT))
#define FRONTEND_TUNER_TYPE                      TUNER_MXL603//TUNER_NXP_TD1611ALF
#elif((MS_DVB_TYPE_SEL == DVBT2))
#define FRONTEND_TUNER_TYPE                      TUNER_MXL603//TUNER_NUTUNE_FT2125
#elif((MS_DVB_TYPE_SEL == ISDBT))
#define FRONTEND_TUNER_TYPE                      TUNER_DIBCOM_DIB8096
#elif((MS_DVB_TYPE_SEL == DVBS))
#define FRONTEND_TUNER_TYPE                      TUNER_AV2028 //TUNER_AV2012 //TUNER_SHARP_BS2S7HZ6306
#elif((MS_DVB_TYPE_SEL == INTERNAL_DVBT))
#define FRONTEND_TUNER_TYPE                      TUNER_MXL603//TUNER_MXL_MXL5007
#elif((MS_DVB_TYPE_SEL == INTERNAL_ISDBT))
#define FRONTEND_TUNER_TYPE                      TUNER_MXL603
#elif((MS_DVB_TYPE_SEL == J83B))
#define FRONTEND_TUNER_TYPE                      TUNER_MXL603//TUNER_PHILIPS_TDA18250HN // TUNER_PHILIPS_CD1616LF_GIGH_4
#endif
#endif
...
//-------DISH Setting---------------------------------------------------------
#define DISH_TYPE                                 DISH_A8296
#define DISH_TYPE1                                DISH_A8296

#define DISH_IIC_PORT                             E_HWI2C_PORT1_1
//------TS Input source setting-------------------------------------------------
#undef DMX_INPUT
#if((MS_DVB_TYPE_SEL == DVBC)||(MS_DVB_TYPE_SEL == INTERNAL_DVBT)||(MS_DVB_TYPE_SEL == INTERNAL_ISDBT)||(MS_DVB_TYPE_SEL == J83B)|| (MS_DVB_TYPE_SEL == DVBS))
...
#if (FRONTPNL_TYPE == FRONTPANEL_TYPE_PT6958)  // to be definition
...
// 7-Segment Control
#define BOARD_DIGITAL_A_GPIO  99
#define BOARD_DIGITAL_B_GPIO  101
#define BOARD_DIGITAL_C_GPIO  98
#define BOARD_DIGITAL_D_GPIO  96
#define BOARD_DIGITAL_E_GPIO  97
#define BOARD_DIGITAL_F_GPIO  103
#define BOARD_DIGITAL_G_GPIO  100
#define BOARD_DIGITAL_DP_GPIO 102

#define BOARD_DIGITAL_DIGI01_GPIO  95
#define BOARD_DIGITAL_DIGI02_GPIO  94
#define BOARD_DIGITAL_DIGI03_GPIO  91
#define BOARD_DIGITAL_DIGI04_GPIO  90

#define BOARD_DIGITAL_L1AND2_GPIO  92
// 7-Segment Control End
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_GPIO7                999
#define HDMITX_HPD_PM_GPIO              HDMITX_HPD_GPIO7
