...
#if((MEMORY_MAP == MMAP_128MB) && (AUDIO_LIB_TYPE == Audio_Normal))
    #include "MMAP_DDI_Keltic_128.h"
#elif((MEMORY_MAP == MMAP_64MB) && (AUDIO_LIB_TYPE == Audio_Normal))
//    #include "MMAP_DDI_Keltic_64.h"
//    #include "MMAP_DDI_Keltic_64GFXDemo.h"
#include "MMAP_DDI_Keltic_64_MMphotoOnly.h"
#elif((MEMORY_MAP == MMAP_64MB) && (AUDIO_LIB_TYPE == Audio_Lite))
    #include "MMAP_DDI_Keltic_64_Audio_Lite.h"
#elif((MEMORY_MAP == MMAP_32MB) && (AUDIO_LIB_TYPE == Audio_Normal))
    #include "MMAP_DDI_Keltic_32.h"
#elif((MEMORY_MAP == MMAP_32MB) && (AUDIO_LIB_TYPE == Audio_Lite))
    #include "MMAP_DDI_Keltic_32_Audio_Lite.h"
#elif(MEMORY_MAP == MMAP_64MB_MI)
    #include "MsMemory64_MI.h"
#else
