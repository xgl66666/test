...
#define VIDEO_DEBUG 1//kk test default:0
#if VIDEO_DEBUG
...
#define MVD_BITSTREAM_LEN_EX      (VDEC_BIT_STREAM_LEN)
...
INTERFACE BOOLEAN msAPI_VID_Init(BOOLEAN bEnableDropErrFrame);
