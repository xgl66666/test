...
#define PREFETCH_NTFS_FREE_CLUSTER_LIST 1

#if PREFETCH_NTFS_FREE_CLUSTER_LIST
#define MAX_NTFS_FREE_CLUSTER_RUNS  256
typedef struct _free_cluster_run {
...
#if PREFETCH_NTFS_FREE_CLUSTER_LIST
       free_cluster_run free_cluster_runlist[MAX_NTFS_FREE_CLUSTER_RUNS];
       u32 free_run_cnt;
#endif
...
extern int ntfs_volume_release(ntfs_volume *v);
