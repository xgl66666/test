...
#define diag_write_string(arg)
#else
#ifdef DISABLE_DEBUG_MESSAGE
#define diag_write_string(...) ecos_fake_printf()
#else
externC void diag_write_string(const char *psz); /* Write zero terminated string */
#endif //DISABLE_DEBUG_MESSAGE
#endif //CYGPKG_INFRA_SECURITY
...
#ifdef DISABLE_DEBUG_MESSAGE
externC int ecos_fake_printf(void);

#define diag_printf(...) ecos_fake_printf()
#define diag_write_char(...) ecos_fake_printf()
#define diag_write_dec(...) ecos_fake_printf()
#define diag_write_hex(...) ecos_fake_printf()
#endif
