...
#define CYGNUM_MEMALLOC_FALLBACK_MALLOC_POOL_SIZE 32768
#define CYGNUM_MEMALLOC_FALLBACK_MALLOC_POOL_SIZE_32768
#define CYGPKG_MEMALLOC_MALLOC_DEBUG 1
#define CYGDBG_MEMALLOC_MALLOC_DEBUG_GUARDS 1
