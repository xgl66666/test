...
DRV_DEMOD_TABLE_TYPE GET_DEMOD_ENTRY_NODE(DEMOD_MSKAPPA_DVBT) DDI_DRV_TABLE_ENTRY(demodtab);
...
MS_BOOL MDrv_Kappa_DVBT_Demod_Init(MS_U8 u8DemodIndex,DEMOD_MS_INIT_PARAM* pParam)
{
...
MS_BOOL MDrv_Kappa_DVBT_Demod_Open(MS_U8 u8DemodIndex)
{
...
MS_BOOL MDrv_Kappa_DVBT_Demod_Close(MS_U8 u8DemodIndex)
{
    MS_BOOL ret;
...
MS_BOOL MDrv_Kappa_DVBT_Demod_PowerOnOff(MS_U8 u8DemodIndex, MS_BOOL bPowerOn)
{
    if (HB_ObtainMutex(_s32MutexId, COFDMDMD_MUTEX_TIMEOUT) == FALSE)
    {
        DMD_ERR(("%s: Obtain mutex failed.\n", __FUNCTION__));
...
MS_BOOL MDrv_Kappa_DVBT_Demod_GetLock(MS_U8 u8DemodIndex, EN_LOCK_STATUS *peLockStatus)
{
...
MS_BOOL MDrv_Kappa_DVBT_Demod_GetSNR(MS_U8 u8DemodIndex, float *pfSNR)
{
    MS_BOOL ret;
...
MS_BOOL MDrv_Kappa_DVBT_Demod_GetBER(MS_U8 u8DemodIndex, float *pfBER)
{
    MS_BOOL ret;
...
MS_BOOL MDrv_Kappa_DVBT_Demod_GetPWR(MS_U8 u8DemodIndex, MS_S32 *ps32Signal)
{
    MS_BOOL ret;
...
MS_BOOL MDrv_Kappa_DVBT_Demod_GetSignalQuality(MS_U8 u8DemodIndex,MS_U16 *pu16quality)
{
    MS_BOOL ret;
    if (HB_ObtainMutex(_s32MutexId, COFDMDMD_MUTEX_TIMEOUT) == FALSE)
    {
...
MS_BOOL MDrv_Kappa_DVBT_Demod_Config(MS_U8 u8DemodIndex, MS_U8 *pRegParam)
{
    if (HB_ObtainMutex(_s32MutexId, COFDMDMD_MUTEX_TIMEOUT) == FALSE)
    {
        DMD_ERR(("%s: Obtain mutex failed.\n", __FUNCTION__));
...
MS_BOOL MDrv_Kappa_DVBT_Demod_GetParam(MS_U8 u8DemodIndex, DEMOD_MS_FE_CARRIER_PARAM* pParam)
{
    if (HB_ObtainMutex(_s32MutexId, COFDMDMD_MUTEX_TIMEOUT) == FALSE)
    {
        DMD_ERR(("%s: Obtain mutex failed.\n", __FUNCTION__));
...
MS_BOOL MDrv_Kappa_DVBT_Demod_Restart(MS_U8 u8DemodIndex, DEMOD_MS_FE_CARRIER_PARAM* pParam,MS_U32 u32BroadCastType)
{
...
MS_BOOL MDrv_Kappa_DVBT_Demod_SetMode(MS_U8 u8DemodIndex, Demod_Mode* pMode)
{
#if 0
    DMD_Mode dmdMod;
...
MS_BOOL DEMOD_MSKAPPA_DVBT_Extension_Function(MS_U8 u8DemodIndex, DEMOD_EXT_FUNCTION_TYPE fuction_type, void *data)
{
    switch(fuction_type)
    { 
        default:
...
MS_BOOL MDrv_Kappa_DVBT_Demod_I2C_ByPass(MS_U8 u8DemodIndex,MS_BOOL bOn)
{
  if(GET_DEMOD_ENTRY_NODE(DEMOD_MSKAPPA_DVBT).I2CByPassPreSetting != NULL)
  {
      return GET_DEMOD_ENTRY_NODE(DEMOD_MSKAPPA_DVBT).I2CByPassPreSetting(u8DemodIndex,bOn);
  }
  else
...
DRV_DEMOD_TABLE_TYPE GET_DEMOD_ENTRY_NODE(DEMOD_MSKAPPA_DVBT) DDI_DRV_TABLE_ENTRY(demodtab) = 
{  
     .name                         = "DEMOD_MSKAPPA_DVBT",
     .data                         = DEMOD_MSKAPPA_DVBT,        
     .init                         = MDrv_Kappa_DVBT_Demod_Init,
     .GetLock                      = MDrv_Kappa_DVBT_Demod_GetLock,
     .GetSNR                       = MDrv_Kappa_DVBT_Demod_GetSNR,
     .GetBER                       = MDrv_Kappa_DVBT_Demod_GetBER,
     .GetPWR                       = MDrv_Kappa_DVBT_Demod_GetPWR,
     .GetQuality                   = MDrv_Kappa_DVBT_Demod_GetSignalQuality,
     .GetParam                     = MDrv_Kappa_DVBT_Demod_GetParam,
     .Restart                      = MDrv_Kappa_DVBT_Demod_Restart,
     .I2CByPass                    = MDrv_Kappa_DVBT_Demod_I2C_ByPass,
     .I2CByPassPreSetting          = NULL,
     .Extension_Function           = DEMOD_MSKAPPA_DVBT_Extension_Function,
