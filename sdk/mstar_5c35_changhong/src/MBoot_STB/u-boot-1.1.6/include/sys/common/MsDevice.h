...
typedef unsigned long ms_device_t;
...
struct devio
{
    int     (*open) (ms_device_t dev, int mode);
    int     (*close)(ms_device_t dev);
//    int     (*read) (device_t dev, char *buf, size_t len, int off);
    int     (*read) (ms_device_t dev, char *buf, MS_U32 len, int off);
//    int     (*write)(device_t dev, const char *buf, size_t len, int off);
    int     (*write)(ms_device_t dev, const char *buf, MS_U32 len, int off);
    int     (*poll) (ms_device_t dev, int types);
    int     (*ioctl)(ms_device_t dev, int request, unsigned long arg);
