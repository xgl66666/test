...
static stSubtitleWindow _pWindowData[ST_WIN_MAX];
static MS_BOOL _bRenderCreated = FALSE;

static stSubtitleWindow *_GetWindowData(U8 u8WinID)
{
    MS_U32 i=0;
...
static stSubtitleWindow *_FindShowWindow(void)
{
    MS_U32 i=0;
...
static stSubtitleWindow *_CreateWindowData(U8 u8WinID,  SBT_Rect *pRect, MS_BOOL bDisplayAble)
{
    MS_U8 u8FbId=0xFF;
    MS_U32 i=0;
...
static void _FreeWindowData(MS_U8 u8WinID)
{
...
static void _FillRect(stSubtitleWindow *pWindowData, SBT_Rect *pRect,MS_U32 Color)
{
...
static void _ResetDisplayTransColorKey(stSubtitleWindow *pWindowData)
{
...
static U16 _UTF82UNICODE(MS_U8 *pu8Char,MS_U8 *pu8Offset)
{
    MS_U16 u16Char = 0;
...
static void _DrawText(MS_U8 u32LineNum,
                                    MS_U8 TotalLine,
                                    MS_U16 *pu16Text,
                                    MS_U16 u16Len,
                                    MS_U8 *pu8Buffer,
...
void MM_SubRender_Show(void *arg)
{
    ...
    //check video status
    if ((E_VDEC_EX_OK != MApi_VDEC_EX_GetDispInfo(stVDECStreamId,&Dispinfo)) ||
