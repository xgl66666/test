...
#ifndef __APPDEMO_DSCMB_H__
#define __APPDEMO_DSCMB_H__
...
MS_BOOL appDemo_DSCMB_CW(MS_U32 *u32DeviceId, MS_U8 *u8HexOddKey, MS_U8 *u8HexEvenKey);
...
MS_BOOL appDemo_DSCMB_KeyLadder(MS_U32 *u32DeviceId, MS_U8 *u8Source, MS_U8 *u8HexHostKey, MS_U8 *u8HexEncryptedOddCW, MS_U8 *u8HexEncryptedEvenCW);
#endif // __APPDEMO_DSCMB_H__
