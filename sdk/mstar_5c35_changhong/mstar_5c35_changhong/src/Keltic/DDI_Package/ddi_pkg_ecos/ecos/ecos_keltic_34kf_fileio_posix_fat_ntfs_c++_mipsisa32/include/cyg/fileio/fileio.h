...
typedef int     cyg_fsop_setinfo  ( cyg_mtab_entry *mte, cyg_dir dir, const char *name,
                                    int key, void *buf, int len );
typedef int     cyg_fsop_format  ( cyg_fstab_entry *fste, cyg_mtab_entry *mte, const char *lablename); // wyc.090623
#ifdef CYGPKG_IO_FILEIO_UNICODE_SUPPORT
typedef int     cyg_fsop_wopen    ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *wname,
                                    int mode,  cyg_file *fte );
typedef int     cyg_fsop_wunlink  ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name );
typedef int     cyg_fsop_wmkdir   ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name );
typedef int     cyg_fsop_wrmdir   ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name );
typedef int     cyg_fsop_wrename  ( cyg_mtab_entry *mte, cyg_dir dir1, const utf16 *name1,
                                    cyg_dir dir2, const utf16 *name2 );
typedef int     cyg_fsop_wlink    ( cyg_mtab_entry *mte, cyg_dir dir1, const utf16 *name1,
                                    cyg_dir dir2, const utf16 *name2, int type );
typedef int     cyg_fsop_wopendir ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                    cyg_file *fte );
typedef int     cyg_fsop_wchdir   ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                    cyg_dir *dir_out );
typedef int     cyg_fsop_wstat    ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                    struct stat *buf);
typedef int     cyg_fsop_wgetinfo ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                    int key, void *buf, int len );
typedef int     cyg_fsop_wsetinfo ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                    int key, void *buf, int len );
#endif
...
struct cyg_fstab_entry
{
    ...
    cyg_fsop_format     *format; // wyc.090623
#ifdef CYGPKG_IO_FILEIO_UNICODE_SUPPORT
    cyg_fsop_wopen      *wopen;
    cyg_fsop_wunlink    *wunlink;
    cyg_fsop_wmkdir     *wmkdir;
    cyg_fsop_wrmdir     *wrmdir;
    cyg_fsop_wrename    *wrename;
    cyg_fsop_wlink      *wlink;
    cyg_fsop_wopendir   *wopendir;
    cyg_fsop_wchdir     *wchdir;
    cyg_fsop_wstat      *wstat;
    cyg_fsop_wgetinfo   *wgetinfo;
    cyg_fsop_wsetinfo   *wsetinfo;
#endif
} CYG_HAL_TABLE_TYPE;
...
#define FS_INFO_BLOCK_USAGE     6       //kevinhuang05132007, add


#define FS_INFO_LOCK_STATE      7       //tommysun05132009, add

#define FS_INFO_VOLUME_LABEL 8 //samson.huang201305,add

#define FS_INFO_SECURE_ERASE    9
struct cyg_fs_lock_state
{
    cyg_uint32 fs_applicant_cnt;
    cyg_uint32 fs_block_rd_applicant_cnt;
    cyg_uint32 fs_block_wr_applicant_cnt;
};
...
{
	cyg_uint32 total_blocks;
    cyg_uint32 free_blocks;
...
#ifdef CYGPKG_IO_FILEIO_UNICODE_SUPPORT
__externC int cyg_fsop_no_wopen    ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *wname,
                                     int mode,  cyg_file *fte );
__externC int cyg_fsop_no_wunlink  ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name );
__externC int cyg_fsop_no_wmkdir   ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name );
__externC int cyg_fsop_no_wrmdir   ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name );
__externC int cyg_fsop_no_wrename  ( cyg_mtab_entry *mte, cyg_dir dir1, const utf16 *name1,
                                     cyg_dir dir2, const utf16 *name2 );
__externC int cyg_fsop_no_wlink    ( cyg_mtab_entry *mte, cyg_dir dir1, const utf16 *name1,
                                     cyg_dir dir2, const utf16 *name2, int type );
__externC int cyg_fsop_no_wopendir ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                     cyg_file *fte );
__externC int cyg_fsop_no_wchdir   ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                     cyg_dir *dir_out );
__externC int cyg_fsop_no_wstat    ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                     struct stat *buf);
__externC int cyg_fsop_no_wgetinfo ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                     int key, void *buf, int len );
__externC int cyg_fsop_no_wsetinfo ( cyg_mtab_entry *mte, cyg_dir dir, const utf16 *name,
                                     int key, void *buf, int len );
...
#endif // CYGPKG_IO_FILEIO_UNICODE_SUPPORT
//=============================================================================
// Mount table entry

struct cyg_mtab_entry
{
    char                *name;          // name of mount point
#ifdef CYGPKG_IO_FILEIO_UNICODE_SUPPORT
    utf16               *wname;         // name of mount point (in Unicode)
#endif
    char                *fsname;        // name of implementing filesystem
    ...
    struct cyg_fs_lock_state lockState;
} CYG_HAL_TABLE_TYPE;
...
#define MTAB_ENTRY( _l, _name, _wname, _fsname, _devname, _data )\
...
typedef int cyg_fileop_ftruncate (struct CYG_FILE_TAG *fp, off_t length);
...
struct CYG_FILEOPS_TAG
{
    ...
    cyg_fileop_ftruncate *fo_ftruncate;	
};
...
struct CYG_FILE_TAG
{
    ...
    void					*f_privatedata;	/* ~!~ private data */
};
...
#define	CYG_FILE_TYPE_DIR       4	/* dir */
...
__externC cyg_drv_mutex_t *cyg_fs_get_lock( cyg_fstab_entry *fste, cyg_mtab_entry *mte );
...
// wyc.090623
__externC int format( const char *devname,
...
#ifdef CYGPKG_IO_FILEIO_UNICODE_SUPPORT
__externC int cyg_fs_wgetinfo( const utf16 *path, int key, void *buf, int len );
__externC int cyg_fs_wsetinfo( const utf16 *path, int key, void *buf, int len );
#endif
...
//jerry.wang 20120210 add for fs time update timeofday:s
__externC void   cyg_settimeoffset(cyg_uint64 timeofday);

__externC cyg_uint64   cyg_gettimeoffset(void);
