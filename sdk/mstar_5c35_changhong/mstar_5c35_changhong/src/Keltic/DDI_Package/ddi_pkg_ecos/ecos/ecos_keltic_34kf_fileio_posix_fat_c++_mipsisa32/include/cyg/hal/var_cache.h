...
//-----------------------------------------------------------------------------
// Cache dimensions
#if defined(CYGHWR_HAL_MIPS_MIPS32_CORE34K_CACHE_32K32K)

// Data cache
#define HAL_DCACHE_SIZE                 32768   // Size of data cache in bytes
#define HAL_DCACHE_LINE_SIZE            128     // Size of a data cache line
#define HAL_DCACHE_WAYS                 4       // Associativity of the cache

// Instruction cache
#define HAL_ICACHE_SIZE                 32768   // Size of cache in bytes
#define HAL_ICACHE_LINE_SIZE            128     // Size of a cache line
...
#elif defined(CYGHWR_HAL_MIPS_MIPS32_CACHE_16K16K)
...
#elif defined(CYGHWR_HAL_MIPS_MIPS32_CACHE_8K16K)
...
#elif defined(CYGHWR_HAL_MIPS_MIPS32_CACHE_8K8K)
...
#elif defined(CYGHWR_HAL_MIPS_MIPS32_CACHE_4K4K) // jerrytsao add for Uranus
...
//#define HAL_DCACHE_SUPPORTS_INDEX_INVALIDATE
//#define HAL_ICACHE_SUPPORTS_INDEX_INVALIDATE
#elif defined(CYGHWR_HAL_MIPS_MIPS32_CORE34K_CACHE_8K16K) //  add for K5L
...
#elif defined(CYGHWR_HAL_MIPS_MIPS32_CORE34K_CACHE_16K16K) // sidney add for U4
...
//#define HAL_DCACHE_SUPPORTS_INDEX_INVALIDATE
//#define HAL_ICACHE_SUPPORTS_INDEX_INVALIDATE
#elif defined(CYGHWR_HAL_MIPS_MIPS32_CORE74K_CACHE_32K32K) // sidney add for K2
...
//kevinhuang01192007, comment, let hal_cache handles
/*
//-----------------------------------------------------------------------------
