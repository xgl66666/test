...
// -------------------------------------------------------------------------
// Find the size of an allocated chunk
// returns true on success
template <class T>
inline cyg_int32
Cyg_Mempool_Joined<T>::get_allocation_size( cyg_uint8 *ptr )
{
    T *pool;
    cyg_int32 ret;

    CYG_REPORT_FUNCTYPE("success=");
    CYG_REPORT_FUNCARG1( "ptr=%08x", ptr );
    CYG_CHECK_DATA_PTRC( ptr );
    ...
    CYG_REPORT_RETVAL( ret );
    return ret;    
} // Cyg_Mempool_Joined<T>::get_allocation_size()
