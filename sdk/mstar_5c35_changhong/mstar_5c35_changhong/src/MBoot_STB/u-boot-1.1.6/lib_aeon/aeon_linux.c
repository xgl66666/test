...
#define UNCACHED_SDRAM(a) (((unsigned long)(a)) | 0x80000000)
		     ...
		     ulong addr, ulong * len_ptr, int verify)
{
    ...
    printf("linux_argc=%d, linux_argv_addr=0x%X\n", linux_argc, &linux_argv[0]);

}

void linux_params_init (ulong start, char *line)
{
    ...
    *((int *)(UNCACHED_SDRAM (gd->bd->bi_params_count))) = linux_argc;
}
