...
/// @param  u16HFreqx1K      \b IN: Horizontal frequency x 1000
/// @param  u16VTotal     \b IN: Vertical Total, usually the scan lines counts of a frame
/// @return MS_U32: V Frequency x 1000
//-------------------------------------------------------------------------------------------------
MS_U32 MApi_XC_CalculateVFreqx1K(MS_U32 u16HFreqx1K, MS_U16 u16VTotal);
...
//-------------------------------------------------------------------------------------------------
void MApi_XC_SetByPassOSDVsyncPos(MS_U16 u16VsyncStart, MS_U16 u16VsyncEnd);
