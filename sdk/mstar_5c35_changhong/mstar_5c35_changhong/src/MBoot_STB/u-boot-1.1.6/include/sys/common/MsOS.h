...
#define MBASE 0xA5000000  //for test
#define RIU_TMPBASE 0xBF200000  //for test

#define DBG0()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x68*4)) = 0x0000
#define DBG1()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x69*4)) = 0x0001
#define DBG2()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x6A*4)) = 0x0002
#define DBG3()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x6B*4)) = 0x0003
#define DBG4()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x6C*4)) = 0x0004
#define DBG5()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x6D*4)) = 0x0005
#define DBG6()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x6E*4)) = 0x0006
#define DBG7()   WMEM(RIU_TMPBASE+(0x3300*2)+(0x6F*4)) = 0x0007
...
//-------------------------------------------------------------------------------------------------
#if 1//defined (MSOS_TYPE_ECOS) || defined (MSOS_TYPE_LINUX) || defined (MSOS_TYPE_NOS)
