...
#define     DEMOD_DYNAMIC_SLAVE_ID_1          0x01
#define     DEMOD_DYNAMIC_SLAVE_ID_2          0x02
#define     DEMOD_DYNAMIC_SLAVE_ID_3          0x03
#define     DEMOD_DYNAMIC_SLAVE_ID_4          0xD2
...
{
    MS_BOOL (*WriteBytes)(U8,U8*,U16,U8*);
    MS_BOOL (*ReadBytes)(U8,U8*,U16,U8*);
...
/*
EXTSEL MS_BOOL INTERN_ISDBT_Power_On_Initialization(void);
EXTSEL MS_BOOL INTERN_ISDBT_Lock(COFDM_LOCK_STATUS eStatus);
EXTSEL MS_BOOL INTERN_ISDBT_Config(RF_CHANNEL_BANDWIDTH BW, MS_BOOL bSerialTS, MS_BOOL bPalBG, MS_BOOL bLPSel);
EXTSEL MS_BOOL INTERN_ISDBT_Active(MS_BOOL bEnable);
EXTSEL MS_BOOL INTERN_ISDBT_Serial_Control(MS_BOOL bEnable);
...
EXTSEL MS_BOOL INTERN_ISDBT_WriteReg(MS_U16 RegAddr, MS_U8 u8Data);
EXTSEL MS_BOOL INTERN_ISDBT_ReadReg(MS_U16 RegAddr, MS_U8* pu8Data);
EXTSEL MS_BOOL INTERN_ISDBT_Exit ( void );
EXTSEL void INTERN_ISDBT_Power_ON_OFF(MS_U8 bPowerOn);
EXTSEL MS_BOOL INTERN_ISDBT_Power_Save(void);
EXTSEL void INTERN_ISDBT_PAD_TS1_Enable(MS_BOOL flag);
*/
