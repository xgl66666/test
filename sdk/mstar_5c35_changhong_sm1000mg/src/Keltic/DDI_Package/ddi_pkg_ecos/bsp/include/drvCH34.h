...
DLL_PUBLIC CH34_Drv_Result MDrv_Ch34_Init(void);
DLL_PUBLIC CH34_Drv_Result MDrv_Ch34_TurnOnOff(MS_BOOL bOn);
//CH34_Drv_Result MDrv_Ch34_ResetReg(void);
DLL_PUBLIC CH34_Drv_Result MDrv_Ch34_SetMode(E_CH34_CHANNEL channel, E_CH34_VIDEO_SYS videosys, E_CH34_AUDIO_SYS audiosys);
DLL_PUBLIC CH34_Drv_Result MDrv_Ch34_WriteCH34Table(MS_U8* pTable);
