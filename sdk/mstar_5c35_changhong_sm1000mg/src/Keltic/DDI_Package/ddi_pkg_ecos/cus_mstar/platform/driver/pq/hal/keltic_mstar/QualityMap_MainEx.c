...
#include "Keltic_Main_Ex.c"               // table config parameter
#include "Keltic_Main_Ex_1920.c"          // table config parameter
#include "Keltic_Main_Ex_1366.c"          // table config parameter
#endif
