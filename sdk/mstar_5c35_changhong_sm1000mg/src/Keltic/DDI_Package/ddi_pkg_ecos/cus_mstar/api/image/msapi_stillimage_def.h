...
#ifndef _Dapi_STILLIMAGE_DEF_H_
#define _Dapi_STILLIMAGE_DEF_H_
...
typedef struct
{
    ...
    MS_U32 u32SrcBuffLen;
    MS_U32 delay_time;
    MS_U8 u8BackgroundIndex;
    MS_U8 u8BackgroundColorRed;
    MS_U8 u8BackgroundColorGreen;
    MS_U8 u8BackgroundColorBlue;

    EN_STILLIMAGE_RET (*pfStillImage_ReadHeader)(MS_U32);
    EN_STILLIMAGE_RET (*pfStillImage_Task)(MS_U32);
    EN_STILLIMAGE_RET (*pfStillImage_Stop)(MS_U32);
