...
#define NON_CACHED_POOL_BUF_LEN                                0x0000D20000
#define NON_CACHED_POOL_BUF_MEMORY_TYPE                        (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* HW_BUF0_START_TAG   */
//co_buffer L0
#define HW_BUF0_START_TAG_AVAILABLE                            0x00022A0000
#define HW_BUF0_START_TAG_ADR                                  0x00022A0000  //Alignment 0
...
/* MIU0_COBUF_START   */
//co_buffer L0
#define MIU0_COBUF_START_AVAILABLE                             0x00022A0000
#define MIU0_COBUF_START_ADR                                   0x00022A0000  //Alignment 0
...
/* VDPLAYER_TAG   */
//co_buffer L1
#define VDPLAYER_TAG_AVAILABLE                                 0x00022A0000
#define VDPLAYER_TAG_ADR                                       0x00022A0000  //Alignment 0
...
/* VDPLAYER_DATA   */
//co_buffer L1
#define VDPLAYER_DATA_AVAILABLE                                0x00022A0000
#define VDPLAYER_DATA_ADR                                      0x00022A0000  //Alignment 0
...
/* VDPLAYER_SUB_BS   */
//co_buffer L1
#define VDPLAYER_SUB_BS_AVAILABLE                              0x0002620000
#define VDPLAYER_SUB_BS_ADR                                    0x0002620000  //Alignment 0
...
/* VDPLAYER_BS   */
//co_buffer L1
#define VDPLAYER_BS_AVAILABLE                                  0x0002920000
#define VDPLAYER_BS_ADR                                        0x0002920000  //Alignment 0x01000
...
/* VDPLAYER_BS_EXT   */
//co_buffer L1
#define VDPLAYER_BS_EXT_AVAILABLE                              0x0002B20000
#define VDPLAYER_BS_EXT_ADR                                    0x0002B20000  //Alignment 0x01000
...
/* VDPLAYER_SUB   */
//co_buffer L1
#define VDPLAYER_SUB_AVAILABLE                                 0x0002DA0000
#define VDPLAYER_SUB_ADR                                       0x0002DA0000  //Alignment 0x01000
...
/* VDPLAYER_DMX_SEC   */
//co_buffer L1
#define VDPLAYER_DMX_SEC_AVAILABLE                             0x0002DE0000
#define VDPLAYER_DMX_SEC_ADR                                   0x0002DE0000  //Alignment 0
...
//co_buffer L1
#define MIU0_COBUF_L1_END_TAG_AVAILABLE                        0x0002E20000
#define MIU0_COBUF_L1_END_TAG_ADR                              0x0002E20000  //Alignment 0
...
//co_buffer L2
#define PHOTO_SHARE_MEM_RESERVED_AVAILABLE                     0x00022A0000
#define PHOTO_SHARE_MEM_RESERVED_ADR                           0x00022A0000  //Alignment 0
...
/* PHOTO_SHARE_MEM   */
//co_buffer L2
#define PHOTO_SHARE_MEM_AVAILABLE                              0x000246A000
#define PHOTO_SHARE_MEM_ADR                                    0x000246A000  //Alignment 0
...
/* JPD_OUT   */
//co_buffer L2
#define JPD_OUT_AVAILABLE                                      0x000246B000
#define JPD_OUT_ADR                                            0x000246B000  //Alignment 0x00008
...
/* JPD_INTER_BUF   */
//co_buffer L2
#define JPD_INTER_BUF_AVAILABLE                                0x000260B000
#define JPD_INTER_BUF_ADR                                      0x000260B000  //Alignment 0x00200
...
/* JPD_READ_BUF   */
//co_buffer L2
#define JPD_READ_BUF_AVAILABLE                                 0x0002C3B000
#define JPD_READ_BUF_ADR                                       0x0002C3B000  //Alignment 0x00010
...
//co_buffer L2
#define MIU0_COBUF_L2_END_TAG_AVAILABLE                        0x0002C8B000
#define MIU0_COBUF_L2_END_TAG_ADR                              0x0002C8B000  //Alignment 0
...
/* MIU0_COBUF_END_TAG   */
//co_buffer L0
#define MIU0_COBUF_END_TAG_AVAILABLE                           0x0002EA0000
#define MIU0_COBUF_END_TAG_ADR                                 0x0002EA0000  //Alignment 0
...
/* SDRAM_ADR_BMP   */
//co_buffer L0
#define SDRAM_ADR_BMP_AVAILABLE                                0x0002EA0000
#define SDRAM_ADR_BMP_ADR                                      0x0002EA0000  //Alignment 0
...
/* SDRAM_ADR_FONT   */
//co_buffer L0
#define SDRAM_ADR_FONT_AVAILABLE                               0x000304DB00
#define SDRAM_ADR_FONT_ADR                                     0x000304DB00  //Alignment 0
...
/* SC0_MENULOAD_BUF   */
//co_buffer L0
#define SC0_MENULOAD_BUF_AVAILABLE                             0x0003052B00
#define SC0_MENULOAD_BUF_ADR                                   0x0003052B00  //Alignment 0x00010
...
/* SC1_MENULOAD_BUF   */
//co_buffer L0
#define SC1_MENULOAD_BUF_AVAILABLE                             0x0003056B00
#define SC1_MENULOAD_BUF_ADR                                   0x0003056B00  //Alignment 0
...
/* TSP_FW_BUF   */
//co_buffer L0
#define TSP_FW_BUF_AVAILABLE                                   0x0003056B00
#define TSP_FW_BUF_ADR                                         0x0003056B00  //Alignment 0x00100
...
/* TSP_VQ_BUF   */
//co_buffer L0
#define TSP_VQ_BUF_AVAILABLE                                   0x000305AB00
#define TSP_VQ_BUF_ADR                                         0x000305AB00  //Alignment 0
...
/* TSP_FQ_BUF   */
//co_buffer L0
#define TSP_FQ_BUF_AVAILABLE                                   0x000305BB00
#define TSP_FQ_BUF_ADR                                         0x000305BB00  //Alignment 0x000C0
...
/* GOP_REG_DMA_BASE   */
//co_buffer L0
#define GOP_REG_DMA_BASE_AVAILABLE                             0x000325BA80
#define GOP_REG_DMA_BASE_ADR                                   0x000325C000  //Alignment 0x01000
#define GOP_REG_DMA_BASE_GAP_CHK                               0x0000000580
...
//co_buffer L0
#define GOP_GWIN_RB_AVAILABLE                                  0x000325D000
#define GOP_GWIN_RB_ADR                                        0x000325D000  //Alignment 0x00008
...
//co_buffer L0
#define VE_FRAME_BUF_AVAILABLE                                 0x00033FD000
#define VE_FRAME_BUF_ADR                                       0x00033FD000  //Alignment 0
...
//co_buffer L0
#define PM51_START_TAG_AVAILABLE                               0x00033FD400
#define PM51_START_TAG_ADR                                     0x0003400000  //Alignment 0x10000
...
/* MIU0_COBUF2_START   */
//co_buffer L0
#define MIU0_COBUF2_START_AVAILABLE                            0x0003400000
#define MIU0_COBUF2_START_ADR                                  0x0003400000  //Alignment 0
...
/* PM51_LITE   */
//co_buffer L1
#define PM51_LITE_AVAILABLE                                    0x0003400000
#define PM51_LITE_ADR                                          0x0003400000  //Alignment 0x01000
...
//co_buffer L1
#define MIU0_COBUF2_L1_END_TAG_AVAILABLE                       0x0003408000
#define MIU0_COBUF2_L1_END_TAG_ADR                             0x0003408000  //Alignment 0
...
/* PM51_STR   */
//co_buffer L2
#define PM51_STR_AVAILABLE                                     0x0003400000
#define PM51_STR_ADR                                           0x0003400000  //Alignment 0x01000
...
//co_buffer L2
#define MIU0_COBUF2_L2_END_TAG_AVAILABLE                       0x0003404000
#define MIU0_COBUF2_L2_END_TAG_ADR                             0x0003404000  //Alignment 0
...
/* MIU0_COBUF2_END_TAG   */
//co_buffer L0
#define MIU0_COBUF2_END_TAG_AVAILABLE                          0x0003408000
#define MIU0_COBUF2_END_TAG_ADR                                0x0003408000  //Alignment 0
...
/* PM51_MEM   */
//co_buffer L0
#define PM51_MEM_AVAILABLE                                     0x0003408000
#define PM51_MEM_ADR                                           0x0003408000  //Alignment 0x01000
...
//co_buffer L0
#define PM51_RESERVED_AVAILABLE                                0x0003409000
#define PM51_RESERVED_ADR                                      0x0003409000  //Alignment 0
#define PM51_RESERVED_GAP_CHK                                  0x0000000000
#define PM51_RESERVED_LEN                                      0x000000F000
#define PM51_RESERVED_MEMORY_TYPE                              (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* SECTION_BUF Reserved for Kernel and Pool */
//co_buffer L0
#define SECTION_BUF_AVAILABLE                                  0x0003418000
#define SECTION_BUF_ADR                                        0x0003418000  //Alignment 0x00010
...
//co_buffer L0
#define VDEC_AEON_AVAILABLE                                    0x0003518000
#define VDEC_AEON_ADR                                          0x0003518000  //Alignment 0
...
//co_buffer L0
#define VDEC_FRAME_BUF_AVAILABLE                               0x00035A8000
#define VDEC_FRAME_BUF_ADR                                     0x00035A8000  //Alignment 0
...
/* VDEC_BIT_STREAM   */
//co_buffer L0
#define VDEC_BIT_STREAM_AVAILABLE                              0x0003B18000
#define VDEC_BIT_STREAM_ADR                                    0x0003B18000  //Alignment 0
...
//co_buffer L0
#define MAD_DEC_BUF_AVAILABLE                                  0x0003D18000
#define MAD_DEC_BUF_ADR                                        0x0003D18000  //Alignment 0x00800
#define MAD_DEC_BUF_GAP_CHK                                    0x0000000000
#define MAD_DEC_BUF_LEN                                        0x00000E8000
#define MAD_DEC_BUF_MEMORY_TYPE                                (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* MAD_SE_BUF Reserved for Kernel and Pool */
//co_buffer L0
#define MAD_SE_BUF_AVAILABLE                                   0x0003E00000
#define MAD_SE_BUF_ADR                                         0x0003E00000  //Alignment 0
...
//co_buffer L0
#define SC0_MAIN_FB_AVAILABLE                                  0x0003E00000
#define SC0_MAIN_FB_ADR                                        0x0003E00000  //Alignment 0
