...
#define FRONTEND_DEMOD_TYPE                      DEMOD_MSKELTIC_ATSC //DEMOD_MSKELTIC_DVBC//DEMOD_NULL
#endif
#endif
...
#elif((MS_DVB_TYPE_SEL == DVBS))
#define FRONTEND_TUNER_TYPE                      TUNER_AV2028 //TUNER_SHARP_BS2S7HZ6306
#elif((MS_DVB_TYPE_SEL == INTERNAL_DVBT))
...
#define TunerOffPCMCIA()                mdrv_gpio_set_low(PAD_PM_PWM1)
#define TunerOnPCMCIA()                 mdrv_gpio_set_high(PAD_PM_PWM1)

// 7-Segment Control
#define BOARD_DIGITAL_A_GPIO  100
#define BOARD_DIGITAL_B_GPIO  101
#define BOARD_DIGITAL_C_GPIO  99
#define BOARD_DIGITAL_D_GPIO  92
#define BOARD_DIGITAL_E_GPIO  98
#define BOARD_DIGITAL_F_GPIO  102
#define BOARD_DIGITAL_G_GPIO  95
#define BOARD_DIGITAL_DP_GPIO 97

#define BOARD_DIGITAL_DIGI01_GPIO  103
#define BOARD_DIGITAL_DIGI02_GPIO  94
#define BOARD_DIGITAL_DIGI03_GPIO  90
#define BOARD_DIGITAL_DIGI04_GPIO  89

#define BOARD_DIGITAL_L1AND2_GPIO  91
