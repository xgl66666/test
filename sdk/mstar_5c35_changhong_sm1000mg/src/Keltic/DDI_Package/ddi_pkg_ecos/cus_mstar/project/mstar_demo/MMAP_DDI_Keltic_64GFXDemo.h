...
#define CACHED_POOL_BUF_LEN                                    0x0000280000
#define CACHED_POOL_BUF_MEMORY_TYPE                            (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* NON_CACHED_POOL_BUF   */
//co_buffer L0
#define NON_CACHED_POOL_BUF_AVAILABLE                          0x0001400000
#define NON_CACHED_POOL_BUF_ADR                                0x0001400000  //Alignment 0
...
/* HW_BUF0_START_TAG   */
//co_buffer L0
#define HW_BUF0_START_TAG_AVAILABLE                            0x00025D0000
#define HW_BUF0_START_TAG_ADR                                  0x00025D0000  //Alignment 0
...
/* MIU0_COBUF_START   */
//co_buffer L0
#define MIU0_COBUF_START_AVAILABLE                             0x00025D0000
#define MIU0_COBUF_START_ADR                                   0x00025D0000  //Alignment 0
...
/* VDPLAYER_TAG   */
//co_buffer L1
#define VDPLAYER_TAG_AVAILABLE                                 0x00025D0000
#define VDPLAYER_TAG_ADR                                       0x00025D0000  //Alignment 0
...
/* VDPLAYER_DATA   */
//co_buffer L1
#define VDPLAYER_DATA_AVAILABLE                                0x00025D0000
#define VDPLAYER_DATA_ADR                                      0x00025D0000  //Alignment 0
...
/* VDPLAYER_SUB_BS   */
//co_buffer L1
#define VDPLAYER_SUB_BS_AVAILABLE                              0x00025D0000
#define VDPLAYER_SUB_BS_ADR                                    0x00025D0000  //Alignment 0
...
/* VDPLAYER_BS   */
//co_buffer L1
#define VDPLAYER_BS_AVAILABLE                                  0x00025D0000
#define VDPLAYER_BS_ADR                                        0x00025D0000  //Alignment 0x01000
...
/* VDPLAYER_BS_EXT   */
//co_buffer L1
#define VDPLAYER_BS_EXT_AVAILABLE                              0x00025D0000
#define VDPLAYER_BS_EXT_ADR                                    0x00025D0000  //Alignment 0x01000
...
/* VDPLAYER_SUB   */
//co_buffer L1
#define VDPLAYER_SUB_AVAILABLE                                 0x00025D0000
#define VDPLAYER_SUB_ADR                                       0x00025D0000  //Alignment 0x01000
...
/* VDPLAYER_DMX_SEC   */
//co_buffer L1
#define VDPLAYER_DMX_SEC_AVAILABLE                             0x00025D0000
#define VDPLAYER_DMX_SEC_ADR                                   0x00025D0000  //Alignment 0
...
//co_buffer L1
#define MIU0_COBUF_L1_END_TAG_AVAILABLE                        0x00025D0000
#define MIU0_COBUF_L1_END_TAG_ADR                              0x00025D0000  //Alignment 0
...
//co_buffer L2
#define PHOTO_SHARE_MEM_RESERVED_AVAILABLE                     0x00025D0000
#define PHOTO_SHARE_MEM_RESERVED_ADR                           0x00025D0000  //Alignment 0
...
/* PHOTO_SHARE_MEM   */
//co_buffer L2
#define PHOTO_SHARE_MEM_AVAILABLE                              0x00025D0000
#define PHOTO_SHARE_MEM_ADR                                    0x00025D0000  //Alignment 0
...
/* JPD_OUT   */
//co_buffer L2
#define JPD_OUT_AVAILABLE                                      0x00025D1000
#define JPD_OUT_ADR                                            0x00025D1000  //Alignment 0x00008
...
/* JPD_INTER_BUF   */
//co_buffer L2
#define JPD_INTER_BUF_AVAILABLE                                0x0002771000
#define JPD_INTER_BUF_ADR                                      0x0002771000  //Alignment 0x00200
...
/* JPD_READ_BUF   */
//co_buffer L2
#define JPD_READ_BUF_AVAILABLE                                 0x0002B6D000
#define JPD_READ_BUF_ADR                                       0x0002B6D000  //Alignment 0x00010
...
//co_buffer L2
#define MIU0_COBUF_L2_END_TAG_AVAILABLE                        0x0002BBD000
#define MIU0_COBUF_L2_END_TAG_ADR                              0x0002BBD000  //Alignment 0
...
/* MIU0_COBUF_END_TAG   */
//co_buffer L0
#define MIU0_COBUF_END_TAG_AVAILABLE                           0x0002BBD000
#define MIU0_COBUF_END_TAG_ADR                                 0x0002BBD000  //Alignment 0
...
/* SDRAM_ADR_BMP   */
//co_buffer L0
#define SDRAM_ADR_BMP_AVAILABLE                                0x0002BBD000
#define SDRAM_ADR_BMP_ADR                                      0x0002BBD000  //Alignment 0
...
/* SDRAM_ADR_FONT   */
//co_buffer L0
#define SDRAM_ADR_FONT_AVAILABLE                               0x0002BBD000
#define SDRAM_ADR_FONT_ADR                                     0x0002BBD000  //Alignment 0
...
/* SC0_MENULOAD_BUF   */
//co_buffer L0
#define SC0_MENULOAD_BUF_AVAILABLE                             0x0002BBD000
#define SC0_MENULOAD_BUF_ADR                                   0x0002BBD000  //Alignment 0x00010
...
/* SC1_MENULOAD_BUF   */
//co_buffer L0
#define SC1_MENULOAD_BUF_AVAILABLE                             0x0002BC1000
#define SC1_MENULOAD_BUF_ADR                                   0x0002BC1000  //Alignment 0
...
/* TSP_FW_BUF   */
//co_buffer L0
#define TSP_FW_BUF_AVAILABLE                                   0x0002BC1000
#define TSP_FW_BUF_ADR                                         0x0002BC1000  //Alignment 0x00100
...
/* TSP_VQ_BUF   */
//co_buffer L0
#define TSP_VQ_BUF_AVAILABLE                                   0x0002BC5000
#define TSP_VQ_BUF_ADR                                         0x0002BC5000  //Alignment 0
...
/* TSP_FQ_BUF   */
//co_buffer L0
#define TSP_FQ_BUF_AVAILABLE                                   0x0002BC6000
#define TSP_FQ_BUF_ADR                                         0x0002BC6080  //Alignment 0x000C0
...
/* GOP_REG_DMA_BASE   */
//co_buffer L0
#define GOP_REG_DMA_BASE_AVAILABLE                             0x0002DC6000
#define GOP_REG_DMA_BASE_ADR                                   0x0002DC6000  //Alignment 0x01000
...
//co_buffer L0
#define VE_FRAME_BUF_AVAILABLE                                 0x0002DC7000
#define VE_FRAME_BUF_ADR                                       0x0002DC7000  //Alignment 0
...
//co_buffer L0
#define PM51_START_TAG_AVAILABLE                               0x0002DC7400
#define PM51_START_TAG_ADR                                     0x0002DD0000  //Alignment 0x10000
#define PM51_START_TAG_GAP_CHK                                 0x0000008C00
#define PM51_START_TAG_LEN                                     0x0000000000
#define PM51_START_TAG_MEMORY_TYPE                             (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* MIU0_COBUF2_START   */
//co_buffer L0
#define MIU0_COBUF2_START_AVAILABLE                            0x0002DD0000
#define MIU0_COBUF2_START_ADR                                  0x0002DD0000  //Alignment 0
...
/* PM51_LITE   */
//co_buffer L1
#define PM51_LITE_AVAILABLE                                    0x0002DD0000
#define PM51_LITE_ADR                                          0x0002DD0000  //Alignment 0x01000
...
//co_buffer L1
#define MIU0_COBUF2_L1_END_TAG_AVAILABLE                       0x0002DD8000
#define MIU0_COBUF2_L1_END_TAG_ADR                             0x0002DD8000  //Alignment 0
...
/* PM51_STR   */
//co_buffer L2
#define PM51_STR_AVAILABLE                                     0x0002DD0000
#define PM51_STR_ADR                                           0x0002DD0000  //Alignment 0x01000
...
//co_buffer L2
#define MIU0_COBUF2_L2_END_TAG_AVAILABLE                       0x0002DD4000
#define MIU0_COBUF2_L2_END_TAG_ADR                             0x0002DD4000  //Alignment 0
...
/* MIU0_COBUF2_END_TAG   */
//co_buffer L0
#define MIU0_COBUF2_END_TAG_AVAILABLE                          0x0002DD8000
#define MIU0_COBUF2_END_TAG_ADR                                0x0002DD8000  //Alignment 0
...
/* PM51_MEM   */
//co_buffer L0
#define PM51_MEM_AVAILABLE                                     0x0002DD8000
#define PM51_MEM_ADR                                           0x0002DD8000  //Alignment 0x01000
...
//co_buffer L0
#define PM51_RESERVED_AVAILABLE                                0x0002DD9000
#define PM51_RESERVED_ADR                                      0x0002DD9000  //Alignment 0
...
//co_buffer L0
#define GOP_GWIN_RB_AVAILABLE                                  0x0002DE0000
#define GOP_GWIN_RB_ADR                                        0x0002DE0000  //Alignment 0x00008
#define GOP_GWIN_RB_GAP_CHK                                    0x0000000000
#define GOP_GWIN_RB_LEN                                        0x00006A0000
#define GOP_GWIN_RB_MEMORY_TYPE                                (MIU0 | SW | CO_BUF_L0 | UNCACHED)

/* SECTION_BUF Reserved for Kernel and Pool */
//co_buffer L0
#define SECTION_BUF_AVAILABLE                                  0x0003480000
#define SECTION_BUF_ADR                                        0x0003480000  //Alignment 0x00010
