...
#ifndef _APPDEMO_USB_H_
#define _APPDEMO_USB_H_

MS_BOOL appDemo_USB_Fdisk(MS_U8 *devName, MS_U32 * partitions_count, MS_U32 *p1_size, MS_U32 *p2_size, MS_U32 *p3_size, MS_U32 *p4_size);
