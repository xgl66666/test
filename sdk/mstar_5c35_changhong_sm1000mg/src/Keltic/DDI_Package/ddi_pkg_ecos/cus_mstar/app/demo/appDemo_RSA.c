...
{
    MS_U32 u32Size = sizeof(rsa_a_256);
    MS_U8 *pu8Cipher = _pu8Buf;
    MS_U8 *pu8Result = _pu8Buf + u32Size;
    MS_BOOL ret = DRVAESDMA_FAIL;

    printf("\nDemo_RSA_DEMO_256==>\n");
    printf("PlainText:\n");  _DumpBuf(rsa_a_256, u32Size);
    memset( pu8Cipher, 0x0, u32Size);
    memset( pu8Result, 0x0, u32Size);
...
{
    MS_U32 u32Size = sizeof(rsa_a_128);
    MS_U8 *pu8Cipher = _pu8Buf;
    MS_U8 *pu8Result = _pu8Buf + u32Size;
    MS_BOOL ret = DRVAESDMA_FAIL;

    printf("\nDemo_RSA_DEMO_128==>\n");
    printf("PlainTest:\n");  _DumpBuf(rsa_a_128, u32Size);
    memset( pu8Cipher, 0x0, u32Size);
    memset( pu8Result, 0x0, u32Size);
...
{
    MS_U32 u32Size = sizeof(rsa_a_32);
    MS_U8 *pu8Cipher = _pu8Buf;
    MS_U8 *pu8Result = _pu8Buf + u32Size;
    MS_BOOL ret = DRVAESDMA_FAIL;

    printf("\nDemo_RSA_DEMO_32==>\n");
    printf("PlainTest:\n");  _DumpBuf(rsa_a_32, u32Size);
    memset( pu8Cipher, 0x0, u32Size);
    memset( pu8Result, 0x0, u32Size);
...
MS_BOOL appDemo_RSA_DoRSADemo(void)
{
    MS_BOOL ret = DRVAESDMA_FAIL;
    
    // Allocate memory
    _pu8Buf = MsOS_AllocateMemory(256 * 2, gs32NonCachedPoolID);
    ...
    // Free memory
    MsOS_FreeMemory( _pu8Buf, gs32NonCachedPoolID);
...
{
    MS_U32 u32Size = sizeof(rsa_a_256);
    MS_U8 *u8Buf = MsOS_AllocateMemory(u32Size, gs32NonCachedPoolID);

    DrvAESDMA_RSASig stSig;
    DrvAESDMA_RSAOut *stRSAOut = (DrvAESDMA_RSAOut *) u8Buf;
    MS_U32 u32OffsetA, u32KeyLen= sizeof(rsa_a_256);
...
MS_BOOL appDemo_RSA_DoRSADemo_HwKey(void)
{
    //
    // Note:
