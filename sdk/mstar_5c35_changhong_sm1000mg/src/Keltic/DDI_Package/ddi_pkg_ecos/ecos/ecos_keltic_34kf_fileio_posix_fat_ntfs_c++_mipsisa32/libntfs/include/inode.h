...
struct _ntfs_inode {
    ...
    /*
     * mcinnis:20090306
     * count the reference to the inode
     */
    s32 i_count;            /* count the refernce to the inode. */
    ntfs_inode *h_next;     /* next inode of the hash entry. */
};
...
extern int ntfs_inode_close_nosync(ntfs_inode *ni);
