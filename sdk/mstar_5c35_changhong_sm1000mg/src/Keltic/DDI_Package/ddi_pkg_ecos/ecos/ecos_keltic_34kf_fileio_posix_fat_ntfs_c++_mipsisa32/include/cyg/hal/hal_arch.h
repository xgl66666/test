...
#ifndef HAL_MIPS_VAR_SAVEDREGISTERS
// It is not obvious which of these CP0 registers actually need saving,
// but the original MIPS HAL used this set.
# define HAL_MIPS_VAR_SAVEDREGISTERS                                            \
...
//
// Interrupts are enabled in kernel configurations where INIT_CONTEXT()
// will be used for threads, disabled otherwise to prevent interrupts
// from being enabled too early.
#ifdef CYGPKG_KERNEL
# define HAL_THREAD_INIT_CONTEXT_SR     0x00000001
#else
# define HAL_THREAD_INIT_CONTEXT_SR     0x00000000
#endif
...
{                                                                                       \
    ...
    (_regs_)->sr  = HAL_THREAD_INIT_CONTEXT_SR;       /* SR = ls 3 bits only    */      \
...
#define HAL_BREAKINST_MIPS16            0xE8A5
#define HAL_BREAKINST_MIPS16_SIZE       2
#define HAL_BREAKINST_MIPS16_TYPE       cyg_uint16

#define HAL_BREAKINST_MIPS32            0x0005000d
#define HAL_BREAKINST_MIPS32_SIZE       4
#define HAL_BREAKINST_MIPS32_TYPE       cyg_uint32

#ifdef __mips16
#define HAL_BREAKINST                   HAL_BREAKINST_MIPS16
#define HAL_BREAKINST_SIZE              HAL_BREAKINST_MIPS16_SIZE
#define HAL_BREAKINST_TYPE              HAL_BREAKINST_MIPS16_TYPE
#else
#define HAL_BREAKINST                   HAL_BREAKINST_MIPS32
#define HAL_BREAKINST_SIZE              HAL_BREAKINST_MIPS32_SIZE
#define HAL_BREAKINST_TYPE              HAL_BREAKINST_MIPS32_TYPE
#endif
