...
#define DONT_CARE_UCSLEN 0XFFFFFFFF
...
/*
 * mcinnis:20090320
 * calculate the upcase value at runtime
 */
extern ntfschar ntfs_runtime_upcase(ntfschar c);

extern ntfschar *ntfs_ucsndup(const ntfschar *s, u32 maxlen);

extern ntfschar *ntfs_ucsrchr(ntfschar *s, int c);

extern ntfschar *ntfs_ucschr(ntfschar *s, int c);

extern ntfschar *ntfs_ucscpy(ntfschar *to, const ntfschar *from);
