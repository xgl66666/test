...
typedef cyg_int8  s8;           /* Signed types of an exact size */
typedef cyg_int16 s16;
typedef cyg_int32 s32;
typedef cyg_int64 s64;

typedef cyg_uint8  u8;          /* Unsigned types of an exact size */
...
#define	major(x)	((s32)(((u32)(x) >> 8) & 0xff))
#define	minor(x)	((s32)((x) & 0xff))
