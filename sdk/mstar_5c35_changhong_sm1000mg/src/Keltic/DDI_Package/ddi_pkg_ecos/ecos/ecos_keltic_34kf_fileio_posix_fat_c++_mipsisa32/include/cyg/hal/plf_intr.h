...
//kevinhuang10262006, add
#define CYGNUM_HAL_INTERRUPT_IRQ                 0 //[10]
#define CYGNUM_HAL_INTERRUPT_FIQ                 1 //[11]
//#define CYGNUM_HAL_INTERRUPT_COMPARE             5
...
#define HAL_INTERRUPT_MASK( _vector_ )                       \
    ...
    {                                                                       \
        hal_interrupt_mask_im( _vector_ );                                  \
    }                                                                       \
...
#define HAL_INTERRUPT_UNMASK( _vector_ )                     \
    ...
    if( (_vector_) <= CYGNUM_HAL_INTERRUPT_COMPARE )                        \
    {                                                                       \
        hal_interrupt_unmask_im( _vector_ );                                \
    }                                                                       \
    else if ((_vector_) >= CYGNUM_HAL_INTERRUPT_CTRL2_BASE)                 \
    {                                                                       \
        cyg_uint8 _mask_;                                                   \
...
#define HAL_INTERRUPT_ACKNOWLEDGE( _vector_ )                   \
    ...
    hal_interrupt_acknowledge_im( _srvector_ );                 \
    CYG_MACRO_END
