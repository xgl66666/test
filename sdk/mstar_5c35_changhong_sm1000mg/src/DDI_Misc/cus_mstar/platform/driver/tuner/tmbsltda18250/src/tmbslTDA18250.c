...
)
{
    ...
    while ( ((Int32)uAGC1 > Lvl_AGC1[uIndex][tmTDA18250_AGC1_Code]) && (uIndex < tmTDA18250_Lvl_AGC1_Index_Max) )
        uIndex = uIndex + 1;
...
)
{
    ...
    while ( ((Int32)uAGC1 > Lvl_AGC1_MasterMulti[uIndex][tmTDA18250_AGC1_Code]) && (uIndex < tmTDA18250_Lvl_AGC1_Index_Max) )
        uIndex = uIndex + 1;
