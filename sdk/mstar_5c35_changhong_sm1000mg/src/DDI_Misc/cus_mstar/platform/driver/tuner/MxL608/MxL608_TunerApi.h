...
MXL_STATUS MxLWare608_API_CfgDevOverwriteDefaults(UINT8 u8TunerIndex,UINT8 devId, MXL_BOOL singleSupply_3_3V);
...
MXL_STATUS MxLWare608_API_ReqDevVersionInfo(UINT8 u8TunerIndex,UINT8 devId, MXL608_VER_INFO_T* mxlDevVerInfoPtr);
MXL_STATUS MxLWare608_API_ReqDevGPOStatus(UINT8 u8TunerIndex,UINT8 devId, MXL608_GPO_STATE_E* gpoStatusPtr);
MXL_STATUS MxLWare608_API_ReqDevPllState(UINT8 u8TunerIndex,UINT8 devId, MXL608_PLL_STATE_E* PllStatePtr);

MXL_STATUS MxLWare608_API_CfgTunerMode(UINT8 u8TunerIndex,UINT8 devId, MXL608_TUNER_MODE_CFG_T tunerModeCfg);
...
MXL_STATUS MxLWare608_API_CfgTunerChanTune(UINT8 u8TunerIndex,UINT8 devId, MXL608_CHAN_TUNE_CFG_T chanTuneCfg);

MXL_STATUS MxLWare608_API_ReqTunerAGCLock(UINT8 u8TunerIndex,UINT8 devId, MXL_BOOL* agcLockStatusPtr);
MXL_STATUS MxLWare608_API_ReqTunerLockStatus(UINT8 u8TunerIndex,UINT8 devId, MXL_BOOL* rfLockPtr, MXL_BOOL* refLockPtr);
