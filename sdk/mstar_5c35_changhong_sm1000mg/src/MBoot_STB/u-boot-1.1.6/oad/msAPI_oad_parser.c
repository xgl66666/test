...
U8 *msAPI_OAD_PollingSectionFilter(U8  u08OadFID,U8  *sectionBuffer)
{
    ...
    OAD_DEBUG(printf("eEvent = %bu\n",(U8)eEvent)) ;

    OAD_DEBUG(printf("procRet = %bu\n",(U8)procRet));
...
BOOLEAN msAPI_OAD_CreateSectionFilter( U32 u32Type,U8 u08TableId,U16 u16MsgId, U16 u16Pid,U8  *u08OadFID)
{
