 ...
 */
#define CFG_CMD_DUMMY		0x00000000ULL
...
#define CFG_CMD_UBIFS		0x00000200ULL	/* UBI file system				*/
#define CFG_CMD_PCMCIA		0x00000400ULL	/* PCMCIA support		*/
#define CFG_CMD_IDE		0x00000800ULL	/* IDE harddisk support		*/
#define CFG_CMD_ENV_IN_UBI      0x00001000ULL /* UBI manage environment area */
...
#define CFG_CMD_DEMOD		0x00400000ULL	/* Demodulator support		*/
#define CFG_CMD_DATE		0x00800000ULL	/* support for RTC, date/time...*/
#define CFG_CMD_DHCP		0x01000000ULL	/* DHCP Support			*/
#define CFG_CMD_STANDBY		0x02000000ULL	/* Standby mode support	*/
#define CFG_CMD_KEYPAD		0x04000000ULL       /* Keypad support */
#define CFG_CMD_LWIP		0x08000000ULL	/* LWIP Support			*/
#define CFG_CMD_AUTOSCRIPT	0x10000000ULL	/* Autoscript Support		*/
#define CFG_CMD_MII		0x20000000ULL	/* MII support			*/
#define CFG_CMD_TUNER		0x40000000ULL	/* Tuner Support		*/
//#define CFG_CMD_BSP		    0x80000000ULL	/* Board Specific functions	*/
#define CFG_CMD_DEMOCODE	0x80000000ULL	/* Demo code function	*/
...
#define CFG_CMD_SECURE      0x0000080000000000ULL   /* Secure authentication */
#define CFG_CMD_SPI	        0x0000100000000000ULL	/* SPI utility			*/
#define CFG_CMD_UBI	        0x0000200000000000ULL	/* UBIFS		*/
...
#define CFG_CMD_BOOTLOGO	    0x0100000000000000ULL	/* boot up logo display		*/
...
#define CFG_CMD_DMX    0x0800000000000000ULL	/* Demultiplex      */
#define CFG_CMD_EXT2	    0x1000000000000000ULL	/* EXT2 Support			*/
#define CFG_CMD_SNTP	    0x2000000000000000ULL	/* SNTP support			*/
#define CFG_CMD_DISPLAY	    0x4000000000000000ULL	/* Display support		*/
#define CFG_CMD_MICOM       0x8000000000000000ULL	/* Micom support		*/
