...
//partition Name definition
#define LINUX_KERNEL_BOOT_PARAMETER_PARTITION_NAME "KL_BP"
#define CHAKRA_PARTITION_NAME "CK"
#define CHAKRA_RES_PARTITION_NAME "CK_RES"
