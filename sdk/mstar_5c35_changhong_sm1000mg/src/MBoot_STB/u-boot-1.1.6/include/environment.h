...
# endif
# ifndef  CFG_ENV_ADDR_BAK
#  define CFG_ENV_ADDR_BAK   (CFG_ENV_ADDR + (CFG_ENV_BLOCK_NUM * nand->erasesize))
# endif
...
# ifndef CFG_ENV_ADDR
#  error "Need to define CFG_ENV_ADDR when using CFG_ENV_IS_IN_SPIFLASH"
# endif
# ifndef CFG_ENV_SIZE
#  error "Need to define CFG_ENV_SIZE when using CFG_ENV_IS_IN_SPIFLASH"
# endif
...
#if (CONFIG_COMMANDS & CONFIG_ENV_IN_NAND)
#define ENV_CFG         "ENV=NAND"
#elif (CONFIG_COMMANDS & CFG_CMD_ENV_IN_UBI)
