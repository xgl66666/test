...
#define MBOOT_MELODY		1						//compile option for Mboot-Melody (default:0)
...
#define  AU_DVB2_AUTHBIT_NULL           127
...
typedef enum
{
    SPDIF_CS_Category_BroadCast,        ///<
    SPDIF_CS_Category_General,          ///<
    SPDIF_CS_Category_Rev1,             ///<
    SPDIF_CS_Category_Rev2,             ///<
    SPDIF_CS_Category_Rev3,             ///<
    SPDIF_CS_Category_Rev4,             ///<
    SPDIF_CS_Category_Rev5,             ///<
    SPDIF_CS_Category_Rev6,             ///<
    SPDIF_CS_CopyRight_CP,              ///<
    SPDIF_CS_CopyRight_NonCP,           ///<SPDIF_CS_ChannelNumber_Right
    SPDIF_CS_SourceNumber_2,            ///<
    SPDIF_CS_SourceNumber_5,            ///<
    SPDIF_CS_SourceNumber_6,            ///<
    SPDIF_CS_SourceNumber_Rev1,         ///<
    SPDIF_CS_SourceNumber_Rev2,         ///<
    SPDIF_CS_SourceNumber_Rev3,         ///<
    SPDIF_CS_ChannelNumber_A_Left,      ///<
    SPDIF_CS_ChannelNumber_B_Right,     ///<
    SPDIF_CS_ChannelNumber_C,           ///<
    SPDIF_CS_ChannelNumber_D,           ///<
    SPDIF_CS_ChannelNumber_E,           ///<
    SPDIF_CS_ChannelNumber_F,           ///<
    SPDIF_CS_ChannelNumber_G,           ///<
    SPDIF_CS_ChannelNumber_H,           ///<
    SPDIF_CS_ChannelNumber_I,           ///<
    SPDIF_CS_ChannelNumber_J,           ///<
    SPDIF_CS_ChannelNumber_K,           ///<
    SPDIF_CS_SmpFreq_192,               ///<
    SPDIF_CS_SmpFreq_176,               ///<
    SPDIF_CS_SmpFreq_128,               ///<
    SPDIF_CS_SmpFreq_96,                ///<
    SPDIF_CS_SmpFreq_88,                ///<
    SPDIF_CS_SmpFreq_64,                ///<
    SPDIF_CS_SmpFreq_48,                ///<
    ...
    SPDIF_CS_SmpFreq_22,                ///<
    SPDIF_CS_SmpFreq_16,                ///<
    SPDIF_CS_SmpFreq_Rev1,              ///<
    SPDIF_CS_SmpFreq_Rev2,              ///<
    SPDIF_CS_SmpFreq_Rev3,              ///<
    SPDIF_CS_SmpFreq_Rev4,              ///<
    SPDIF_CS_SmpFreq_Rev5,              ///<
    SPDIF_CS_ClockAcc_Lev1,             ///<
    SPDIF_CS_ClockAcc_Lev2,             ///<
    SPDIF_CS_ClockAcc_Lev3,             ///<
    SPDIF_CS_ClockAcc_NotMatch,         ///<
...
typedef enum
{
    ...
    MSAPI_AUD_DVB_RESERVE3,             // 0x11
    MSAPI_AUD_DVB_RESERVE2,             // 0x12
    MSAPI_AUD_DVB_RESERVE1,             // 0x13
    MSAPI_AUD_DVB_MAX,
    ...
    MSAPI_AUD_DVB2_AC3P,                ///< 0x35: System=AC3P AD
    MSAPI_AUD_DVB2_DDE,                 ///< 0x36: System=AC3 Encoder
    MSAPI_AUD_DVB2_DTSE,                ///< 0x37: System=DTS Encoder
    MSAPI_AUD_DVB2_XPCM,
    MSAPI_AUD_DVB2_KTV,
    MSAPI_AUD_DVB2_KTV2,
    MSAPI_AUD_DVB2_MAX,
...
typedef enum
{
    ...
    AU_DVB_DECCMD_PLAYFRAME             = 8,            // Uniplayer, Mstreamer
...
typedef enum
{
    ...
    SRS_THEATERSOUND_RESERVE1,
    SRS_THEATERSOUND_RESERVE2,
    SRS_THEATERSOUND_RESERVE3,
    SRS_THEATERSOUND_RESERVE4,
    SRS_THEATERSOUND_RESERVE5,
    SRS_THEATERSOUND_RESERVE6,
    SRS_THEATERSOUND_RESERVE7,
