...
#define MSIF_DMX_LIBVER                       {'1','2'}            //LIB version
#define MSIF_DMX_BUILDNUM                     {'2','6'}            //Build Number
#define MSIF_DMX_CHANGELIST                   {'0','0','4','1','9','2','1','4'} //P4 ChangeList Number
...
typedef enum
{
	DMX_MMFI_FLTTYPE_AUD = 0,
	DMX_MMFI_FLTTYPE_AUDB,
	DMX_MMFI_FLTTYPE_VD3D,
}DMX_MMFI_FLTTYPE;
...
DMX_FILTER_STATUS MApi_DMX_MMFI_Filein_Abort(DMX_MMFI_PATH ePath);
...
// [NOTE] API for TSP Ver2.0 N filter to 1 Buffer HW architecture.
