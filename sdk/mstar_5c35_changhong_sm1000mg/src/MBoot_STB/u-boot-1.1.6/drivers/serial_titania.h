...
#if defined(CONFIG_TITANIA8) || defined(CONFIG_TITANIA12) || defined(CONFIG_JANUS2) || defined(CONFIG_AMBER2)
// Baud rate
#define UART_BAUD_RATE	            115200//38400 //9600 //19200 //38400 //57600 //115200 =>too frequent Rx INT
// Clock source
#define UART_CLK_FREQ               123000000//43200000 //123000000//14318180
...
#if (ENABLE_MCU_AEONR2)                 // for PIU UART
    #define REG_UART0_BASE              0xA0201300
    #define REG_UART1_BASE              0xA0201300
    #define REG_UART2_BASE              0xA0201300

    #define UART0_REG8(addr)            *((volatile unsigned char*)(REG_UART0_BASE + ( ((addr)<< 2) - ((addr)&1) )) )
    #define UART1_REG8(addr)            *((volatile unsigned char*)(REG_UART1_BASE + ( ((addr)<< 2) - ((addr)&1) )) )
    #define UART2_REG8(addr)            *((volatile unsigned char*)(REG_UART2_BASE + ( ((addr)<< 2) - ((addr)&1) )) )
#else
    #define REG_UART0_BASE              0x90000000
    #define REG_UART1_BASE              0x90000000
    #define REG_UART2_BASE              0x90000000
    #define UART0_REG8(addr)            *((volatile unsigned char*)(REG_UART0_BASE + ((addr))))
    #define UART1_REG8(addr)            *((volatile unsigned char*)(REG_UART1_BASE + ((addr))))
    #define UART2_REG8(addr)            *((volatile unsigned char*)(REG_UART2_BASE + ((addr))))
#endif
...
// UART Register List
//
#if (defined (CONFIG_JANUS) && (ENABLE_MCU_AEONR2==1) ) || (defined (CONFIG_MARIA10) && (ENABLE_MCU_AEONR2==1) )
...
#define UART_SCR       (7 * 2)  // I/O: Scratch Register
