...
void USB_Bulk_Init4(struct usb_device *dev)
{
   ...
   //<5>.Hook the qHD
       ...
       //Setting Max Packet Size and print message
         ...
         pHost20_qHD_List_Bulk1_P3->bMaxPacketSize=ep2->wMaxPacketSize; //Suppose In/Out have the same Max packet Size
...
#define   wTimeWaitForConnect_ms 100//1000

UINT8 flib_OTGH_Init4(UINT8 wForDevice_B)
{
   UINT8 wValue;
   UINT16 wTimer_ms;
...
// J_test
      ...
      USB_DELAY(100);		//wait some slow device to be ready
   //<7>.Detect Speed
