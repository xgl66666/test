...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        pObj->I2CMap.uBx07.PSM_byte_1          = 0xD0;
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            *puState = (tmddTDA18250_State_t)0x00;
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            *puSwitchState = (tmddTDA18250SwitchState_t)0x00;
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        err = ddTDA18250Write(pObj, TMDD_TDA18250_0x2D_RF_Cal_byte_2, 1);
        tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "ddTDA18250_Write(0x%08X) failed.", tUnit));
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "ddTDA18250_Read(0x%08X) failed.", tUnit));
        }
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            *puValue = tmddTDA18250_AGC1_Gain_Free;
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            *puValue = tmddTDA18250_AGC_Mode_Free;
