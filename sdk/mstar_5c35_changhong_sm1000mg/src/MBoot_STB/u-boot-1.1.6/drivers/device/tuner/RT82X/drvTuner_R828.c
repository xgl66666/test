...
// Filename: R828.c
//
// This file is R828S tuner driver
...
UINT8 R828_iniArry[27] =
{
           0x83, 0x32, 0x75, 0xC0, 0x40, 0xD6, 0x6C, 0xD5, 0x63,
...
MS_U32 MDrv_Tuner_SetTuner(MS_U32 u32Freq, MS_U8 feBw)
{
    ...
    printf("\n u32Freq %d, ucBw %d, tuner type =%d,",u32Freq,feBw,mode.Fetype);
    printf("mode=%s\n",(mode.Femode ==FAST_MODE)?"Fast Mode":"Normal Mode");
    ...
    R828_INFO.RT_Input = LOOP_THROUGH;
