...
#define TMDD_TDA18250_MINOR_VER                 21 /* Software update - No protocol change - No specification change required */
...
{                            
    ...
    {            
        struct
        {
            ...
            UInt8 UNUSED_0x18_2             :2;
            UInt8 PD_RFAGC_Det              :1;
            UInt8 UNUSED_0x18_1             :1;
            UInt8 pdAGC2b                   :1;
