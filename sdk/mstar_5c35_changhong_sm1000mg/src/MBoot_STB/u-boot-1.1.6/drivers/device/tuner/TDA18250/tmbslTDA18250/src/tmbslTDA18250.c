...
static UInt8 Gd_RCcal[tmTDA18250_Gd_RCcal_Index_Max][tmTDA18250_GD_Max] = TMBSL_TDA18250_INSTANCE_CUSTOM_COMMON_Gd_RCcal;
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            if (err == TM_OK)
            {
                ...
                if (pObj->BandParam[uNewBandIndex].ChannelType == tmTDA18250AnalogChannel)
                {
                    if (err == TM_OK)
                    {
                        /* Gain threshold management */
                        if ( (uRF + 4500000) <= pObj->uFreqCut)
                            uGAIN_threshold = 4;
                        else
                            uGAIN_threshold = 0;
                        err = tmddTDA18250SetGAIN_threshold(tUnit, uGAIN_threshold);
                        tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetGAIN_threshold(0x%08X) failed.", tUnit));
                    }

                    if (err == TM_OK)
                    {
                        err= TDA18250SetGroupDelay(tUnit, uLO);
                        tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250SetGroupDelay(0x%08X) failed.", tUnit));
                    }

                    if (err == TM_OK)
                    {
                        /* Set the new Analog Path */
                        err = TDA18250SetAnalogPath(tUnit, uNewBandIndex);
                        tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250SetAnalogPath(0x%08X) failed.", tUnit));
                    }
                }
            }
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        /***** RF Calibration POR *****/
        if ((err == TM_OK) && (uIdentity != 0xD5 )  && (uIdentity != 0xD6 ) && (uIdentity != 0xD7 ) )
        {
            err = TDA18250CalPOR(tUnit);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250CalPOR(0x%08X) failed.", tUnit));
        }
        ...
        if (err == TM_OK)
        {
            err = TDA18250SwitchDirectAccess(tUnit, tmTDA18250_RFSW_ANALOG, tmddTDA18250_SW_CLOSE);
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (uIRStep == tmTDA18250_RESTORE)
        {
            ...
            {
                case tmddTDA18250_DeviceTypeMasterWithoutXTout:
                case tmddTDA18250_DeviceTypeMaster:
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            err = TDA18250Wait(pObj, 10);  /* wait 10ms */
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250Wait(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            err = TDA18250Wait(pObj, 40);  /* wait 40ms */
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250Wait(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            err = tmddTDA18250SetSelRAM(tUnit, 0);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetSelRAM(0x%08X) failed.", tUnit));
        }
        /* Data writting in RAM */
        if (err == TM_OK)
        {
            err = tmddTDA18250WriteDataRAM(tUnit, 0x02, 0x07);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250WriteDataRAM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250WriteDataRAM(tUnit, 0x08, 0x1C);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250WriteDataRAM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250WriteDataRAM(tUnit, 0x09, 0x21);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250WriteDataRAM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250SetModeI2CRAM(tUnit, 0);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetModeI2CRAM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250SetWRI2CRAM(tUnit, 0);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetWRI2CRAM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
        ...
        /***** End RAM FCAL updated *****/

        /* RFCAL POR Mode */
        if (err == TM_OK)
        {
            err = tmddTDA18250Sethc_mode(tUnit, tmddTDA18250_HcModeRFcalPOR);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Sethc_mode(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
        ...
        if (err == TM_OK)
        {
            err = TDA18250Wait(pObj, 150);  /* wait 150ms */
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250Wait(0x%08X) failed.", tUnit));
        }
        ...
        /* Frequency cut management */
        if (err == TM_OK)
        {
            err = tmddTDA18250SetFreqCut_sel(tUnit, (UInt8)0);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetFreqCut_sel(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250GetFreqCut(tUnit, &pObj->uFreqCut);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250GetFreqCut(0x%08X) failed.", tUnit));
        }
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            for (uAudAdd = tmTDA18250_AGC1_Aup_0dB; uAudAdd<=tmTDA18250_AGC1_Aup_13_5dB; uAudAdd++)
            {
        ...
        if (err == TM_OK)
        {
            for (uAudAdd = tmTDA18250_AGC1_Ado_3dB; uAudAdd<=tmTDA18250_AGC1_Ado_15dB; uAudAdd++)
            {
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            if ((tmddTDA18250_State_t)RdSwitchState == SwitchState)
            {
                return TM_OK;
            }
        }
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            while (((tmddTDA18250_State_t)RdSwitchState != SwitchState) && (uCpt<5))
            {
...
)
{
    ptmTDA18250Object_t       pObj = Null;
    tmErrorCode_t             err  = TM_OK;
    tmTDA18250_SwitchSmooth_t    eMTOSmooth;
    ...
    if (err == TM_OK)
    {
        ...
        if (pObj->MTO_TimeCst == tmddTDA18250_TCST_0)
            eMTOSmooth = tmTDA18250_SW_SMOOTH_OFF;
        else
            eMTOSmooth = tmTDA18250_SW_SMOOTH_ON;
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            while (((tmddTDA18250SwitchState_t)RdMTOState != MTOState) && (uCpt<5))
            {
                ...
                if (err == TM_OK)
                {
                    err = TDA18250Wait(pObj, uTimeTransition[pObj->MTO_TimeCst]);
                    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250Wait(0x%08X) failed.", tUnit));
                }
        ...
        if (err == TM_OK)
        {
            if ((tmddTDA18250_State_t)RdMTOState != MTOState)
            {
                err = TDA18250_ERR_NOT_READY;
...
/*============================================================================*/
/* FUNCTION:    TDA18250SetGroupDelay:                                        */
/*                                                                            */
/* DESCRIPTION: Group Delay management.                                       */
/*                                                                            */
/* RETURN:      TM_OK if no error                                             */
/*                                                                            */
/* NOTES:                                                                     */
...
)
{
    ...
    if (err == TM_OK)
    {
        if (err == TM_OK)
        {
            /* Group Delay activated if deltaLO >= 40KHz */
            err = tmddTDA18250GetLOFreq(tUnit, &uLOprog);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250GetLOFreq(0x%08X) failed.", tUnit));
        }

        if (err == TM_OK)
        {
            err = tmddTDA18250Setshift_GD_offset(tUnit, tmddTDA18250_ON);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setshift_GD_offset(0x%08X) failed.", tUnit));
        }

        /* Group Delay optimization */
        if (err == TM_OK)
        {
            err = tmddTDA18250GetRC_ReadCal_3_to_0(tUnit, &uRCcal);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250GetRC_Cal_3_to_0(0x%08X) failed.", tUnit));
        }

        if (err == TM_OK)
        {
            err = tmddTDA18250GetRC_ReadCal_4(tUnit, &uRCcal4);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250GetRC_Cal_4(0x%08X) failed.", tUnit));
        }
        ...
        if (err == TM_OK)
        {
            uRCcal += uRCcal4 << 4;
            uRCcal &= 0x1F;
            err = tmddTDA18250SetRC_GD_sign(tUnit, Gd_RCcal[uRCcal][tmTDA18250_GD_Signe]);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetRC_GD_sign(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250SetRC_GD_offset(tUnit, Gd_RCcal[uRCcal][tmTDA18250_GD_Offset]);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetRC_GD_offset(0x%08X) failed.", tUnit));
        }
    }
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            /* AGC2_TOP writting only if BP_Filter changed or came from analog path */
            if ( (pObj->BandParam[NewBandIndex].BP_Filter != pObj->BandParam[pObj->BandIndex].BP_Filter)
                 ||
                  (pObj->BandParam[pObj->BandIndex].ChannelType == tmTDA18250AnalogChannel)
               )
            {
        ...
        if (err == TM_OK)
        {
            /* Blocks path updated only if previous channel type is Analog or after Reset */
            if ( (pObj->BandParam[pObj->BandIndex].ChannelType == tmTDA18250AnalogChannel)
                  ||
                 (pObj->ResetCalledPreviously == True) )
            {
...
/*============================================================================*/
/* FUNCTION:    TDA18250SetAnalogPath:                                        */
/*                                                                            */
/* DESCRIPTION: Analog Path configuration.                                    */
/*                                                                            */
/* RETURN:      TM_OK if no error                                             */
/*                                                                            */
/* NOTES:       pObj->BandIndex = previous index in this step                 */
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            err = tmddTDA18250SetRFAGC_OpenLoop(tUnit, tmddTDA18250_PD_Activated);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetRFAGC_OpenLoop(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = TDA18250SetSwitchOpen(tUnit);
        ...
        if (err == TM_OK)
        {
            /* Blocks path updated only if previous channel type is Digital or after Reset */
            if ( (pObj->BandParam[pObj->BandIndex].ChannelType == tmTDA18250DigitalChannel)
                  ||
                 (pObj->ResetCalledPreviously == True) )
            {
                err = TDA18250SetBlocksPath(tUnit, tmTDA18250AnalogChannel);
                tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250SetStandardMode(0x%08X) failed.", tUnit));
            }
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250SetAGC_Low_BW(tUnit, 0);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetLaunchMSM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
        ...
        if (err == TM_OK)
        {
            err = tmddTDA18250Setcapw_filter_sel(tUnit, tmddTDA18250_OFF);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setcapw_filter_sel(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            /* RF filter prepositionning <=> center to 0 */
            err = tmddTDA18250SetNmeasAV(tUnit, 0);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250GetNmeasAV(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = TDA18250CalAV(tUnit);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250CalAV(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = TDA18250SetSwitchClose(tUnit, NewBandIndex);
        ...
        if (err == TM_OK)
        {
            err = tmddTDA18250SetRFAGC_OpenLoop(tUnit, tmddTDA18250_PD_NotActivated);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetRFAGC_OpenLoop(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
        ...
        if (err == TM_OK)
        {
            /* pulse_width set to zero in Reset function */
            err = tmddTDA18250Setpulse_up_auto(tUnit, tmddTDA18250_OFF);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setpulse_up_auto(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250SetRFagc_fast(tUnit, 1);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetLaunchMSM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
        ...
        if (err == TM_OK)
        {
            err = tmddTDA18250SetRFagc_fast(tUnit, 0);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetLaunchMSM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = TDA18250Wait(pObj, 11);  /* wait 11ms */
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250Wait(0x%08X) failed.", tUnit));
        }

        if (err == TM_OK)
        {
            /* RF filter calibration <=> -2, -1, 0, +1, +2 */
            err = tmddTDA18250SetNmeasAV(tUnit, 2);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250GetNmeasAV(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
        ...
        if (err == TM_OK)
        {
            err = tmddTDA18250Setpulse_up_auto(tUnit, tmddTDA18250_ON);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setpulse_up_auto(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            /* Update analog path value */
            err = TDA18250WriteAnalogRF_Filters(tUnit);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250WriteAnalogRF_Filters(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            /* Update RFAGC_Top value */
            err = TDA18250SetRFAGC_Top(tUnit);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "TDA18250SetRFAGC_Top(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            /* start AGC1 loop */
        ...
        if (err == TM_OK)
        {
            err = tmddTDA18250SetAGC_Low_BW(tUnit, 1);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetLaunchMSM(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
...
)
{
    ...
    if (err == TM_OK)
    {
        /* Select the analog or digital Band */
        if ( pObj->Std_Array[pObj->StandardMode].ChannelType == tmTDA18250DigitalChannel )
            uNewBandIndex = tmTDA18250_IND_DIG_Band_1;
        if ( pObj->Std_Array[pObj->StandardMode].ChannelType == tmTDA18250AnalogChannel )
            uNewBandIndex = tmTDA18250_IND_ANLG_Band_1;
...
/*============================================================================*/
/* FUNCTION:    TDA18250WriteAnalogRF_Filters:                                */
/*                                                                            */
/* DESCRIPTION: Writes specific Analog data regarding the Filter Index.       */
/*                                                                            */
/* RETURN:      TM_OK if no error                                             */
/*                                                                            */
/* NOTES:       writting data done only if previous different from current    */
/*              (exception to capw)                                           */
/*              pObj->AnalogIndex is the previous Filter index                */
/*              uFilterIndex = 0 after reset                                  */
/*============================================================================*/
tmErrorCode_t
...
)
{
    ...
    if (err == TM_OK)
    {
        if (err == TM_OK)
        {
            err = tmddTDA18250Setcapw_filter_sel(tUnit, tmddTDA18250_ON);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setcapw_filter_sel(0x%08X) failed.", tUnit));
        }

        /***** Set capw all the time due to hardware modification  *****/
        /*Get the new Filter index */
        if (err == TM_OK)
        {
            err = tmddTDA18250GetFilterIndex(tUnit, &uNewFilterIndex);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250GetFilterIndex(0x%08X) failed.", tUnit));
        }

        if (err == TM_OK)
        {
            err = tmddTDA18250Setcapw_gain(tUnit, pObj->AnalogParam[uNewFilterIndex].capw_gain);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setcapw_gain(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250Setcapw_cad(tUnit, pObj->AnalogParam[uNewFilterIndex].capw_cad);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setcapw_cad(0x%08X) failed.", tUnit));
        }
        if (err == TM_OK)
        {
            err = tmddTDA18250Setcapw_ctank(tUnit, pObj->AnalogParam[uNewFilterIndex].capw_ctank);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250Setcapw_ctank(0x%08X) failed.", tUnit));
        }

        /***** Set data only only if previous different from current *****/
        if (err == TM_OK)
        {
            if ( (pObj->AnalogParam[uNewFilterIndex].LF_nHF != pObj->AnalogParam[pObj->AnalogIndex].LF_nHF)
                 || (pObj->ResetCalledPreviously == True) )
            {
                err = tmddTDA18250SetLF_nHF(tUnit, pObj->AnalogParam[uNewFilterIndex].LF_nHF);
                tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetLF_nHF(0x%08X) failed.", tUnit));
            }
        }
        if (err == TM_OK)
        {
            if ( (pObj->AnalogParam[uNewFilterIndex].LF_freq != pObj->AnalogParam[pObj->AnalogIndex].LF_freq)
                 || (pObj->ResetCalledPreviously == True) )
            {
                err = tmddTDA18250SetLF_freq(tUnit, pObj->AnalogParam[uNewFilterIndex].LF_freq);
                tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetLF_freq(0x%08X) failed.", tUnit));
            }
        }
        if (err == TM_OK)
        {
            if ( (pObj->AnalogParam[uNewFilterIndex].Sel_3dB != pObj->AnalogParam[pObj->AnalogIndex].Sel_3dB)
                 || (pObj->ResetCalledPreviously == True) )
            {
                err = tmddTDA18250SetSel_3dB(tUnit, pObj->AnalogParam[uNewFilterIndex].Sel_3dB);
                tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetSel_3dB(0x%08X) failed.", tUnit));
            }
        }
        if (err == TM_OK)
        {
            if ( (pObj->AnalogParam[uNewFilterIndex].Shift_LF_rccal != pObj->AnalogParam[pObj->AnalogIndex].Shift_LF_rccal)
                 || (pObj->ResetCalledPreviously == True) )
            {
                err = tmddTDA18250SetShift_LF_rccal(tUnit, pObj->AnalogParam[uNewFilterIndex].Shift_LF_rccal);
                tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddTDA18250SetShift_LF_rccal(0x%08X) failed.", tUnit));
            }
        }
        if (err == TM_OK)
        {
        ...
        {
            /* Update Filter Index */
            pObj->AnalogIndex = uNewFilterIndex;
        }
    }
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        uRFAGC_TopIndex = 0;
        while ( (pObj->uRF > pObj->RFAGC_Top[uRFAGC_TopIndex].RfMax) && (uRFAGC_TopIndex < tmTDA18250_IND_RFAGC_Top_Max) )
...
)
{
    ...
    while ( (uAGC2b > Lvl_AGC2b[uIndex][tmTDA18250_AGC2b_Code]) && (uIndex < tmTDA18250_Lvl_AGC2b_Index_Max) )
        uIndex = uIndex + 1;
...
)
{
    ptmTDA18250Object_t      pObj = Null;
    tmErrorCode_t            err  = TM_OK;
    tmddTDA18250_AGC1_Gain_t uAGC1_Current = tmddTDA18250_AGC1_Gain_Fixed_0dB;
    tmddTDA18250_AGC1_Gain_t uAGC1_Master = tmddTDA18250_AGC1_Gain_Fixed_0dB;
        ...
        */
        ...
        if (err == TM_OK)
        {
            switch(AGC1_Type)
            {
                ...
                default:
                    err = TDA18250_ERR_NOT_SUPPORTED;
                    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "Agc1 type contribution undefined(0x%08X) failed.", tUnit));
                    break;
            }
