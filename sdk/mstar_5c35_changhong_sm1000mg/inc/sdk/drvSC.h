...
DLL_PUBLIC SC_Result       MDrv_SC_Init(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_Open(MS_U8 u8SCID, MS_U8 u8Protocol, SC_Param* pParam, P_SC_Callback pfSmartNotify);
DLL_PUBLIC SC_Result       MDrv_SC_Config(MS_U8 u8SCID, SC_Param* pParam);
DLL_PUBLIC SC_Result       MDrv_SC_Close(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_Reset(MS_U8 u8SCID, SC_Param* pParam);
DLL_PUBLIC SC_Result       MDrv_SC_Activate(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_Deactivate(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_Reset_ATR(MS_U8 u8SCID, SC_Param* pParam, MS_U8 *pu8Atr, MS_U16 *pu16AtrLen, MS_U8 *pu8His, MS_U16 *pu16HisLen);
DLL_PUBLIC SC_Result       MDrv_SC_PPS(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_Send(MS_U8 u8SCID, MS_U8 *pu8SendData, MS_U16 u16SendDataLen, MS_U32 u32TimeoutMs);
DLL_PUBLIC SC_Result       MDrv_SC_Recv(MS_U8 u8SCID, MS_U8 *pu8ReadData, MS_U16 *u16ReadDataLen, MS_U32 u32TimeoutMs);
DLL_PUBLIC SC_Result       MDrv_SC_T0_SendRecv(MS_U8 u8SCID, MS_U8 *pu8SendData, MS_U16 u16SendLen, MS_U8 *pu8RecvData, MS_U16 *pu16RecvLen);
DLL_PUBLIC SC_Result       MDrv_SC_T1_SendRecv(MS_U8 u8SCID, MS_U8 *pu8SendData, MS_U16 *u16SendDataLen, MS_U8 *pu8ReadData, MS_U16 *u16ReadDataLen);
DLL_PUBLIC SC_Result       MDrv_SC_T14_SendRecv(MS_U8 u8SCID, MS_U8 *pu8SendData, MS_U16 u16SendLen, MS_U8 *pu8RecvData, MS_U16 *pu16RecvLen);
DLL_PUBLIC SC_Result       MDrv_SC_Exit(MS_U8 u8SCID);

DLL_PUBLIC SC_Result       MDrv_SC_GetATR(MS_U8 u8SCID, MS_U32 u32TimeOut,MS_U8 *pu8Atr, MS_U16 *pu16AtrLen, MS_U8 *pu8His, MS_U16 *pu16HisLen);
DLL_PUBLIC const SC_Info*  MDrv_SC_GetInfo(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC SC_Result       MDrv_SC_GetStatus(MS_U8 u8SCID, SC_Status *pStatus);
DLL_PUBLIC void            MDrv_SC_SetDbgLevel(SC_DbgLv eLevel);
DLL_PUBLIC SC_Result       MDrv_SC_SetPPS(MS_U8 u8SCID, MS_U8 u8SCProtocol, MS_U8 u8Di,MS_U8 u8Fi);
DLL_PUBLIC SC_Result       MDrv_SC_ClearState(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_PowerOff(void);
DLL_PUBLIC SC_Result       MDrv_SC_SetGuardTime(MS_U8 u8SCID, MS_U8 u8GuardTime);
DLL_PUBLIC SC_Result       MDrv_SC_SetWaitingTime(MS_U8 u8SCID, MS_U16 u16WaitingTime);
DLL_PUBLIC SC_Result       MDrv_SC_SetBlockGuardTime(MS_U8 u8SCID, MS_U8 u8GuardTime);

SC_Result       MDrv_SC_Task_Proc(void);
MS_BOOL         MDrv_SC_ISR_Proc(MS_U8 u8SCID);
DLL_PUBLIC SC_Result       MDrv_SC_RawExchange(MS_U8 u8SCID, MS_U8 *pu8SendData, MS_U16 *u16SendDataLen, MS_U8 *pu8ReadData, MS_U16 *u16ReadDataLen);
DLL_PUBLIC SC_Result       MDrv_SC_RawExchangeTimeout(MS_U8 u8SCID, MS_U8 *pu8SendData, MS_U16 *u16SendDataLen, MS_U8 *pu8ReadData, MS_U16 *u16ReadDataLen, MS_U32 u32TimeoutMs);
DLL_PUBLIC SC_Result       MDrv_SC_SetBuffAddr(SC_BuffAddr *pScBuffAddr);
DLL_PUBLIC MS_BOOL         MDrv_SC_CardVoltage_Config(MS_U8 u8SCID, SC_VoltageCtrl eVoltage);
DLL_PUBLIC void            MDrv_SC_EnableTimeout(MS_BOOL bTimeout);
void MDrv_SC_GuardTime_INT(MS_U8 u8SCID,MS_BOOL Satus);
void MDrv_SC_WaitTime_INT(MS_U8 u8SCID,MS_BOOL Satus);
