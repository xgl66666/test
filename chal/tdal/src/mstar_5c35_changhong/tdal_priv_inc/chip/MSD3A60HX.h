...
#ifndef _MSD3A60HX_H_
#define _MSD3A60HX_H_
...
#define PAD_GPIO_PM12_IS_GPIO BALL_A6_IS_GPIO
#endif
...
#define PAD_VSYNC0_IS_GPIO BALL_L4_IS_GPIO
#endif

#define BALL_K4 PAD_VSYNC1
...
#define PAD_VSYNC1_IS_GPIO BALL_K4_IS_GPIO
#endif
...
#define PAD_TSO_CLK_IS_GPIO BALL_F6_IS_GPIO
#endif

#define BALL_F5 PAD_TSO_SYNC
...
#define PAD_TSO_SYNC_IS_GPIO BALL_F5_IS_GPIO
#endif

#define BALL_G5 PAD_TSO_VLD
...
#define PAD_TSO_VLD_IS_GPIO BALL_G5_IS_GPIO
#endif

#define BALL_F4 PAD_TSO_D7
#define PAD_TSO_D7 8
...
#define PAD_TSO_D7_IS_GPIO BALL_F4_IS_GPIO
#endif

#define BALL_H5 PAD_TSO_D6
#define PAD_TSO_D6 7
...
#define PAD_TSO_D6_IS_GPIO BALL_H5_IS_GPIO
#endif

#define BALL_P5 PAD_TSO_D5
#define PAD_TSO_D5 6
...
#define PAD_TSO_D5_IS_GPIO BALL_P5_IS_GPIO
#endif
...
#define PAD_TSO_D0_IS_GPIO BALL_N5_IS_GPIO
#endif
...
#define PAD_DDCA_CK_PM_IS_GPIO BALL_W5_IS_GPIO
#endif

#define BALL_W6 PAD_DDCA_DA_PM
...
#define PAD_DDCA_DA_PM_IS_GPIO BALL_W6_IS_GPIO
#endif

#define BALL_D4 PAD_DDCDA_CK_PM
...
#define PAD_DDCDA_CK_PM_IS_GPIO BALL_D4_IS_GPIO
#endif

#define BALL_E4 PAD_DDCDA_DA_PM
...
#define PAD_DDCDA_DA_PM_IS_GPIO BALL_E4_IS_GPIO
#endif

#define BALL_B2 PAD_DDCDB_CK_PM
...
#define PAD_DDCDB_CK_PM_IS_GPIO BALL_B2_IS_GPIO
#endif

#define BALL_A1 PAD_DDCDB_DA_PM
...
#define PAD_DDCDB_DA_PM_IS_GPIO BALL_A1_IS_GPIO
#endif
...
#define PAD_TS0_D1_IS_GPIO BALL_AA7_IS_GPIO
#endif

#define BALL_Y7 PAD_TS0_D2
...
#define PAD_TS0_D2_IS_GPIO BALL_Y7_IS_GPIO
#endif

#define BALL_AA8 PAD_TS0_D3
...
#define PAD_TS0_D3_IS_GPIO BALL_AA8_IS_GPIO
#endif
...
#define PAD_TS0_D5_IS_GPIO BALL_AC7_IS_GPIO
#endif

#define BALL_AD7 PAD_TS0_D6
...
#define PAD_TS0_D6_IS_GPIO BALL_AD7_IS_GPIO
#endif

#define BALL_AE7 PAD_TS0_D7
...
#define PAD_TS0_D7_IS_GPIO BALL_AE7_IS_GPIO
#endif

#define BALL_AC8 PAD_TS0_VLD
...
#define PAD_TS0_VLD_IS_GPIO BALL_AC8_IS_GPIO
#endif

#define BALL_AD8 PAD_TS0_SYNC
...
#define PAD_TS0_SYNC_IS_GPIO BALL_AD8_IS_GPIO
#endif

#define BALL_AE8 PAD_TS0_CLK
...
#define PAD_TS0_CLK_IS_GPIO BALL_AE8_IS_GPIO
#endif

#define BALL_AE9 PAD_PCM_D3
...
#define PAD_PCM_D3_IS_GPIO BALL_AE9_IS_GPIO
#endif

#define BALL_AB12 PAD_PCM_D4
...
#define PAD_PCM_D4_IS_GPIO BALL_AB12_IS_GPIO
#endif
...
#define PAD_PCM_D6_IS_GPIO BALL_AB11_IS_GPIO
#endif

#define BALL_AB10 PAD_PCM_D7
...
#define PAD_PCM_D7_IS_GPIO BALL_AB10_IS_GPIO
#endif

#define BALL_AD10 PAD_PCM_CE_N
...
#define PAD_PCM_CE_N_IS_GPIO BALL_AD10_IS_GPIO
#endif

#define BALL_AB15 PAD_PCM_A10
...
#define PAD_PCM_A10_IS_GPIO BALL_AB15_IS_GPIO
#endif

#define BALL_AC11 PAD_PCM_OE_N
...
#define PAD_PCM_OE_N_IS_GPIO BALL_AC11_IS_GPIO
#endif
...
#define BALL_AC9 PAD_PCM_IORD_N
...
#define PAD_PCM_IORD_N_IS_GPIO BALL_AC9_IS_GPIO
#endif

#define BALL_AE16 PAD_PCM_A9
...
#define PAD_PCM_A9_IS_GPIO BALL_AE16_IS_GPIO
#endif

#define BALL_AD9 PAD_PCM_IOWR_N
...
#define PAD_PCM_IOWR_N_IS_GPIO BALL_AD9_IS_GPIO
#endif
...
#define PAD_PCM_A13_IS_GPIO BALL_AA13_IS_GPIO
#endif

#define BALL_AA15 PAD_PCM_A14
...
#define PAD_PCM_A14_IS_GPIO BALL_AA15_IS_GPIO
#endif
...
#define BALL_AA12 PAD_PCM_IRQA_N
...
#define PAD_PCM_IRQA_N_IS_GPIO BALL_AA12_IS_GPIO
#endif
...
#define PAD_PCM_A7_IS_GPIO BALL_AD15_IS_GPIO
#endif

#define BALL_AC14 PAD_PCM_A6
...
#define PAD_PCM_A6_IS_GPIO BALL_AC14_IS_GPIO
#endif

#define BALL_AD13 PAD_PCM_A5
...
#define PAD_PCM_A5_IS_GPIO BALL_AD13_IS_GPIO
#endif

#define BALL_Y11 PAD_PCM_WAIT_N
...
#define PAD_PCM_WAIT_N_IS_GPIO BALL_Y11_IS_GPIO
#endif

#define BALL_AD14 PAD_PCM_A4
...
#define PAD_PCM_A4_IS_GPIO BALL_AD14_IS_GPIO
#endif

#define BALL_Y12 PAD_PCM2_CE_N
...
#define PAD_PCM2_CE_N_IS_GPIO BALL_Y12_IS_GPIO
#endif

#define BALL_Y17 PAD_PCM2_IRQA_N
...
#define PAD_PCM2_IRQA_N_IS_GPIO BALL_Y17_IS_GPIO
#endif

#define BALL_AE14 PAD_PCM2_WAIT_N
...
#define PAD_PCM2_WAIT_N_IS_GPIO BALL_AE14_IS_GPIO
#endif

#define BALL_Y8 PAD_UART_RX2
...
#define PAD_UART_RX2_IS_GPIO BALL_Y8_IS_GPIO
#endif

#define BALL_Y9 PAD_UART_TX2
...
#define PAD_UART_TX2_IS_GPIO BALL_Y9_IS_GPIO
#endif

#define BALL_Y16 PAD_PF_AD15
...
#define PAD_PF_AD15_IS_GPIO BALL_Y16_IS_GPIO
#endif

#define BALL_Y10 PAD_PF_ALE
...
#define PAD_PF_ALE_IS_GPIO BALL_Y10_IS_GPIO
#endif

#define BALL_AC12 PAD_PF_CE0Z
...
#define PAD_PF_CE0Z_IS_GPIO BALL_AC12_IS_GPIO
#endif

#define BALL_AB9 PAD_PF_CE1Z
...
#define PAD_PF_CE1Z_IS_GPIO BALL_AB9_IS_GPIO
#endif

#define BALL_AE11 PAD_PF_OEZ
...
#define PAD_PF_OEZ_IS_GPIO BALL_AE11_IS_GPIO
#endif

#define BALL_AD12 PAD_PF_WEZ
...
#define PAD_PF_WEZ_IS_GPIO BALL_AD12_IS_GPIO
#endif

#define BALL_AC16 PAD_F_RBZ
#define PAD_F_RBZ 86
...
#define PAD_F_RBZ_IS_GPIO BALL_AC16_IS_GPIO
#endif

#define BALL_AB17 PAD_SPI_CK
...
#define PAD_SPI_CK_IS_GPIO BALL_AB17_IS_GPIO
#endif
...
#define PAD_SPI_DO_IS_GPIO BALL_AA17_IS_GPIO
#endif

#define BALL_Y19 PAD_SPI_CZ
...
#define PAD_SPI_CZ_IS_GPIO BALL_Y19_IS_GPIO
#endif

#define BALL_AC21 PAD_PWM0
#define PAD_PWM0 137
...
#define PAD_PWM0_IS_GPIO BALL_AC21_IS_GPIO
#endif

#define BALL_AD21 PAD_PWM1
#define PAD_PWM1 138
...
#define PAD_PWM1_IS_GPIO BALL_AD21_IS_GPIO
#endif

#define BALL_AE21 PAD_PWM2
#define PAD_PWM2 139
...
#define PAD_PWM2_IS_GPIO BALL_AE21_IS_GPIO
#endif

#define BALL_AB21 PAD_PWM3
#define PAD_PWM3 140
...
#define PAD_PWM3_IS_GPIO BALL_AB21_IS_GPIO
#endif

#define BALL_AB18 PAD_DDCR_DA
...
#define PAD_DDCR_DA_IS_GPIO BALL_AB18_IS_GPIO
#endif

#define BALL_AA18 PAD_DDCR_CK
...
#define PAD_DDCR_CK_IS_GPIO BALL_AA18_IS_GPIO
#endif

#define BALL_V22 PAD_TCON0
#define PAD_TCON0 91
...
#define PAD_TCON0_IS_GPIO BALL_V22_IS_GPIO
#endif
...
#define PAD_TCON5_IS_GPIO BALL_Y22_IS_GPIO
#endif

#define BALL_AA22 PAD_TCON6
#define PAD_TCON6 97
...
#define PAD_TCON6_IS_GPIO BALL_AA22_IS_GPIO
#endif

#define BALL_AB22 PAD_TCON7
#define PAD_TCON7 98
...
#define PAD_TCON7_IS_GPIO BALL_AB22_IS_GPIO
#endif

#define BALL_W22 PAD_TCON8
#define PAD_TCON8 99
...
#define PAD_TCON8_IS_GPIO BALL_W22_IS_GPIO
#endif

#define BALL_Y21 PAD_TCON9
...
#define PAD_TCON9_IS_GPIO BALL_Y21_IS_GPIO
#endif

#define BALL_AA21 PAD_TCON10
...
#define PAD_TCON10_IS_GPIO BALL_AA21_IS_GPIO
#endif

#define BALL_Y20 PAD_TCON11
...
#define PAD_TCON11_IS_GPIO BALL_Y20_IS_GPIO
#endif
...
#define PAD_PCM_A3_IS_GPIO BALL_AC15_IS_GPIO
#endif

#define BALL_AE13 PAD_PCM_A2
...
#define PAD_PCM_A2_IS_GPIO BALL_AE13_IS_GPIO
#endif

#define BALL_AA16 PAD_PCM_REG_N
...
#define PAD_PCM_REG_N_IS_GPIO BALL_AA16_IS_GPIO
#endif

#define BALL_AC13 PAD_PCM_A1
...
#define PAD_PCM_A1_IS_GPIO BALL_AC13_IS_GPIO
#endif

#define BALL_AE12 PAD_PCM_A0
...
#define PAD_PCM_A0_IS_GPIO BALL_AE12_IS_GPIO
#endif

#define BALL_AD11 PAD_PCM_D0
...
#define PAD_PCM_D0_IS_GPIO BALL_AD11_IS_GPIO
#endif

#define BALL_AE10 PAD_PCM_D1
...
#define PAD_PCM_D1_IS_GPIO BALL_AE10_IS_GPIO
#endif

#define BALL_AC10 PAD_PCM_D2
...
#define PAD_PCM_D2_IS_GPIO BALL_AC10_IS_GPIO
#endif

#define BALL_AE15 PAD_PCM_RESET
...
#define PAD_PCM_RESET_IS_GPIO BALL_AE15_IS_GPIO
#endif

#define BALL_AD16 PAD_PCM2_RESET
...
#define PAD_PCM2_RESET_IS_GPIO BALL_AD16_IS_GPIO
#endif

#define BALL_AA14 PAD_PCM_CD_N
...
#define PAD_PCM_CD_N_IS_GPIO BALL_AA14_IS_GPIO
#endif

#define BALL_AB16 PAD_PCM2_CD_N
...
#define PAD_PCM2_CD_N_IS_GPIO BALL_AB16_IS_GPIO
#endif
...
#define PAD_ET_COL_IS_GPIO BALL_A12_IS_GPIO
#endif

#define BALL_C10 PAD_ET_TXD1
...
#define PAD_ET_TXD1_IS_GPIO BALL_C10_IS_GPIO
#endif

#define BALL_A11 PAD_ET_TXD0
...
#define PAD_ET_TXD0_IS_GPIO BALL_A11_IS_GPIO
#endif
...
#define PAD_ET_TX_CLK_IS_GPIO BALL_A10_IS_GPIO
#endif
...
#define PAD_I2S_IN_WS_IS_GPIO BALL_B11_IS_GPIO
#endif
...
#define PAD_LHSYNC2_IS_GPIO BALL_D9_IS_GPIO
#endif
...
#define PAD_GPIO12_IS_GPIO BALL_E7_IS_GPIO
#endif

#define BALL_E11 PAD_ET_RXD2
...
#define PAD_ET_RXD2_IS_GPIO BALL_E11_IS_GPIO
#endif
...
#define PAD_ET_RXD3_IS_GPIO BALL_E10_IS_GPIO
#endif

#define BALL_F8 PAD_GPIO14
...
#define PAD_GPIO14_IS_GPIO BALL_F8_IS_GPIO
#endif
...
#define PAD_SAR2_IS_GPIO BALL_A5_IS_GPIO
#endif
...
#define PAD_GPIO_PM2_IS_GPIO BALL_D8_IS_GPIO
#endif
...
#define PAD_GPIO_PM5_IS_GPIO BALL_D6_IS_GPIO
#endif
...
#define PAD_GPIO_PM7_IS_GPIO BALL_D7_IS_GPIO
#endif

#define BALL_C7 PAD_GPIO_PM8
...
#define PAD_GPIO_PM8_IS_GPIO BALL_C7_IS_GPIO
#endif
